...
#  define OLD_ROOT_UPDATE_DIR_NAME "Fennec"
...
#  define ROOT_UPDATE_DIR_NAME "Fennec-1de4eec8-1241-4177-a864-e594e8d1fb38"
...
static HRESULT GetUpdateDirectory(const wchar_t* installPath,
  ...
  regPath.AutoAllocAndAssignSprintf(L"SOFTWARE\\BrowserWorks\\%S\\TaskBarIDs",
                                    MOZ_APP_BASENAME);
  if (regPath.Length() != 0) {
