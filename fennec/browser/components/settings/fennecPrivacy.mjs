...
// Fennec ships Safe Browsing off by policy, so the security status card must
...
function wrapSafeBrowsingWarning(config) {
  if (config._fennecSafeBrowsing || !config.prefMapping) {
    return;
  }
  config._fennecSafeBrowsing = true;
