...
const BROWSER_STYLE_PREF = "browser.theme.fennec.browserStyle";
const MODE_PREF = "browser.theme.enableFennecCustomizations";
const FENNEC_THEME_MODE_PREF = "browser.theme.fennec.mode";
const FENNEC_THEME_COLOR_PREF = "browser.theme.fennec.color";
...
class FennecModeSegmented extends HTMLElement {
  ...
  #render() {
    ...
    const labelId = `${this.id || "fennec-mode-segmented"}-label`;
    const label = this.ownerDocument.createElement("span");
    label.className = "fennec-mode-segmented-label";
    label.id = labelId;
    ...
    group.className = "fennec-mode-segmented-options";
  ...
  get #buttons() {
    return Array.from(this.querySelectorAll(".fennec-mode-segmented-option"));
  }
  ...
  #handleClick(event) {
    ...
    const button = event.target.closest(".fennec-mode-segmented-option");
  ...
  #handleKeyDown(event) {
    ...
    const currentButton = Element.isInstance(event.target)
      ? event.target.closest(".fennec-mode-segmented-option")
      : null;
...
if (!customElements.get("fennec-mode-segmented")) {
  customElements.define("fennec-mode-segmented", FennecModeSegmented);
}

const TOGGLES = [
  {
    id: "fennec-appearance-transparency",
    l10nId: "fennec-appearance-transparent-toggle",
    prefs: [
  ...
  {
    id: "fennec-appearance-autohide-tabbar",
    l10nId: "fennec-appearance-autohide-tabbar-toggle",
    prefs: ["userChrome.autohide.tabbar"],
  },
  {
    id: "fennec-appearance-autohide-bookmarks",
    l10nId: "fennec-appearance-autohide-bookmarks-toggle",
    prefs: ["userChrome.autohide.bookmarkbar"],
  },
  {
    id: "fennec-appearance-autohide-sidebar",
    l10nId: "fennec-appearance-autohide-sidebar-toggle",
    prefs: ["userChrome.autohide.sidebar"],
  },
  {
    id: "fennec-appearance-autohide-navigation",
    l10nId: "fennec-appearance-autohide-navigation-toggle",
    prefs: [
  ...
  {
    id: "fennec-appearance-close-button-hover",
    l10nId: "fennec-appearance-close-button-hover-toggle",
    prefs: ["userChrome.tab.close_button_at_hover"],
  },
  {
    id: "fennec-appearance-drag-space",
    l10nId: "fennec-appearance-drag-space-toggle",
...
const BROWSER_STYLE_PREVIEW =
  "chrome://browser/content/fennec/style/fennec-style-";
...
// light variant of the FennecThemeColors palettes.
...
const BROWSER_STYLE_OPTIONS = [
  {
    value: "nova",
    l10nId: "fennec-appearance-browser-style-option-nova",
    imageSrc: `${BROWSER_STYLE_PREVIEW}nova.svg`,
  },
  {
    value: "proton",
    l10nId: "fennec-appearance-browser-style-option-proton",
    imageSrc: `${BROWSER_STYLE_PREVIEW}proton.svg`,
  },
  {
    value: "photon",
    l10nId: "fennec-appearance-browser-style-option-photon",
...
const THEME_COLORS = [
  {
    value: "default",
    l10nId: "fennec-appearance-theme-color-option-default",
    imageSrc: gradientSwatch("#e7f3ff", "#b1d3f5"),
  },
  {
    value: "smoke",
    l10nId: "fennec-appearance-theme-color-option-smoke",
    imageSrc: gradientSwatch("#f7f4f0", "#ebe4dc"),
  },
  {
    value: "ash",
    l10nId: "fennec-appearance-theme-color-option-ash",
    imageSrc: gradientSwatch("#f7f8ff", "#dfe3f2"),
  },
  {
    value: "sun",
    l10nId: "fennec-appearance-theme-color-option-sun",
    imageSrc: gradientSwatch("#fff0a8", "#ffd25f"),
  },
  {
    value: "spark",
    l10nId: "fennec-appearance-theme-color-option-spark",
    imageSrc: gradientSwatch("#ffd8bd", "#ff9b6a"),
  },
  {
    value: "flame",
    l10nId: "fennec-appearance-theme-color-option-flame",
    imageSrc: gradientSwatch("#ffd6de", "#ff8fa6"),
  },
  {
    value: "flare",
    l10nId: "fennec-appearance-theme-color-option-flare",
    imageSrc: gradientSwatch("#ffd6f0", "#ff7fca"),
  },
  {
    value: "lavender",
    l10nId: "fennec-appearance-theme-color-option-lavender",
    imageSrc: gradientSwatch("#efd6ff", "#c58cff"),
  },
  {
    value: "dusk",
    l10nId: "fennec-appearance-theme-color-option-dusk",
    imageSrc: gradientSwatch("#e6dcff", "#b5a0ff"),
  },
  {
    value: "lagoon",
    l10nId: "fennec-appearance-theme-color-option-lagoon",
    imageSrc: gradientSwatch("#d4ecff", "#79c8ff"),
  },
  {
    value: "tide",
    l10nId: "fennec-appearance-theme-color-option-tide",
    imageSrc: gradientSwatch("#d8f4fb", "#80d5e5"),
  },
  {
    value: "pine",
    l10nId: "fennec-appearance-theme-color-option-pine",
...
// The browser style is the theme. Lepton (the Fennec chrome customisation
...
function setBrowserStyle(style) {
  switch (style) {
    case "nova":
      lazy.FennecBrowserStyle.applyStockTabStyle();
    ...
    case "proton":
      ...
      break;
    case "photon":
      lazy.FennecBrowserStyle.applyPhotonTabStyle();
      Services.prefs.setStringPref(BROWSER_STYLE_PREF, style);
...
function leptonOff(deps) {
  return deps["fennec-lepton-mode"].value == "off";
}

function photonSelected(deps) {
  return deps["fennec-browser-style"].value == "photon";
}

function statusBarOff(deps) {
  return !deps["fennec-statusbar-enabled"].value;
}

Preferences.addSetting({
  id: "fennec-browser-style",
  get: getBrowserStyle,
  set: setBrowserStyle,
  setup: emitChange =>
...
Preferences.addSetting({
  id: "fennec-theme-mode",
  get: () => lazy.FennecThemeColors.getMode(),
  set: val => lazy.FennecThemeColors.setMode(val),
  setup: emitChange => observeBranches([FENNEC_THEME_MODE_PREF], emitChange),
});

Preferences.addSetting({
  id: "fennec-theme-color",
  get: () => lazy.FennecThemeColors.getColor(),
  set: val => lazy.FennecThemeColors.setColor(val),
  setup: emitChange => observeBranches([FENNEC_THEME_COLOR_PREF], emitChange),
});
...
for (let toggle of TOGGLES) {
  Preferences.addSetting({
    id: toggle.id,
    pref: toggle.prefs[0],
    deps: ["fennec-browser-style", "fennec-lepton-mode"],
    set(val) {
...
Preferences.addSetting({
  id: "fennec-statusbar-enabled",
  pref: STATUS_BAR_PREF,
});

Preferences.addSetting({
  id: "fennec-statusbar-show-links",
  pref: STATUS_BAR_TEXT_PREF,
  deps: ["fennec-statusbar-enabled"],
  disabled: statusBarOff,
});

SettingGroupManager.registerGroups({
  fennecBrowserStyle: {
    l10nId: "fennec-appearance-browser-style-group",
    headingLevel: 2,
    ...
    items: [
      {
        ...
        controlAttrs: { class: "fennec-browser-style-picker" },
  ...
  fennecThemeColors: {
    l10nId: "fennec-appearance-theme-colors-group",
    headingLevel: 2,
    controlAttrs: { badge: "fennec-exclusive" },
    items: [
      {
        id: "fennec-theme-mode",
        l10nId: "fennec-appearance-theme-mode-picker",
        control: "fennec-mode-segmented",
        controlAttrs: {
          class: "fennec-mode-segmented",
          ".options": THEME_MODES,
      ...
      {
        id: "fennec-theme-color",
        l10nId: "fennec-appearance-theme-color-picker",
        control: "moz-visual-picker",
        controlAttrs: {
          class: "fennec-color-grid",
  ...
  fennecAppearanceDetails: {
    l10nId: "fennec-appearance-details-group",
    headingLevel: 2,
    controlAttrs: { badge: "fennec-exclusive" },
    items: [
      ...TOGGLES.map(toggle => ({
  ...
  fennecStatusBar: {
    l10nId: "fennec-appearance-statusbar-heading",
    headingLevel: 2,
    controlAttrs: { badge: "fennec-exclusive" },
    items: [
      {
        id: "fennec-statusbar-enabled",
        l10nId: "fennec-appearance-statusbar-enabled-toggle",
        control: "moz-toggle",
        controlAttrs: {
      ...
      {
        id: "fennec-statusbar-show-links",
        l10nId: "fennec-appearance-statusbar-links-toggle",
        control: "moz-toggle",
      },
    ],
  },
...
(function injectAppearanceSheet() {
  ...
  const href =
    "chrome://browser/content/fennec/settings/fennecAppearance.css";
