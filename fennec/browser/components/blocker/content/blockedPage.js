 ...
 * The "Load anyway" click is delegated to the FennecBlockedPage actor,
...
const BLOCKED_PAGE_UNAVAILABLE_L10N_ID = "fennec-blocked-page-unavailable";
...
function initPage() {
  ...
  // Navigation runs in FennecBlockedPageChild after the parent records a
