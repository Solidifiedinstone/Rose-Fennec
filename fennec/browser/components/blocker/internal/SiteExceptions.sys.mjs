...
import { toSafeDomain } from "resource:///modules/FennecBlockerUtils.sys.mjs";
...
export const PERMISSION_TYPE = "fennec-blocker";
export const PERMISSION_TYPE_PB = "fennec-blocker-pb";
...
/**
 * Stores blocker site exceptions as fennec-blocker permissions. Permanent
