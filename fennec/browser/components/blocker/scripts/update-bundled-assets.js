...
const AUTO_UBLOCK_DIR = path.join(os.tmpdir(), "fennec-blocker-ublock");
...
/**
 * Wrap scriptlet functions to consume Fennec placeholder args.
 *
...
/**
 * Build Fennec scriptlet resources from uBO built-in scriptlets.
 *
