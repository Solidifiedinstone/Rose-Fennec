...
import { isPrivateBrowsingContext } from "resource:///modules/FennecBlockerUtils.sys.mjs";
 ...
 */
export class FennecBlockedPageParent extends JSWindowActorParent {
  receiveMessage(message) {
    if (message.name !== "FennecBlockedPage:AllowAndNavigate") {
      return undefined;
    }
