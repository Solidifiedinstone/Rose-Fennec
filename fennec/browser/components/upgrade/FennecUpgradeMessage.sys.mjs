...
const FENNEC_153_UPGRADE = {
  id: "FENNEC_153_UPGRADE",
  template: "spotlight",
  targeting: "true",
  content: {
    id: "FENNEC_153_UPGRADE",
    ...
    screens: [
      {
        ...
        content: {
          ...
          logo: {},
          title: {
            string_id: "fennec-upgrade-dialog-title",
          },
          subtitle: {
            string_id: "fennec-upgrade-dialog-subtitle",
          },
          primary_button: {
            label: {
              string_id: "fennec-upgrade-dialog-continue-button",
            },
            action: {
              navigate: true,
            },
      ...
      {
        id: "FENNEC_153_UPGRADE_APPEARANCE",
        content: {
          position: "center",
          screen_style: {
            width: "560px",
          ...
          logo: {},
          title: {
            string_id: "fennec-upgrade-dialog-appearance-title",
          },
          subtitle: {
            string_id: "fennec-upgrade-dialog-appearance-subtitle",
          },
          tiles: {
            type: "single-select",
            class_name: "fennec-style",
            selected: "fennec-style-photon",
            action: {
              picker: "<event>",
            },
          ...
          primary_button: {
            label: {
              string_id: "fennec-upgrade-dialog-primary-button",
            },
            action: {
              navigate: true,
            },
...
export const FennecUpgradeMessage = {
  ...
  async getUpgradeMessage() {
    return Cu.cloneInto(FENNEC_153_UPGRADE, {});
  },
};
