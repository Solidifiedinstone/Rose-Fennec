...
const CSS_URI = "chrome://browser/content/fennec/privatetab/privatetab.css";
...
export const PrivateTab = {
  ...
  _markPrivateTab(tab) {
    tab.toggleAttribute("fennec-private", true);
  ...
  _initMenus(win) {
    ...
    // webext-panels.xhtml does not load browser/fennec/private-tabs.ftl;
    ...
    // browser.xhtml supplies browser/fennec/private-tabs.ftl here.
