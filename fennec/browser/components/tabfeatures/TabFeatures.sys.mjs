...
const CSS_URI = "chrome://browser/content/fennec/tabfeatures/tabfeatures.css";
...
export const TabFeatures = {
  ...
  async _showCopyNotification(win, url) {
    try {
      const l10n = new Localization(["browser/fennec/tabs.ftl"], true);
      const title = l10n.formatValueSync("fennec-copy-url-notification");
