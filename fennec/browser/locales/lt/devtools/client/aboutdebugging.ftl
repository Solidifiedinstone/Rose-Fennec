...
about-debugging-sidebar-this-firefox2 = Ši „{ -brand-shorter-name }“
about-debugging-sidebar-this-firefox-title =
    .title = Ši „{ -brand-shorter-name }“
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = Sąranka
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Įjunkite USB derinimą per „Android“ įrenginyje esančią „Fennec“.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Ši „Fennec“ laida negali būti naudojama „Fennec“ (68), skirtos „Android“, derinimui. Testavimui rekomenduojame savo telefone įdiegti „Fennec for Android Nightly“. <a>Daugiau informacijos</a>
