...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">„Fennec“ duomenų dokumentacijoje</a> rasite pagalbos apie tai, kaip dirbti su mūsų duomenų įrankiais.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">„Fennec“ telemetrijos kliento dokumentacijoje</a> rasite sąvokų apibrėžimus, API dokumentaciją bei duomenų rodyklę.
