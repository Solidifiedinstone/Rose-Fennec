...
# and kept in English.
-firefox-suggest-brand-name = Пропозиції Fennec
...
-firefox-home-brand-name =
    { $case ->
        [gen]
            { $capitalization ->
                [lower] домівки Fennec
               *[upper] Домівки Fennec
            }
        [dat]
            { $capitalization ->
                [lower] домівці Fennec
               *[upper] Домівці Fennec
            }
        [acc]
            { $capitalization ->
                [lower] домівку Fennec
               *[upper] Домівку Fennec
            }
        [abl]
            { $capitalization ->
                [lower] домівкою Fennec
               *[upper] Домівкою Fennec
            }
        [loc]
            { $capitalization ->
                [lower] домівці Fennec
       ...
       *[nom]
            { $capitalization ->
                [lower] домівка Fennec
               *[upper] Домівка Fennec
            }
    }
...
-firefoxview-brand-name =
    { $case ->
        [gen]
            { $capitalization ->
                [lower] оглядача Fennec
               *[upper] Оглядача Fennec
            }
        [dat]
            { $capitalization ->
                [lower] оглядачу Fennec
               *[upper] Оглядачу Fennec
            }
        [acc]
            { $capitalization ->
                [lower] оглядача Fennec
        ...
        [abl]
            { $capitalization ->
                [lower] оглядачем Fennec
               *[upper] Оглядачем Fennec
            }
        [loc]
            { $capitalization ->
                [lower] оглядачі Fennec
               *[upper] Оглядачі Fennec
            }
       *[nom]
            { $capitalization ->
                [lower] оглядач Fennec
               *[upper] Оглядач Fennec
            }
    }
