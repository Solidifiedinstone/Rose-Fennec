...
rights-intro-point-1 = { -brand-short-name } надається вам на умовах <a data-l10n-name="mozilla-public-license-link">Публічної ліцензії BrowserWorks</a>.Тобто, ви можете використовувати, копіювати та розповсюджувати { -brand-short-name }. Ви також можете змінювати джерельний код { -brand-short-name } як хочете та як вважаєте за потрібне. Публічна ліцензія BrowserWorks дає вам також право розповсюджувати змінені вами версії програми.
rights-intro-point-2 = Вам не передаються жодні права на торговельну марку чи ліцензії на торговельні марки BrowserWorks або будь-якої сторони, включно та без обмежень на назву і логотип Fennec. Додаткову інформацію щодо торговельних марок можна знайти <a data-l10n-name="mozilla-trademarks-link">тут</a>.
