...
discopane-intro3 =
    ...
    перелік <a data-l10n-name="learn-more-trigger">рекомендованих розширень</a> Fennec
...
addon-badge-recommended4 =
    .title = Fennec рекомендує лише ті розширення, які відповідають стандартам безпеки та продуктивності.
...
recommended-theme-1 = Відчуваєте творче натхнення? <a data-l10n-name="link">Створіть власну тему за допомогою Fennec Color.</a>
...
details-notification-hard-blocked-extension =
    .message = Це розширення заблоковано за порушення політик BrowserWorks, тому його було вимкнено.
details-notification-hard-blocked-other =
    .message = Цей додаток заблоковано за порушення політик BrowserWorks, тому його було вимкнено.
...
details-notification-soft-blocked-extension-enabled =
    .message = Це розширення порушує політики BrowserWorks. Користуватися ним може бути ризиковано.
details-notification-soft-blocked-other-disabled =
    .message = Цей додаток обмежено через порушення політик BrowserWorks, тому його було вимкнено. Ви можете ввімкнути його, розуміючи можливі наслідки ризику.
details-notification-soft-blocked-other-enabled =
    .message = Цей додаток порушує політики BrowserWorks. Користуватися ним може бути ризиковано.
...
plugins-openh264-description = Цей плагін автоматично встановлений BrowserWorks для взаємодії зі специфікацією WebRTC та увімкнення викликів WebRTC з пристроями, які потребують відеокодек H.264. Відвідайте http://www.openh264.org/ для перегляду програмного коду кодека та докладної інформації про його застосування.
