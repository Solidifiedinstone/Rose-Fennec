...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Документація даних Fennec</a> містить настанови про те, як працювати з нашими інструментами даних.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Документація клієнта телеметрії Fennec</a> містить визначення для концептів, документацію API та посилання на дані.
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">Панелі огляду телеметрії</a> дозволяють вам візуалізувати дані, які BrowserWorks отримує через телеметрію.
...
about-telemetry-page-subtitle = Ця сторінка показує інформацію про продуктивність, обладнання, використання та налаштування, зібрану за допомогою телеметрії. Ця інформація відправляється до { $telemetryServerOwner }, щоб поліпшити { -brand-full-name }.
