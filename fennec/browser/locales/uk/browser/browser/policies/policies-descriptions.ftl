...
policy-Backup = Вимкнути резервне копіювання або відновлення даних профілю.
...
policy-DisableFirefoxScreenshots = Вимкнути функцію Fennec Screenshots.
...
policy-DisableRemoteImprovements = Запобігти застосуванню змін продуктивності, стабільності та функцій для { -brand-short-name } між оновленнями.
...
policy-MicrosoftEntraSSO = Дозволити єдиний вхід для облікових записів Microsoft Entra.
