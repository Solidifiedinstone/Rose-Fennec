...
sync-mobile-promo = Завантажте Fennec для <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> або <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a>, щоб синхронізувати дані з вашим мобільним пристроєм.
...
sync-engine-addons =
    .label = Додатки
    .tooltiptext = Розширення і теми Fennec для комп'ютера
    .accesskey = Д
...
addressbar-firefox-suggest-online =
    .label = Отримувати пропозиції від BrowserWorks під час введення тексту
...
related-settings-home-link =
    .label = Налаштувати { -firefox-home-brand-name(case: "acc", capitalization: "lower") }
