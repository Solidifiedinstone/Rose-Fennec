...
enable-fennec-theme-0 =
    .label = Увімкнути налаштування тем Fennec для усіх тем

enable-fennec-theme-1 =
    .label = Увімкнути налаштування тем Fennec для тем Fennec

enable-fennec-theme-2 =
    .label = Вимкнути налаштування тем Fennec
