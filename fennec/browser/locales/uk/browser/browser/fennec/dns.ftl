...
preferences-doh-setting-ultra =
    ...
    .accesskey = Н
preferences-doh-ultra-desc = { -brand-short-name } використовуватиме захищену DNS з Oblivious HTTP через приватний ретранслятор Fennec для максимального захисту.
preferences-doh-ultra-detailed-desc-1 = Використовує Oblivious HTTP ретранслятор Fennec, щоб приховати запити DNS навіть від провайдера DNS
...
fennec-ultra-group =
    .label = Ультразахист
    .description = { -brand-short-name } використовуватиме безпечний DNS з Oblivious HTTP через приватний ретранслятор Fennec для максимального захисту.
fennec-ultra-toggle =
...
fennec-doh-overview-ultra =
    .label = Ультразахист
    .description = Безпечний DNS з Oblivious HTTP через приватний ретранслятор Fennec.
-fennec-doh-ultra-description = Domain Name System over Oblivious HTTP (DoOH) шифрує запити до сайтів і відокремлює вашу IP-адресу від ваших DNS-запитів, що ускладнює вашому інтернет-провайдеру, DNS-провайдеру або іншим особам можливість пов’язати вас із вебсайтами, які ви збираєтеся відвідати.
