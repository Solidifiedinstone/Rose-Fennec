...
sync-mobile-promo = Fennec brauzerini mobil qurilmangiz bilan sinxronlash uchun <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> yoki <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> uchun versiyalarini yuklab oling.
...
sync-engine-addons =
    ...
    .tooltiptext = Kompyuter uchun Fennec kengaytma va mavzulari
    .accesskey = Q
