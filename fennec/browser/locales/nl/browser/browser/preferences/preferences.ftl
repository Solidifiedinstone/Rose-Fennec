...
sync-mobile-promo = Download Fennec voor <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> of <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> om met uw mobiele apparaat te synchroniseren.
...
sync-engine-addons =
    .label = Add-ons
    .tooltiptext = Extensies en thema’s voor Fennec op desktops
    .accesskey = A
...
addressbar-firefox-suggest-online =
    .label = Suggesties van BrowserWorks ophalen terwijl u typt
