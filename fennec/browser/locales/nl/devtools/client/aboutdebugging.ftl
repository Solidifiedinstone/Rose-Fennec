...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = USB-foutopsporing in Fennec op het Android-apparaat inschakelen.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Deze versie van Fennec kan Fennec voor Android (68) niet debuggen. We raden u aan om voor testdoeleinden Fennec voor Android Nightly op uw telefoon te installeren. <a>Meer info</a>
...
about-debugging-browser-version-too-recent = De verbonden browser is recenter ({ $runtimeVersion }, buildID { $runtimeID }) dan uw { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Deze configuratie wordt niet ondersteund en kan ervoor zorgen dat DevTools niet goed werkt. Werk Fennec bij. <a>Probleemoplossing</a>
