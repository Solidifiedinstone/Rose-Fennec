...
about-telemetry-firefox-data-doc = De <a data-l10n-name="data-doc-link">Fennec Data Documentation</a> bevat handleidingen over het werken met onze gegevenshulpmiddelen.
about-telemetry-telemetry-client-doc = De <a data-l10n-name="client-doc-link">Fennec Telemetry-clientdocumentatie</a> bevat definities voor concepten, API-documentatie en gegevensverwijzingen.
