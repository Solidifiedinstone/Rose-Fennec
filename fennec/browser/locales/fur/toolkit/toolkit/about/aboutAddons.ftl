...
discopane-intro3 =
    ...
    tu cjatis une selezion di elements <a data-l10n-name="learn-more-trigger">conseâts</a> di Fennec
...
addon-badge-line3 =
    .title = Estension uficiâl realizade di BrowserWorks. E rispiete i standards di sigurece e prestazions
...
addon-badge-recommended4 =
    .title = Fennec al consee dome estensions che a sodisfin i standards di sigurece e di prestazion
...
recommended-theme-1 = Ti sintistu creatîf? <a data-l10n-name="link">Dissegne il to teme cun Fennec Color.</a>
...
details-notification-hard-blocked-extension =
    .message = Cheste estension e je blocade parcè che e viole lis politichis di BrowserWorks e e je stade disativade.
details-notification-hard-blocked-other =
    .message = Chest component adizionâl al è blocât parcè che al viole lis politichis di BrowserWorks e al è stât disativât.
...
details-notification-soft-blocked-extension-disabled =
    .message = Cheste estension e je limitade parcè che e viole lis politichis di BrowserWorks e e je stade disativade. Tu puedis tornâ a ativâle, ma al è pussibil che al compuarti cualchi risi.
details-notification-soft-blocked-extension-enabled =
    .message = Cheste estension e viole lis politichis di BrowserWorks. La sô utilizazion e podarès compuartâ cualchi risi.
details-notification-soft-blocked-other-disabled =
    .message = Chest component adizionâl al è limitât parcè che al viole lis politichis di BrowserWorks e al è stât disativât. Tu puedis tornâ a ativâlu, ma al è pussibil che al compuarti cualchi risi.
details-notification-soft-blocked-other-enabled =
    .message = Chest component adizionâ al viole lis politichis di BrowserWorks. La sô utilizazion e podarès compuartâ cualchi risi.
...
plugins-openh264-description = Chest plugin al ven instalât in automatic di BrowserWorks par conformâsi cu lis specifichis WebRTC e abilitâ lis clamadis WebRTC cui dispositîfs che a àn bisugne dal codec video H.264. Visite il sît https://www.openh264.org/ par viodi il codiç sorzint dal codec e scuvierzi di plui su la implementazion.
