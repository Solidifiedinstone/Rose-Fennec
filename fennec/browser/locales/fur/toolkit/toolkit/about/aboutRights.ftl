...
rights-intro-point-1 = { -brand-short-name } al è disponibil sot i tiermins dal <a data-l10n-name="mozilla-public-license-link">BrowserWorks Public License (Licence Publiche di BrowserWorks) </a>. Chest al vûl dî che tu puedis doprâ, copiâ e distribuî { -brand-short-name } a altris.  Tu puedis ancje modificâ il codiç sorzint di { -brand-short-name } come che tu vuelis seont lis tôs disbisugnis.  Cun di plui la BrowserWorks Public License ti da il dirit di distribuî lis tôs versions modificadis.
rights-intro-point-2 =
    BrowserWorks nol atribuìs al utent nissun dirit o licence su la utilizazion de marchis
    regjistradis di BrowserWorks o di altris sogjets, includûts cence nissune
    limitazion il non Fennec o i logos. Al è pussibil cjatâ altris informazions
