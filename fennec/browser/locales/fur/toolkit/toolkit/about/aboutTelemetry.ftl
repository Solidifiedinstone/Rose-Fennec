...
about-telemetry-firefox-data-doc = La <a data-l10n-name="data-doc-link">documentazion dai dâts di Fennec</a> e inclût vuidis su cemût lavorâ cui nestris imprescj pe gjestion dai dâts.
about-telemetry-telemetry-client-doc = La <a data-l10n-name="client-doc-link">documentazion dal client di Fennec Telemetry</a> a inclût definizions di concets, documentazion API e referencis di dâts.
about-telemetry-telemetry-dashboard = Cui <a data-l10n-name="dashboard-link">panei di Telemetry</a> al e pussibil visualizâ i dâts di BrowserWorks ricevûts cun Telemetry.
