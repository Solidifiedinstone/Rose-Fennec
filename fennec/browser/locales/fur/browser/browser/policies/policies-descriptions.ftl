...
policy-DisableFirefoxScreenshots = Disabilite la funzionalitât Fennec Screenshots.
...
policy-PrimaryPassword = Domande o impedìs la utilizazion i une password principâl.
