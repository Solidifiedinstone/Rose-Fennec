...
sync-mobile-promo = Discjame Fennec par <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> o <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> par sincronizâ cul to dispositîf mobil.
...
sync-engine-addons =
    ...
    .tooltiptext = Estensions e temis par Fennec desktop
    .accesskey = C
