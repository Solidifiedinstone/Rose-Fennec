...
about-debugging-sidebar-this-firefox2 = Chest { -brand-shorter-name }
about-debugging-sidebar-this-firefox-title =
    .title = Chest { -brand-shorter-name }
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = Configurazion
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Ative lis operazions di debug vie USB in Fennec sul dispositîf Android.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Cheste version di Fennec no pues esegui il debug a Fennec par Android (68). O conseìn di instalâ Fennec par Android Nightly sul to telefon par provâ. <a>Plui detais</a>
