...
sync-mobile-promo = Fennec ڈاؤن لوڈ کریں <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> یا <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a>آپ کے موبائل ڈیوائس کے ساتھ ہمہ وقت ساز
...
sync-engine-addons =
    .label = ایڈ-اون
    .tooltiptext = Fennec ڈیسک ٹاپ کے لئے ایکسٹینشن اور تھیم
    .accesskey = A
