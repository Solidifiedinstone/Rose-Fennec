...
rights-intro-point-1 = { -brand-short-name } آپ کو بر اصطلاحات کے زیر تحت دستیاب کیا گیا ہے <a data-l10n-name="mozilla-public-license-link">BrowserWorks عوامی لائسنس</a>۔ اس کا مطلب ہے کہ آپ { -brand-short-name } کو استعمال، نقل اور دوسروں کو بانٹ سکتے ہیں۔  آپ اپنی ضرورت پوری کرنے لے لیے { -brand-short-name } کا سورس کوڈ بھی تبدیل کر سکتے ہیں۔ BrowserWorks عوامی لائسنس آپ کو اپنی تبدیل کی ہوئی ورژن بانٹنے کی بھی اجازت دیتا ہے۔
rights-intro-point-2 = آپ کو BrowserWorks یا کسی پارٹی، کے ٹریڈ مارک کے لائسنس یا ٹریڈ مارک حقوق نہیں دیے گئے۔ اس میں بغیر کسی حدبندی کے Fennec نام اور لوگو بھی شامل ہیں۔ ٹریڈمارک پر اضافی معلومات شاید ملیں <a data-l10n-name="mozilla-trademarks-link">ادھر</a>۔
