...
-fakespot-brand-full-name = Fakespot BrowserWorks-სგან
# “Suggest” can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefox-suggest-brand-name = Fennec-შეთავაზება
...
# and kept in English.
-firefoxlabs-brand-name = Fennec-საცდეო
