...
addon-manage-extensions-shortcuts = გაფართოებების ღილაკებით მართვა
    .accesskey = ღ
...
discopane-intro3 =
    ...
    შედეგიანობა, მასალებით სარგებლობა, შეამკოთ { -brand-product-name } სურვილისამებრ და გააკეთოთ სხვა უამრავი რამ. ეს მცირე პროგრამები უმეტესად რიგითი, უცხო ხალხის მიერაა შექმნილი. იხილეთ მათგან საუკეთესო, რომელთაც <a data-l10n-name="learn-more-trigger">გირჩევთ</a> Fennec
...
addon-badge-line3 =
    .title = BrowserWorks-ს მიერ შექმნილი ოფიციალური გაფართოება. სრულად აკმაყოფილებს უსაფრთხოებისა და წარმადობის მოთხოვნებს.
...
addon-badge-recommended4 =
    .title = Fennec მხოლოდ იმ გაფართოებებს გირჩევთ, რომლებიც აკმაყოფილებს უსაფრთხოებისა და წარმადობის მაღალ მოთხოვნებს
...
# the user.
addon-permissions-managed-by-policy = ზოგიერთი ნებართვა იმართება დაწესებულების მიერ.
...
recommended-theme-1 = შემოქმედებით უნარებს ფლობთ? <a data-l10n-name="link">საკუთარის ასაწყობად გამოიყენეთ Fennec Color.</a>
...
shortcuts-heading = გაფართოებების ღილაკებით მართვა
...
details-notification-hard-blocked-extension =
    .message = გაფართოება შეიზღუდა BrowserWorks-ს დებულებების დარღვევის გამო და ამორთულია.
details-notification-hard-blocked-other =
    .message = დამატება შეიზღუდა BrowserWorks-ს დებულებების დარღვევის გამო და ამორთულია.
...
details-notification-soft-blocked-extension-disabled =
    .message = გაფართოება შეიზღუდა BrowserWorks-ს დებულებების დარღვევის გამო და ამორთულია. შეგიძლიათ ჩართოთ, მაგრამ სახიფათოა.
details-notification-soft-blocked-extension-enabled =
    .message = გაფართოება არღვევს BrowserWorks-ს დებულებებს. მისი გამოყენება შეიძლება სახიფათო იყოს.
details-notification-soft-blocked-other-disabled =
    .message = დამატება შეიზღუდა BrowserWorks-ს დებულებების დარღვევის გამო და ამორთულია. შეგიძლიათ ჩართოთ, მაგრამ სახიფათოა.
details-notification-soft-blocked-other-enabled =
    .message = დამატება არღვევს BrowserWorks-ს დებულებებს. მისი გამოყენება შეიძლება სახიფათო იყოს.
...
plugins-openh264-description = ამ მოდულს BrowserWorks თავადვე ამატებს WebRTC-მოთხოვნების დასაკმაყოფილებლად და WebRTC-ზარების ასამოქმედებლად იმ მოწყობილობებზე, რომელთაც ესაჭიროება ვიდეომშიფრავი H.264. ვრცლად იხილეთ https://www.openh264.org/ დანიშულებისა და მშიფრავის წყაროს შესახებ.
