...
rights-intro-point-1 = { -brand-short-name } მოგეწოდებათ <a data-l10n-name="mozilla-public-license-link">BrowserWorks-ს საზოგადოებრივი ლიცენზიით</a>. ეს ნიშნავს, რომ შეგიძლიათ { -brand-short-name } გამოიყენოთ, გაამრავლოთ და გაავრცელოთ. ასევე, შეგიძლიათ შეცვალოთ პირველწყარო კოდი, რომლითაც შექმნილია { -brand-short-name }, თქვენი მოთხოვნების შესაბამისად. BrowserWorks-ს საზოგადოებრივი ლიცენზია ასევე გაძლევთ უფლებას თქვენი სახეცვლილი ვერსიების გავრცელების.
rights-intro-point-2 = თქვენ არ გეძლევათ არანაირი უფლება ან ლიცენზია, BrowserWorks-ის ან მისი რომელიმე მხარის სავაჭრო ნიშნებზე, მათ შორის Fennec-ის სახელის ან ლოგოს შეუზღუდავ გამოყენებაზე. დამატებითი ინფორმაცია სავაჭრო ნიშნების შესახებ, შეგიძლიათ მოიძიოთ <a data-l10n-name="mozilla-trademarks-link">აქ</a>.
