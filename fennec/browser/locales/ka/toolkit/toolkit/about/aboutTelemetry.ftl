...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Fennec-ის მონაცემთა მასალები</a> მოიცავს მითითებებს, თუ როგორ შეიძლება მუშაობა მონაცემთა ხელსაწყოებთან.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Fennec-გაზომვების კლიენტის მასალები</a> შეიცავს განმარტებებს, კონცეფციას, API-დოკუმენტაციასა და მითითებებს მონაცემების შესახებ.
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">გაზომვების გვერდი</a> BrowserWorks-ს მიერ აღრიცხული მონაცემების ვიზუალურად წარმოდგენის საშუალებას იძლევა.
...
about-telemetry-ping-details = მონაცემების თითოეული ნაწილი იკვრება და იგზავნება მზა „<a data-l10n-name="ping-link">უწყებებად</a>“. თქვენ ახლა ხედავთ უწყებას { $name }, { $timestamp }.
about-telemetry-data-details-current = მონაცემების თითოეული ნაწილი იკვრება და იგზავნება მზა „<a data-l10n-name="ping-link">უწყებებად</a>“. თქვენ ახლა თვალს ადევნებთ მიმდინარე მონაცემებს.
