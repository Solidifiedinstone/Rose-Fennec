...
sync-mobile-promo = Fennec ჩამოტვირთეთ <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android-ზე</a> ან <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS-ზე</a> თქვენს მობილურ მოწყობილობასთან სინქრონიზაციისთვის.
...
sync-engine-addons =
    .label = დამატებები
    .tooltiptext = Fennec სამაგიდო ვერსიის გაფართოებები და თემები
    .accesskey = დ
