...
policy-DefaultBrowserSettingEnabled = განსაზღვრავს, შეუძლია თუ არა მომხმარებელს { -brand-short-name } აქციოს ნაგულისხმევ ბრაუზერად.
...
policy-DisableFirefoxScreenshots = Fennec Screenshots-ის გათიშვა
...
policy-DisableRemoteImprovements = შეზღუდვა, რომ { -brand-short-name } შეცვლის შესაძლებლობებს, წარმადობასა და მდგრადობას განახლებებს შორის შუალედებშიც.
policy-DisableRemoteSettingsAndAcceptSecurityConsequences = დაშორებული გამართვის გათიშვა.
...
policy-IPProtectionAvailable = ჩაშენებული VPN შეიზღუდოს მომხმარებელთათვის.
...
policy-RelaunchRequired = მოთხოვნა, რომ { -brand-short-name } ხელახლა გაეშვას მოცემულ ვადაში და ეცნობოს მომხმარებელს მოახლოებული გაშვების შესახებ.
...
policy-SitePolicies = დებულებები საიტის მიხედვით.
...
policy-XSLTEnabled = ჩაირთოს ან გამოირთოს მხარდაჭერა, რომლითაც იმუშავებს XSLTProcessor JavaScript API და XSLT-დამუშავების მითითება.
