...
-mdn-brand-name = Documentatzione web - MDN
...
-fakespot-brand-full-name = Fakespot de BrowserWorks
# “Suggest” can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefox-suggest-brand-name = Fennec cussìgiat
# ”Home" can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefox-home-brand-name = Pàgina printzipale de Fennec
# View" can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefoxview-brand-name = Visualizatzione de Fennec
