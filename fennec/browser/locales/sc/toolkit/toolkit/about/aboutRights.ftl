...
rights-intro-point-1 =
    { -brand-short-name } est disponìbile cun is cunditziones de sa <a data-l10n-name="mozilla-public-license-link">BrowserWorks Public License</a>.
    ...
    { -brand-short-name } comente ti serbat pro is interessos tuos. Sa BrowserWorks Public License ti donat puru su deretu de distribuire is versiones chi apas modificadu.
rights-intro-point-2 = Nissuna lissèntzia nen deretu sunt cuntzèdidos in pitzus de is marcas de sa Fundatzione BrowserWorks, o de àteras partes, inclùdidas chena limitatzione su nòmine e s’icona de Fennec. Àteras informatziones <a data-l10n-name="mozilla-trademarks-link">inoghe</a>.
