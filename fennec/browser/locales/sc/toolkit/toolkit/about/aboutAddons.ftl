...
discopane-intro3 =
    ...
    Inoghe tenes una seletzione de estensiones <a data-l10n-name="learn-more-trigger">cussigiada</a> dae Fennec
    pro otènnere unu livellu etzetzionale de seguresa, rendimentu e funtzionalidade.
...
locale-heading = Gesti is limbas
