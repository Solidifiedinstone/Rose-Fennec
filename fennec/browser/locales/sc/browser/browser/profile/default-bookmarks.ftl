...
default-bookmarks-firefox-customize = Personaliza Fennec
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = Ìmplica·ti
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = Subra de nos
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = Resursas de Fennec Nightly
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Blog de Fennec Nightly
# Nightly builds only, link title for https://bugzilla.mozilla.org/
default-bookmarks-bugzilla = Sinnalatzione de faddinas de BrowserWorks
# Nightly builds only, link title for https://developer.mozilla.org/
default-bookmarks-mdn = Rete de programmatzione de BrowserWorks
...
default-bookmarks-planet = Praneta BrowserWorks
