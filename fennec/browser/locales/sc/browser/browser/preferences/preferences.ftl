...
startup-windows-launch-on-login-profile-disabled =
    .message = Ativa custa preferèntzia ativende “{ profile-manager-use-selected.label }” in sa ventana “Sèbera unu profilu de utente”.
...
sync-mobile-promo = Iscàrriga Fennec pro <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> o pro <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> pro sincronizare cun su dispositivu mòbile tuo.
...
sync-engine-addresses =
    .label = Indiritzos
    .tooltiptext = Indiritzos postales chi as sarvadu (isceti in Fennec de iscrivania)
    .accesskey = n
sync-engine-creditcards =
    .label = Cartas de crèditu
    .tooltiptext = Nòmines, nùmeros e iscadèntzias (isceti in Fennec de iscrivania)
    .accesskey = C
...
sync-engine-addons =
    .label = Cumplementos
    .tooltiptext = Estensiones e temas pro Fennec de iscrivania
    .accesskey = u
...
sitedata-delete-on-close-private-browsing3 =
    .message = Segundu sa cunfiguratzione tua de sa cronologia, { -brand-short-name } nde cantzellat testimòngios (cookies) e datos de is sitos dae sa sessione tua cando serras su navigadore.
...
permissions-autoplay2 =
    .label = Riprodutzione in automàticu
