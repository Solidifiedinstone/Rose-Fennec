...
discopane-intro3 =
    ...
    lựa chọn <a data-l10n-name="learn-more-trigger">được đề xuất</a> của Fennec
...
addon-badge-recommended4 =
    .title = Fennec chỉ đề xuất các tiện ích mở rộng đáp ứng các tiêu chuẩn về bảo mật và hiệu suất
...
recommended-theme-1 = Cảm thấy muốn sáng tạo? <a data-l10n-name="link">Xây dựng chủ đề của riêng bạn với Fennec Color.</a>
