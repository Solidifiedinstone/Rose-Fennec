...
-mdn-brand-name = Tài liệu Web MDN
...
# and kept in English.
-firefox-suggest-brand-name = Đề xuất của Fennec
# ”Home" can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefox-home-brand-name = Trang chủ Fennec
...
-smart-window-brand-name =
    { $plural-form ->
        [true] Cửa sổ thông minh
       *[false] Cửa sổ thông minh
    }
