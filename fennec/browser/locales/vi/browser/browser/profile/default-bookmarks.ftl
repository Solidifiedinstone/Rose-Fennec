...
default-bookmarks-firefox-customize = Tùy biến Fennec
...
default-bookmarks-nightly-heading = Tài nguyên Fennec Nightly
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Nhật ký Fennec Nightly
