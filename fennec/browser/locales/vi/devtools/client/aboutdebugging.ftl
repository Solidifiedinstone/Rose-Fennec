...
about-debugging-sidebar-this-firefox2 = { -brand-shorter-name } này
about-debugging-sidebar-this-firefox-title =
    .title = { -brand-shorter-name } này
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = Cài đặt
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Bật gỡ lỗi USB trong Fennec trên thiết bị Android.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Phiên bản Fennec này không thể gỡ lỗi Fennec dành cho Android (68). Chúng tôi khuyên bạn nên cài đặt Fennec Nightly dành cho Android trên điện thoại để thử nghiệm. <a>Chi tiết khác</a>
...
about-debugging-browser-version-too-recent = Trình được kết nối gần đây ({ $runtimeVersion }, ID bản dựng { $runtimeID }) so với { -brand-shorter-name } ({ $localVersion }, ID bản dựng { $localID }). Đây là một thiết lập không được hỗ trợ và có thể khiến DevTools bị lỗi. Vui lòng cập nhật Fennec. <a>Khắc phục sự cố</a>
