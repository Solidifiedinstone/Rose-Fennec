...
rights-intro-point-1 = { -brand-short-name } mi ngi jàppandi ci anami <a data-l10n-name="mozilla-public-license-link">BrowserWorks Public License</a>. Lii dafay wone ni man nga jëfandikoo, duppi ak tasaare { -brand-short-name }. Man nga itam soppi yoonu gongikuwaayu { -brand-short-name } ci sa coobare. Sañal gu BrowserWorks may na la nga tasaare sumb yi nga soppi.
rights-intro-point-2 = Kenn joxulay àq walla ay sañal ci njëfandikoog màndarga gu koom gu BrowserWorks, péeñ gu Fennec itam ci la bokk . Man nga seet yeneen xibaar ñeel màndarga gu koom.<a data-l10n-name="mozilla-trademarks-link">fii</a>.
