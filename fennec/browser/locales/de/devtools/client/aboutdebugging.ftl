...
about-debugging-sidebar-this-firefox2 = Dieser { -brand-shorter-name }
about-debugging-sidebar-this-firefox-title =
    .title = Dieser { -brand-shorter-name }
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = USB-Debugging in Fennec auf dem Android-Gerät aktivieren.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Diese Fennec-Version kann Fennec für Android (68) nicht debuggen. Es wird empfohlen, Fennec für Android Nightly zum Testen auf dem Telefon zu installieren. <a>Weitere Informationen</a>
...
about-debugging-message-close-icon2 =
    .tooltiptext = Nachricht schließen
# Alt text used for the close icon of message component (warnings, errors and notifications).
