...
experimental-features-custom-wallpaper =
    .label = Ein benutzerdefiniertes Hintergrundbild oder eine Farbe für die Fennec-Startseite wählen
experimental-features-custom-wallpaper-description = Laden Sie Ihr eigenes Hintergrundbild hoch oder wählen Sie eine benutzerdefinierte Farbe für den Hintergrund Ihrer Fennec-Startseite.
...
experimental-features-newtab-widget-lists-new =
    .label = Listen
experimental-features-newtab-widget-lists-description = Rufen Sie sich Ihre Aufgabenliste ins Gedächtnis, jedes Mal wenn Sie die Fennec-Startseite öffnen. Von Checklisten bis hin zu Einkaufslisten: Machen Sie ihre Pläne in { -brand-product-name }. <a data-l10n-name="connect">Sagen Sie uns Ihre Meinung</a>
# Timer Widget
