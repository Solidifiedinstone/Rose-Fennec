...
about-telemetry-firefox-data-doc = Die <a data-l10n-name="data-doc-link">Dokumentation von Fennec-Daten</a> enthält Anleitungen zur Verwendung unserer Datenwerkzeuge.
about-telemetry-telemetry-client-doc = Die <a data-l10n-name="client-doc-link">Dokumentation des Telemetrie-Clients von Fennec</a> enthält Definitionen von Konzepten, API-Dokumentationen und Erläuterungen zu den Daten.
