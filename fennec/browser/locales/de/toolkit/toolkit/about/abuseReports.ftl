...
abuse-report-settings-reason-v2 = Es hat meine Suchmaschine oder die Startseite beim Start von Fennec oder eines neuen Tabs geändert, ohne mich darüber zu informieren oder um Erlaubnis zu bitten
...
abuse-report-settings-suggestions-homepage = Ändern Sie die Startseiten für den Start von Fennec oder eines neuen Tabs
