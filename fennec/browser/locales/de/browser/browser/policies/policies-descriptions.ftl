...
policy-DisableFirefoxScreenshots = "Fennec Screenshots"-Funktion deaktivieren
...
policy-DisableRemoteSettingsAndAcceptSecurityConsequences = Externe Einstellungen deaktivieren
...
policy-DisableTelemetry = Datenerhebung zur Verbesserung von Fennec (Telemetrie) deaktivieren
...
policy-NewTabPage = Fennec-Startseite aktivieren oder deaktivieren
...
policy-OverridePostUpdatePage = Fennec-Neuigkeiten-Seite - angezeigt nach Programmaktualisierung - festlegen. Ein leerer Wert deaktiviert das Öffnen der Seite.
...
policy-XSLTEnabled = Unterstützung für die XSLTProcessor-JavaScript-API und die XSLT-Verarbeitungs-Anweisung aktivieren oder deaktivieren.
