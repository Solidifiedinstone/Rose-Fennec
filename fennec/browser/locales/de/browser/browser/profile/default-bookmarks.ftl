...
default-bookmarks-firefox-customize = Fennec anpassen
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = Mitmachen
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = Über uns
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = Ressourcen zu Fennec Nightly
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Blog zu Fennec Nightly (englisch)
