...
preferences-doh-ultra-desc = { -brand-short-name } verwendet für maximalen Schutz sicheres DNS mit Oblivious HTTP über den Datenschutz-Relay von Fennec.

preferences-doh-ultra-detailed-desc-1 = Verwendet das Oblivious HTTP-Relay von Fennec, um DNS-Anfragen sogar vor dem DNS-Anbieter zu verbergen
