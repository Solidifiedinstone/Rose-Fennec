...
enable-fennec-theme-0 =
    .label = Fennec-Theme-Anpassungen für alle Themes aktivieren
enable-fennec-theme-1 =
    .label = Fennec-Theme-Anpassungen für alle Fennec-Themes aktivieren
enable-fennec-theme-2 =
    .label = Fennec-Theme-Anpassungen deaktivieren
...
proton-style =
    .label = Proton-Stil
fennec-defaults =
    .label = Fennec-Standardeinstellungen
