...
pane-search-title2 = खोज
    .title = खोज
pane-privacy-title3 = गोपनीयता & सुरक्षा
...
download-save-where-3 =
    .aria-label = फाइलहरू यहाँ सङ्ग्रह गर्नुहोस्
...
applications-type-column =
    ...
    .accesskey = T
applications-type-heading = सामग्री र तारिका
applications-action-column =
    .label = कार्य
    .accesskey = A
applications-action-heading = कार्य
# Variables:
...
sync-mobile-promo = निम्नको लागि Fennec डाउनलोड गर्नुहोस् <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> वा <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> ‌मोबाइल यन्त्रमा समक्रमण गर्नको लागि।
...
sync-manage-account2 =
    .label = खाता व्यवस्थापन गर्नुहोस्
    .accesskey = o
