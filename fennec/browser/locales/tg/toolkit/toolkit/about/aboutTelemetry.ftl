...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Санадҳои иттилоотии «Fennec»</a> дорои роҳнамоӣ барои тарзи кору фаъолият бо абзорҳои иттилоотии мо мебошанд.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Санадҳои муштарии санҷиши дурдасти «Fennec»</a> дорои тафсирҳо барои консепсияҳо, санадҳои API ва маълумоти иттилоотӣ мебошад.
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">Лавҳаи иттилоотии санҷиши дурдаст</a> ба шумо имкон медиҳад, ки тавонед маълумотеро, ки «BrowserWorks» тавассути Санҷиши дурдаст (Телеметрия) қабул мекунад, намоиш диҳед.
