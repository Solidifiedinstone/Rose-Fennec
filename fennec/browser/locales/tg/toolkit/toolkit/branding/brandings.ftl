...
-profiler-brand-name = Профилсози «Fennec»
...
-mdn-brand-name = Ҳуҷҷатҳои интернетии «MDN»
...
-fakespot-brand-full-name = «Fakespot« аз ҷониби «BrowserWorks»
# “Suggest” can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefox-suggest-brand-name = Пешниҳоди Fennec
# ”Home" can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefox-home-brand-name = Саҳифаи асосии «Fennec»
# View" can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefoxview-brand-name = Намуди «Fennec»
