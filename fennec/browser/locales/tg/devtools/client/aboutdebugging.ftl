...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Реҷаи ислоҳкунии хатоҳои USB-ро ба воситаи Fennec дар дастгоҳи Android фаъол намоед.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Ин версияи «Fennec» наметавонад, ки хатоҳои браузери «Fennec барои Android (68)»-ро ислоҳ кунад. Мо тавсия медиҳем, ки шумо браузери «Fennec барои Android Nightly»-ро дар телефони худ барои санҷишҳо насб намоед. <a>Маълумоти муфассал</a>
