...
policy-Backup = Ғайрифаъол кардани нусхаи эҳтиётӣ ё барқарор кардани маълумоти профил.
...
policy-DisableFirefoxScreenshots = Хусусияти «Fennec Screenshots» ғайрифаъол мекунад.
...
policy-HttpAllowlist = Манбаъҳое, ки ба реҷаи «HTTPS» такмил дода намешаванд.
policy-HttpsOnlyMode = Барои фаъолсозии реҷаи «Танҳо HTTPS» иҷозат медиҳад.
...
policy-PostQuantumKeyAgreementEnabled = Фаъол кардани мутобиқшавии қадами чандинсозӣ барои TLS.
