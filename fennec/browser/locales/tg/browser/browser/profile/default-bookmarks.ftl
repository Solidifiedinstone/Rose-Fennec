...
default-bookmarks-firefox-customize = Фармоишдиҳии Fennec
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = Ҳамроҳ шавед
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = Дар бораи мо
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = Манбаъҳои «Fennec Nightly»
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Блоги «Fennec Nightly»
# Nightly builds only, link title for https://bugzilla.mozilla.org/
default-bookmarks-bugzilla = Пайгирикунандаи нуқсонҳои BrowserWorks
# Nightly builds only, link title for https://developer.mozilla.org/
default-bookmarks-mdn = Шабакаи барномарезии BrowserWorks
# Nightly builds only, link title for https://addons.mozilla.org/firefox/addon/nightly-tester-tools/
default-bookmarks-nightly-tester-tools = Абзорҳои санҷиши нашри «Fennec Nightly»
# Nightly builds only, link title for about:crashes
default-bookmarks-crashes = Ҳамаи вайрониҳои браузери шумо
# Nightly builds only, link title for https://planet.mozilla.org/
default-bookmarks-planet = Сайёраи BrowserWorks
