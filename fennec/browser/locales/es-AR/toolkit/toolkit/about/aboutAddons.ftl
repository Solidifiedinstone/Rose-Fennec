...
addon-badge-line3 =
    .title = Extensión oficial construida por BrowserWorks. Cumple con los estándares de seguridad y rendimiento
...
addon-badge-recommended4 =
    .title = Fennec solo recomienda extensiones que cumplan con estándares de seguridad y rendimiento.
...
# the user.
addon-permissions-managed-by-policy = Algunos permisos son administrados por su organización.
...
recommended-theme-1 = ¿Se siente creativo? <a data-l10n-name="link"> Cree su propio tema con Fennec Color. </a>
...
details-notification-soft-blocked-extension-disabled =
    .message = Esta extensión está restringida por violar las políticas de BrowserWorks y ha sido deshabilitada. Se puede habilitar, pero podría ser riesgoso.
details-notification-soft-blocked-extension-enabled =
    .message = Esta extensión viola las políticas de BrowserWorks. Usarla podría ser riesgoso.
details-notification-soft-blocked-other-disabled =
    .message = Este complemento está restringido por violar las políticas de BrowserWorks y ha sido deshabilitado. Se puede habilitar, pero podría ser riesgoso.
details-notification-soft-blocked-other-enabled =
    .message = Este complemento viola las políticas de BrowserWorks. Usarlo podría ser riesgoso.
...
plugins-openh264-description = Este plugin es instalado automáticamente por BrowserWorks para cumplir con la especificación WebRTC y habilitar llamadas WebRTC con dispositivos que requieren el codec de video H.264. Visite https://www.openh264.org/ para ver el código fuente y conocer más sobre la implementación.
