...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Habilitar depuración USB en Fennec en el dispositivo Android.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Esta versión de Fennec no puede depurar Fennec para Android (68). Recomendamos instalar Fennec para Android Nightly en su teléfono para realizar pruebas. <a>Más detalles</a>
...
about-debugging-browser-version-too-recent = El navegador conectado es más reciente ({ $runtimeVersion }, buildID { $runtimeID }) que su { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Esta es una configuración incompatible y puede hacer que DevTools falle. Actualice Fennec. <a>Solución de problemas</a>
