...
session-history-unavailable = Diagrama del historial de la sesión no disponible
# Text displayed for when the target does not support showing session history diagrams
session-history-target-unsupported = El destino no soporta mostrar diagramas de historial de sesión
