...
about-debugging-sidebar-this-firefox2 = 這個 { -brand-shorter-name }
about-debugging-sidebar-this-firefox-title =
    .title = 這個 { -brand-shorter-name }
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = 設定
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = 於 Android 裝置上的 Fennec 開啟「USB 除錯」。
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = 此版本的 Fennec 無法對 Fennec for Android 68 版進行除錯。我們建議您在手機上安裝 Fennec for Android Nightly 來進行測試。<a>更多詳情</a>
...
about-debugging-browser-version-too-recent = 連結的瀏覽器（版本 { $runtimeVersion }、buildID { $runtimeID }）比您的 { -brand-shorter-name }（{ $localVersion }、buildID { $localID }） 還新。這是不支援的設定，可能會造成開發者工具發生錯誤，請更新 Fennec。<a>點此進行疑難排解</a>
