...
discopane-intro3 = 您可以使用擴充套件與佈景主題來自訂 { -brand-product-name }。您可以安裝它們來擴充隱私保護、加強生產力、改善媒體功能，調整 { -brand-product-name } 外觀，還有滿滿其他功能。這些小軟體通常都是由第三方打造的，以下是一系列 Fennec <a data-l10n-name="learn-more-trigger">推薦的</a>，在安全性、效能、功能上均有傑出表現的套件。
...
addon-badge-recommended4 =
    .title = Fennec 僅推薦符合安全性與運作效能標準的擴充套件。
...
recommended-theme-1 = 突然有個靈感嗎？<a data-l10n-name="link">使用 Fennec Color 來打造自己的佈景主題。</a>
...
details-notification-hard-blocked-extension =
    .message = 此擴充套件違反 BrowserWorks 的政策規定，已被停用。
...
details-notification-soft-blocked-extension-enabled =
    .message = 此擴充套件違反了 BrowserWorks 的政策規定，繼續使用可能會有風險。
details-notification-soft-blocked-other-disabled =
    .message = 此附加元件違反了 BrowserWorks 的政策規定，已被停用。您還是可以開啟，但可能會有風險。
details-notification-soft-blocked-other-enabled =
    .message = 此附加元件違反了 BrowserWorks 的政策規定，繼續使用可能會有風險。
