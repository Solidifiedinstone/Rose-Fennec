...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Fennec Data Documentation</a> 當中描述了我們使用資料工具的方式。
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Fennec Telemetry 客戶端文件</a>當中包含資料收集概念、API 文件以及資料格式的參考資料。
