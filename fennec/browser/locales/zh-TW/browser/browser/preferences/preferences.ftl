...
sync-mobile-promo = 下載 Fennec for<img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a>或<img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a>以與您的行動裝置同步。
...
sync-engine-addons =
    .label = 附加元件
    .tooltiptext = Fennec 桌機版的擴充套件與佈景主題
    .accesskey = A
...
addressbar-firefox-suggest-online =
    .label = 一邊打字，一邊從 BrowserWorks 取得建議
