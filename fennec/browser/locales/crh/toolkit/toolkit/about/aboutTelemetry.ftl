...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Fennec Veriler Tavsiqi</a> veriler aletlerimiz içün nasıl çalışılğanı aqqında rehberlerni ihtiva ete.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Fennec Telemetri müşteri tavsiqi</a> qavramlar içün tariflerni, API (UPA) tavsiqini ve veriler sıltavlarını ihtiva ete.
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">Telemetri köstergiç panelleri</a> BrowserWorks'nıñ Telemetri arqalı alğanı verilerni körselleştirmeñizge imkân bere.
