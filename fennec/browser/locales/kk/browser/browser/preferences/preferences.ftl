...
pane-downloads-title2 = Жүктемелер
    .title = Жүктемелер
pane-downloads3 =
    .heading = Жүктемелер
pane-accessibility-title = Қолжетімділік
    .title = { pane-accessibility-title }
pane-languages-title2 = Тілдер
    .title = Тілдер
...
pane-tabs-browsing-title2 = Беттер және шолу
    .title = Беттер және шолу
tabs-group-header2 =
    .label = Беттер
...
settings-tabs-drag-to-create-tab-groups =
    .label = Беттер топтарын жасау үшін беттерді бірге сүйреңіз
browser-layout-header2 =
    .label = Браузер жаймасы
browser-layout-horizontal-tabs2 =
    .label = Горизонталды беттер
    .title = Беттер жоғарыда
    .description = Беттер жоғарыда
browser-layout-vertical-tabs2 =
    .label = Вертикалды беттер
    .title = Беттер жанында, бүйірлік панельде
    .description = Беттер жанында, бүйірлік панельде
browser-layout-show-sidebar2 =
    .label = Бүйір панелін көрсету
    .description = Бетбелгілерге, телефоннан беттерге, ЖИ чат-боттарына және т.б. негізгі көріністен шықпай-ақ жылдам қол жеткізіңіз.
...
appearance-group2 =
    ...
    .description = Кейбір веб-сайттар өз түстерін сіздің қалауларыңызға сәйкес өзгертеді. Түс схемаңызды таңдаңыз.
...
browser-language-heading =
    .label = Браузер тілі
    .description = { -brand-short-name } мәзірлерін, хабарламаларын және хабарландыруларын көрсету үшін қолданылатын тілді таңдаңыз.
browser-language-preferred-label =
    .label = Таңдамалы тіл
browser-language-fallback-label =
    .label = Резервтік тіл
    .description = Таңдалған тілдің локализациясы толық болмаған жағдайда қолданылады.
...
download-always-ask-where2 =
    .label = Жүктеп алуға дейін файлдарды сақтау орны туралы сұрау
    .accesskey = а
...
applications-setting2 =
    .label = Файлдар және қолданбалар
    .description = { -brand-short-name } жүктеп алынған файлдар мен мазмұнды қалай өңдейтінін таңдаңыз.
applications-filter =
...
applications-save-for-new-types2 =
    .label = Файлдарды автоматты түрде сақтау
    .accesskey = с
...
performance-use-recommended-settings-checkbox-2 =
    .label = Ұсынылатын өнімділік баптауларын қолдану
    .description = Бұл баптаулар сіздің құрылғылар және операциялық жүйеңіз үшін икемдетілген.
    .accesskey = ы
...
settings-keyboard-shortcuts-group =
    ...
    .description = { -brand-short-name } қолданбасында шарлау және онымен өзара әрекеттесу жолын басқарыңыз.
...
containers-card-header2 =
    .label = Контейнерлер
    .description = Бір сайтта әртүрлі тіркелгілерді пайдалану және сайттар аралық бақылауды шектеу үшін cookie файлдарын контейнерлер бойынша бөліңіз.
...
account-disabled-group =
    .label = Тіркелгі
    .description = Тіркелгі баптаулары қолжетімсіз.
...
pane-account-sync-title2 = Тіркелгі және синхрондау
    .title = Тіркелгі және синхрондау
...
sync-mobile-promo = Fennec қолданбасын <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> немесе <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> үшін жүктеп алып, мобильді құрылғыңызбен синхрондаңыз.
...
sync-engine-addons =
    .label = Қосымшалар
    .tooltiptext = Fennec жұмыс үстелі үшін кеңейтулер және темалар
    .accesskey = о
...
forms-primary-pw-on-2 = Негізгі пароль <strong>ІСКЕ ҚОСУЛЫ</strong>
forms-primary-pw-on =
...
addressbar-firefox-suggest-online =
    .label = Теру кезінде BrowserWorks-дан ұсыныстарды алыңыз
...
content-blocking-baseline-exceptions-3 =
    .label = Сайттардың негізгі мәселелерін түзету (ұсынылады)
...
content-blocking-convenience-exceptions-3 =
    .label = Сайттардың шамалы мәселелерін түзету
    .description = Мақаладағы видеолар немесе пікірлер бөлімдері сияқты элементтердің бұғаттауын алып тастап, трекерлер болуы мүмкін элементтерді қайта ашады. Бұл сайттағы кейбір мәселелерді азайтады, бірақ қорғаныс деңгейін төмендетеді. Негізгі мәселелерді түзетумен бірге қолданылуы тиіс.
content-blocking-baseline-uncheck-warning-dialog-title = Түзетулерді шынымен сөндіргіңіз келе ме?
content-blocking-baseline-uncheck-warning-dialog-body = Бұл параметр ең көп таралған сайт мәселелерін шешуге көмектеседі. Оны сөндірсеңіз, кейбір сайттар жұмыс істемеуі мүмкін және { -brand-short-name } бұл мәселелерді шешуге көмектесе алмайтын болады.
...
nimbus-rollouts =
    .label = { -brand-short-name } браузеріне жаңартулар арасында функцияларды, өнімділікті және тұрақтылықты жақсартуға рұқсат беру
    .description = Өзгерістер қашықтан жіберілетін болады.
...
data-collection-health-report-disabled =
    .label = Техникалық және өзара әрекеттесу деректерін { -vendor-short-name } адресіне жіберу
    .accesskey = р
    .description = Деректерді жинау бұл жинақта сөндірілген.
data-collection-run-studies =
    .label = { -brand-short-name } үшін мүмкіндіктерді зерттеуге рұқсат беру
    .description = { -brand-short-name } барлығы үшін сапаны жақсарту мақсатында мүмкіндіктерді сынау үшін пайдаланушыларды кездейсоқ түрде таңдайды.
data-collection-studies-link =
    .label = { -brand-short-name } зерттеулерін қарау
data-collection-backlogged-crash-reports =
    .label = Құлау есептемелерін автоматты түрде жіберу
    .description = Бұл { -vendor-short-name } үшін браузер мәселелерін анықтау және оларды жөндеуге көмектеседі. Есептемелерде жеке немесе сезімтал мәліметтер болуы мүмкін.
    .accesskey = с
...
preferences-doh-radio-default =
    .label = Бастапқы
    .description = Қауіпсіз DNS қолжетімді аймақтарда пайдалану
...
preferences-doh-fallback-label =
    .label = Қауіпсіз DNS қолжетімді болмаса, әрқашан мені ескерту
...
preferences-appearance-header =
    .heading = Сыртқы түрі
browser-theme-group =
    .label = Браузер темасы
    .description = { -brand-short-name } стилін өзіңізге ыңғайлы етіп баптаңыз. Тема түстері саймандар панеліне, мәзірлерге және хабарламаларға қолданылады.
browser-theme-manage-link =
    .label = { -brand-short-name } темаларын басқару
appearance-window-density-group =
    .label = Терезе тығыздығы
    .description = Саймандар панелі, беттер және бүйірлік панель сияқты терезе элементтерінің айналасындағы аралықты реттеу.
appearance-window-density-radio-group =
    .aria-label = Терезе тығыздығы
appearance-window-density-automatic =
    .label = Автоматты түрде (бастапқы)
    .description = Стандартты, ықшам немесе сенсорлық аралық автоматты түрде қолданылады
appearance-window-density-automatic-no-touch =
    .label = Автоматты түрде (бастапқы)
    .description = Стандартты немесе ықшам аралық автоматты түрде қолданылады
appearance-window-density-standard =
    .label = Қалыпты
    .description = Экрандардың көбіне арналған теңгерілген аралық
appearance-window-density-auto-touch-mode =
    .label = Планшет режимі үшін сенсорлық аралықты пайдалану
appearance-window-density-compact =
    .label = Ықшам
    .description = Кішірек экрандар үшін азайтылған аралық
appearance-window-density-touch =
    .label = Сенсорлық
    .description = Сенсорлық экрандар үшін оңтайландырылған үлкенірек терезе элементтері мен шерту мақсаттары
related-settings-group =
    .label = Байланысты параметрлер
...
preferences-ai-controls-description = { -brand-short-name } бағдарламасында сізде әрдайым таңдау мүмкіндігі болады, соның ішінде ЖИ жетілдірілген функцияларды пайдалану керектігін да өзіңіз шешесіз. Қосымша басқару элементтері жақын арада қосылады.
preferences-ai-controls-block-ai-label = ЖИ жақсартуларын бұғаттау
preferences-ai-controls-block-ai =
    .label = { preferences-ai-controls-block-ai-label }
preferences-ai-controls-block-ai-description = Бұғаттау дегеніміз сіз { -brand-short-name } ішіндегі жаңа немесе қазіргі ЖИ жетілдірулерін, сондай-ақ олар туралы қалқымалы терезелерді көрмейтініңізді білдіреді. Ішінде не бар екені және іздеу нұсқаулары мен ұсыныстар сияқты дәстүрлі машиналық оқыту функцияларын қалай басқаруға болатыны туралы <a data-l10n-name="link">толығырақ мәлімет алыңыз</a>.
preferences-ai-controls-blocked-message =
    .message = Жаңа және ағымдағы ЖИ жақсартулары үнсіз келісім бойынша бұғатталады. Белгілі бір мүмкіндікті бұғаттан шығару үшін төмендегі басқару элементтерін пайдаланыңыз.
preferences-ai-controls-on-device-group =
    .label = Құрылғыдағы ЖИ
    .description = Бұл мүмкіндіктерді пайдаланған кезде құрылғыңызға жүктелетін шағын AI модельдері қолданылады. Бұл тәсіл жеке деректеріңіздің жекелігін қорғауға көмектеседі.
preferences-ai-controls-translations-control =
    .label = Аудармалар
    .description = Интернетті өзіңізге ыңғайлы тілде кедергісіз шолыңыз.
preferences-ai-controls-translations-more-link = Көбірек аударма баптаулары
preferences-ai-controls-pdfjs-control =
    .label = { -brand-short-name } PDF қарау құралындағы суреттің балама мәтіні
    .description = PDF құжаттарына суреттер қосқан кезде, бұл оларды қолжетімді ету үшін сипаттамалар қосады.
preferences-ai-controls-tab-group-suggestions-control =
    .label = Беттер тобының ұсыныстары
    .description = Беттерді атау және реттеу бойынша ұсыныстар алыңыз.
...
preferences-etp-custom-cookie-behavior-block-cross-site-cookies =
    .label = Сайтаралық cookie файлдарын бұғаттау
preferences-etp-custom-cookie-behavior-isolate-cross-site-cookies =
    .label = Сайтаралық cookie файлдарын оқшаулау
preferences-etp-custom-cookie-behavior-block-unvisited =
    .label = Шолмаған веб-сайттардан cookies файлдарын бұғаттау
preferences-etp-custom-cookie-behavior-block-all-cross-site-cookies =
    .label = Барлық сайтаралық cookies файлдарын бұғаттау (веб-сайттар сынуына әкеп соғуы мүмкін)
preferences-etp-custom-cookie-behavior-block-all =
    .label = Барлық cookie файлдарын бұғаттау (веб-сайттар жұмысы бұзылады)
...
security-privacy-issue-warning-extension-install =
    .label = Веб-сайттар кеңейтулерді орната алады
    .description = Веб-сайттар { -brand-short-name } ішіне сұрамай-ақ кеңейтулерді орната алады.
security-privacy-issue-warning-safe-browsing =
    .label = Қауіпті және алдамшы мазмұн бұғатталмаған
    .description = Веб-сайттар тарапынан болатын алаяқтық пен зиянды бағдарламалардың әсеріне ұшырау қаупі жоғарылайды.
security-privacy-issue-warning-doh =
    .label = HTTPS арқылы DNS сөндірулі
    .description = HTTPS арқылы DNS желі провайдеріңізденс сіз қандай сайттарға кіретініңізді жасырады.
