...
about-debugging-sidebar-this-firefox2 = Бұл { -brand-shorter-name }
about-debugging-sidebar-this-firefox-title =
    .title = Бұл { -brand-shorter-name }
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = Баптау
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Android құрылғыңыздағы Fennec ішінде USB жөндеуін іске қосыңыз.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Fennec-тың бұл нұсқасы Android үшін Fennec-ті (68) жөндей алмайды. Сынау үшін телефонға Android үшін Fennec Nightly орнатуды ұсынамыз. <a>Көбірек білу</a>
