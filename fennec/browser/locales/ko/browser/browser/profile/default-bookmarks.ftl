...
default-bookmarks-firefox-customize = Fennec 사용자 지정
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = 참여하기
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = 회사 소개
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = Fennec Nightly 리소스
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Fennec Nightly 블로그
