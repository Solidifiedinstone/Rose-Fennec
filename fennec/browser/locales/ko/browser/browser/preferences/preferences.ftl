...
sync-mobile-promo = 모바일 기기와 동기화하려면 <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> 또는 <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a>용 Fennec를 다운로드하세요.
...
sync-engine-addons =
    .label = 부가 기능
    .tooltiptext = Fennec 데스크톱 용 확장 기능 및 테마
    .accesskey = A
