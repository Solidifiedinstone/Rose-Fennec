...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Fennec 데이터 문서</a>에 데이터 도구를 사용하는 방법에 대한 안내서가 포함되어 있습니다.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Fennec 원격 분석 클라이언트 문서</a>에 개요, API 문서 및 데이터 참조에 대한 정의가 포함되어 있습니다.
