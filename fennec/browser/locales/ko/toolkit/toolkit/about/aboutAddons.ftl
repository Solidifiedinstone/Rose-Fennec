...
discopane-intro3 =
    ...
    제3자에 의해 개발됩니다. 여기에 뛰어난 보안, 성능 및 기능을 위해 Fennec가 
...
addon-badge-recommended4 =
    .title = Fennec는 보안 및 성능 표준을 충족하는 확장 기능만 추천합니다
...
recommended-theme-1 = 창의적인 느낌이 떠오르십니까? <a data-l10n-name="link">Fennec Color로 나만의 테마를 만들어 보세요.</a>
