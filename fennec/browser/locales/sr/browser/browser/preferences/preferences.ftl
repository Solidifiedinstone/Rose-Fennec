...
sync-mobile-promo = Преузмите Fennec за <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> или <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> да бисте усклађивали податке са мобилним уређајем.
...
sync-engine-addons =
    .label = Додаци
    .tooltiptext = Додаци и теме за Fennec на рачунару
    .accesskey = Д
...
addressbar-firefox-suggest-online =
    .label = Преузимај предлоге од BrowserWorks-е док куцате
