...
Welcome to the Fennec localization repository! This repository contains the Fluent (.ftl) files used for translating the Fennec browser into various languages.
...
1. Visit our Weblate project page at [https://hosted.weblate.org/engage/fennec/](https://hosted.weblate.org/engage/fennec/).
...
- Ask in the [Reddit community](https://www.reddit.com/r/fennec)

Thank you for contributing to making Fennec accessible to users around the world!
