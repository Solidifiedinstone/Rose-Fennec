...
default-bookmarks-firefox-customize = Personalice Fennec
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = Involúcrese
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = Sobre nós
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = Recursos de Fennec Nightly
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Blog de Fennec Nightly
# Nightly builds only, link title for https://bugzilla.mozilla.org/
default-bookmarks-bugzilla = Ferramenta para seguimento de erros de BrowserWorks
# Nightly builds only, link title for https://developer.mozilla.org/
default-bookmarks-mdn = Rede de desenvolvemento de BrowserWorks
