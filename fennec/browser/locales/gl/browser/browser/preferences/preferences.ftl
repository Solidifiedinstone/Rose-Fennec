...
sync-mobile-promo = Descargar Fennec para <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> ou <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> para sincronizar co seu dispositivo móbil.
...
sync-engine-addons =
    .label = Complementos
    .tooltiptext = Extensións e temas para o Fennec de escritorio
    .accesskey = p
