...
about-telemetry-firefox-data-doc = A <a data-l10n-name="data-doc-link">documentación dos datos de Fennec</a> contén guías sobre como traballar coas nosas ferramentas de datos.
about-telemetry-telemetry-client-doc = A <a data-l10n-name="client-doc-link">documentación do cliente de telemetría de Fennec</a> inclúe definicións de conceptos, documentación da API e referencias de datos.
about-telemetry-telemetry-dashboard = Os <a data-l10n-name="dashboard-link">taboleiros de telemetría</a> permítenlle visualizar os datos que BrowserWorks recibe a través da telemetría.
