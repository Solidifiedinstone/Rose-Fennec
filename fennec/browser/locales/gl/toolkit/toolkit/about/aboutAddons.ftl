...
addon-badge-line3 =
    .title = Extensión oficial creada por BrowserWorks. Cumpre os estándares de seguridade e rendemento
...
addon-badge-recommended4 =
    .title = Fennec só recomenda extensións que cumpren os estándares de seguridade e rendemento
...
recommended-theme-1 = Séntese creativo? <a data-l10n-name="link">Cree o seu propio tema con Fennec Color.</a>
...
details-notification-hard-blocked-extension =
    .message = Esta extensión está bloqueada por infrinxir as políticas de BrowserWorks e desactivouse.
details-notification-hard-blocked-other =
    .message = Este complemento bloqueouse por infrinxir as políticas de BrowserWorks e desactivouse.
...
details-notification-soft-blocked-extension-disabled =
    .message = Esta extensión está restrinxida por infrinxir as políticas de BrowserWorks e desactivouse. Podes activala, pero pode ser arriscado.
details-notification-soft-blocked-extension-enabled =
    .message = Esta extensión infrinxe as políticas de BrowserWorks. Usala pode ser arriscado.
details-notification-soft-blocked-other-disabled =
    .message = Este complemento está restrinxido por infrinxir as políticas de BrowserWorks e desactivouse. Podes activalo, pero pode ser arriscado.
details-notification-soft-blocked-other-enabled =
    .message = Este complemento infrinxe as políticas de BrowserWorks. Usalo pode ser arriscado.
...
plugins-openh264-description = Este engadido instalouse automaticamente por BrowserWorks para cumprir coa especificación WebRTC e para permitir chamadas WebRTC con dispositivos que requiren o códec de vídeo H.264. Visite http://www.openh264.org/ para ver o código fonte do códec e obter máis información sobre a implementación.
