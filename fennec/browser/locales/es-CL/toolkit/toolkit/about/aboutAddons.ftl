...
addon-badge-line3 =
    .title = Extensión oficial desarrollada por BrowserWorks. Cumple con los estándares de seguridad y rendimiento
...
addon-badge-recommended4 =
    .title = Fennec solo recomienda extensiones que cumplen estándares de seguridad y rendimiento
...
recommended-theme-1 = ¿Te sientes creativo? <a data-l10n-name="link"> Crea tu propio tema con Fennec Color. </a>
...
details-notification-hard-blocked-extension =
    .message = Esta extensión está bloqueada por violar las políticas de BrowserWorks y ha sido deshabilitada.
details-notification-hard-blocked-other =
    .message = Este complemento está bloqueado por violar las políticas de BrowserWorks y ha sido deshabilitado.
...
details-notification-soft-blocked-extension-disabled =
    .message = Esta extensión está restringida por violar las políticas de BrowserWorks y ha sido deshabilitada. La puedes habilitar, pero podría ser riesgoso.
details-notification-soft-blocked-extension-enabled =
    .message = Esta extensión viola las políticas de BrowserWorks. Usarla podría ser riesgoso.
details-notification-soft-blocked-other-disabled =
    .message = Este complemento está restringido por violar las políticas de BrowserWorks y ha sido deshabilitado. Lo puedes habilitar, pero podría ser riesgoso.
details-notification-soft-blocked-other-enabled =
    .message = Este complemento viola las políticas de BrowserWorks. Usarla podría ser riesgoso.
...
plugins-openh264-description = Este complemento es instalado automáticamente por BrowserWorks para cumplir con la especificación WebRTC y para permitir las llamadas WebRTC con dispositivos que requieren el códec de video H.264. Visite http://www.openh264.org/ para ver el código fuente del códec y aprender más sobre la implementación.
...
addon-data-collection-learnmore = Aprender más sobre la recopilación de datos
