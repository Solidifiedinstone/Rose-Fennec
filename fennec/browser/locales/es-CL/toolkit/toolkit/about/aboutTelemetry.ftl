...
about-telemetry-firefox-data-doc = La <a data-l10n-name="data-doc-link">documentación de datos de Fennec</a> contiene guías sobre cómo trabajar con tus herramientas de datos.
about-telemetry-telemetry-client-doc = La <a data-l10n-name="client-doc-link">documentación de cliente de telemetría de Fennec</a> incluye definiciones para conceptos, documentación de API y referencias de datos.
about-telemetry-telemetry-dashboard = Los <a data-l10n-name="dashboard-link">paneles de telemetría</a> te permiten visualizar los datos que BrowserWorks recibe a través de telemetría.
