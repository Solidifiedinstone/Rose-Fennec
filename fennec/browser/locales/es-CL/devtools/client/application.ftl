...
manifest-loaded-devtools-error = Error de Fennec DevTools
...
sidebar-item-session-history = Historial de sesiones
    .alt = Ícono del historial de sesiones
    .title = Historial de sesiones
# Entry in the Session History diagram
session-history-entry-info-button-title =
    .title = Mostrar datos del historial de sesiones
...
session-history-target-unsupported = Destino no admite la visualización de diagramas del historial de sesiones.
