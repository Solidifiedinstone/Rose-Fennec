...
applications-type-column =
    .label = ವಿಷಯದ ಬಗೆ
    .accesskey = T
applications-type-heading = ವಿಷಯದ ಬಗೆ
applications-action-column =
    .label = ಕಾರ್ಯ
    .accesskey = A
applications-action-heading = ಕಾರ್ಯ
# Variables:
...
search-engine-group =
    .label = ಪೂರ್ವನಿಯೋಜಿತ ಹುಡುಕು ಎಂಜಿನ್
...
sync-mobile-promo = Fennec ಡೌನ್‌ಲೋಡ್ ಮಾಡಿ<img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> ಅಥವ <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> ನಿಮ್ಮ ಮೊಬೈಲ್ ಸಾಧನದ ಜೊತೆ ಸಿಂಕ್ ಮಾಡಲು.
