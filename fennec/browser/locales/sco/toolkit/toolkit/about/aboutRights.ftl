...
rights-intro-point-1 =
    ...
    <a data-l10n-name="mozilla-public-license-link">BrowserWorks Public Licence</a>.
    This means ye can yaise, copy and distreebute { -brand-short-name } tae
    ithers. Ye're walcome forby tae chynge the soorce code o
    { -brand-short-name } ony wey ye're mindit fut tae meet yer needs. The BrowserWorks Public
...
rights-intro-point-2 =
    ...
    the BrowserWorks or onie pairty, includin wioot leemitation the
    Fennec nemme or logo. Mair information on tredmerks can be airtit oot
