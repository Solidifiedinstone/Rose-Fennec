...
addon-badge-line3 =
    .title = Offeecial extension pit thegither by BrowserWorks. Meets security and performance staunarts
...
recommended-theme-1 = In the muid for makkin sowt? <a data-l10n-name="link">Pit thegither yer ain theme wi Fennec Colour.</a>
...
plugins-openh264-description = This plugin is automatically instawed by BrowserWorks fur tae haud tae the WebRTC specification and tae enable WebRTC caws wi devices that need the H.264 video codec. Veesit https://www.openh264.org/ tae hae a luik at the codec soorce code and lairn mair aboot how it's implementit.
