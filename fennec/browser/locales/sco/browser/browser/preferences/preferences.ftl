...
sync-mobile-promo = Doonload Fennec fur <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> or <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> tae sync wi yer mobile device.
...
sync-engine-addons =
    .label = Eik-ons
    .tooltiptext = Extensions and themes fur Fennec desktap
    .accesskey = E
