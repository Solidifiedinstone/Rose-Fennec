...
sync-mobile-promo = Hent Fennec til <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> eller <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> for at synkronisere med din mobil-enhed
...
sync-engine-addons =
    .label = Tilføjelser
    .tooltiptext = Udvidelser og temaer til Fennec til computer
    .accesskey = T
