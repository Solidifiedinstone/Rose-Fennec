...
default-bookmarks-firefox-customize = Tilpas Fennec
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = Bliv involveret
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = Om os
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = Om Fennec Nightly
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Blog om Fennec Nightly
