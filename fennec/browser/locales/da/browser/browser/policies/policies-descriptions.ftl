...
policy-DisableFirefoxScreenshots = Deaktiver funktionen Fennec Screenshots
...
policy-DisableRemoteSettingsAndAcceptSecurityConsequences = Deaktiver fjernindstillinger.
