...
about-debugging-sidebar-this-firefox2 = Denne { -brand-shorter-name }
about-debugging-sidebar-this-firefox-title =
    .title = Denne { -brand-shorter-name }
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = Opsætning
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Aktiver USB-debugging i Fennec på Android-enheden.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Denne version af Fennec kan ikke bruges til at debugge Fennec til Android (68). Vi anbefaler, at du installerer Fennec Nightly til Android for at kunne teste. <a>Læs mere</a>
...
about-debugging-browser-version-too-recent = Den forbundne browser er nyere ({ $runtimeVersion }, buildID { $runtimeID }) end din { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Denne opsætning understøttes ikke og kan forhindre Udviklerværktøj i at køre korrekt. Opdater Fennec. <a>Fejlsøgning</a>
