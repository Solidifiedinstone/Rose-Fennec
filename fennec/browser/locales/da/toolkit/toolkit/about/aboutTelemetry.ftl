...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Fennec Data Documentation</a> indeholder guider om, hvordan du kan arbejde med vores dataværktøjer
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Fennec Telemetry client documentation</a> indeholder definitioner af koncepter, API-dokumentation og data-referencer.
