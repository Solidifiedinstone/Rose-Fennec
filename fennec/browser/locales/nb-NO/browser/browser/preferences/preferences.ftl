...
sync-mobile-promo = Last ned Fennec for <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> eller <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> for å synkronisere med dine mobile enheter.
...
sync-engine-addons =
    .label = Utvidelser
    .tooltiptext = Utvidelser og temaer for Fennec for datamaskin
    .accesskey = U
...
addressbar-firefox-suggest-online =
    .label = Hent forslag fra BrowserWorks mens du skriver
