...
addon-badge-line3 =
    .title = Offisiell utvidelse utviklet av BrowserWorks. Oppfyller sikkerhets- og ytelsesstandarder.
...
addon-badge-recommended4 =
    .title = Fennec anbefaler bare utvidelser som oppfyller standarder for sikkerhet og ytelse.
...
# the user.
addon-permissions-managed-by-policy = Noen tillatelser administreres av organisasjonen din.
...
recommended-theme-1 = Er du i det kreative hjørnet? <a data-l10n-name="link">Bygg ditt eget tema med Fennec Color.</a>
...
details-notification-hard-blocked-extension =
    .message = Denne utvidelsen er blokkert for brudd på BrowserWorkss retningslinjer og har blitt deaktivert.
details-notification-hard-blocked-other =
    .message = Dette tillegget er blokkert for brudd på BrowserWorkss retningslinjer og har blitt deaktivert.
...
details-notification-soft-blocked-extension-disabled =
    .message = Denne utvidelsen har blitt begrenset for brudd på BrowserWorkss retningslinjer og har blitt deaktivert. Du kan aktivere den, men dette kan være risikabelt.
details-notification-soft-blocked-extension-enabled =
    .message = Denne utvidelsen bryter BrowserWorkss retningslinjer. Å bruke det kan være risikabelt.
details-notification-soft-blocked-other-disabled =
    .message = Dette tillegget har blitt begrenset for brudd på BrowserWorkss retningslinjer og har blitt deaktivert. Du kan aktivere den, men dette kan være risikabelt.
details-notification-soft-blocked-other-enabled =
    .message = Dette tillegget bryter BrowserWorkss retningslinjer. Å bruke det kan være risikabelt.
...
plugins-openh264-description = Dette programtillegget installeres automatisk av BrowserWorks for å følge WebRTC-spesifikasjonen, og for å tillate WebRTC-kall med enheter som bruker videokodeken H.264. Gå til http://www.openh264.org/ for å se kildekoden og lese mer om implementasjonen.
