...
applications-type-column =
    ...
    .accesskey = d
applications-type-heading = Gundekuna dumi
applications-action-column =
    .label = Teera
    .accesskey = T
applications-action-heading = Teera
# Variables:
...
sync-mobile-promo = Fennec zumandi <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> wala <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> ka hangandi nda war kanbe jinaa.
