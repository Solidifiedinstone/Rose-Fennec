...
addon-badge-line3 =
    .title = Официално разширение то BrowserWorks. Отговаря на стандартите за сигурност и производителност
...
recommended-theme-1 = Чувствате се креативни? <a data-l10n-name="link"> Създайте своя собствена тема с Fennec Color.</a>
...
plugins-openh264-description = Тази приставка се инсталира автоматично от BrowserWorks за съвместимост със спецификацията на WebRTC, и за да направи възможни обаждания към устройства изискващи видео кодек H.264. Посетете http://www.openh264.org/, за да разгледате изходния код и да научите повече за реализацията.
