...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Документацията за данни от Fennec</a> съдържа напътствия как да боравите с нашите инструменти за данни.
...
about-telemetry-telemetry-dashboard = На <a data-l10n-name="dashboard-link">Таблата на Телеметрията</a> се изобразяват данните, които BrowserWorks получава от Телеметрията.
