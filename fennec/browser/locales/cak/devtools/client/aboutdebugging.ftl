...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Titzij USB Chojmirisanem pa Fennec pa ri Android okisab'äl.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Re ruwäch Fennec man nikitiïr ta nuchojmirisaj Fennec richin Android (68). Niqachilab'ej chi tiyak Fennec richin Android Nightly pan awoyonib'al richin nitojtob'ëx. <a>Juley retal</a>
...
about-debugging-browser-version-too-recent = Ri ruq'ijul samaj okisan yalan k'ak'a' ({ $runtimeVersion }, buildID { $runtimeID }) chuwäch ri { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Re re' jun man k'amonel ta chi nuk'ulem ri nitikïr nub'än chi nisach ri DevTools. Tak'exa' ri Fennec. <a>Kisolik taq k'ayewal</a>
