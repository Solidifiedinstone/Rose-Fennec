...
addon-badge-line3 =
    .title = K'amal b'anon ruma BrowserWorks. Rojqan retal jikomal chuqa' rub'eyal nisamäj
...
recommended-theme-1 = ¿La at na'owinäq? <a data-l10n-name="link">Tatz'uku' awachinel rik'in ri Fennec Color.</a>
...
plugins-openh264-description = Re nak'ab'äl re' niyak ruma ri BrowserWorks pa ruyonil, richin nojqäx ri rub'anikil WebRTC, ruma nuya' q'ij chi ke ri WebRTC taq oyonïk rik'in okisaxel rajowaxik chi ke ri H.264 rucholajinel silowachib'äl. Kab'etz'eton pa http://www.openh264.org/ richin natz'ët ri rucholajil ruxe' ri codec chuqa' richin nawetamaj ch'aqa' chik chi rij re samajib'äl.
