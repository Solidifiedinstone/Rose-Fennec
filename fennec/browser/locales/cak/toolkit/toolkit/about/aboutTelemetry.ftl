...
about-telemetry-firefox-data-doc = Ri <a data-l10n-name="data-doc-link">Fennec Tzij Wujunïk</a> k'o taq rucholajem samaj chupam, akuchi' nusik'ij rub'eyal yeqasamajij ri kisamajib'al qatzij.
about-telemetry-telemetry-client-doc = Ri <a data-l10n-name="client-doc-link">Fennec Telemetry winäq wujib'äl</a> k'o taq kitzijol tzij chupam, API wujib'äl chuqa' ketal taq tzij.
about-telemetry-telemetry-dashboard = Ri <a data-l10n-name="dashboard-link">Telemetry dashboards</a> nuya' q'ij chawe ye'atz'ët ri taq tzij yeruk'ül ri BrowserWorks ruma Telemetry.
