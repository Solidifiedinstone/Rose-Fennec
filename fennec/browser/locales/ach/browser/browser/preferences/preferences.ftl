...
sync-mobile-promo = Gam Fennec pi <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> onyo <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> me ribo ki nyonyo mamegi me cing.
...
sync-engine-addons =
    .label = Med-ikome
    .tooltiptext = Lamed ki theme pi Fennec desktop
    .accesskey = M
