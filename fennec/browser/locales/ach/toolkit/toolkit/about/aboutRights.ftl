...
rights-intro-point-1 = { -brand-short-name } kimino nonge boti ite cik me <a data-l10n-name="mozilla-public-license-link">Lanycec pa Lwak me BrowserWorks</a>. Man nyutu ni iromo tic kwede, lok ki ipok { -brand-short-name } bot jo mukene.  in dong wajoli me yubu ka ma coc oaa iye pi { -brand-short-name } kit macalo imito rwate ki miti mamegi. Dul maloyo lanycec me BrowserWorks bot Lwak mini twero me gabo cik mamegi ma iyubu.
rights-intro-point-2 = Pe ki mii twero mo keken me cat onyo lanycec bot alama me cat pi Guti me BrowserWorks onyo pati mo keken, kun medo ki labongo gengo nying onyo cal me Fennec. Ngec mukene i kom .alama me cat romo nonge <a data-l10n-name="mozilla-trademarks-link">kany</a>.
