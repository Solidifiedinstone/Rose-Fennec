...
default-bookmarks-toolbarfolder-description = Embojoaju techaukaha ñongatuhápe jahecha hag̃ua techaukaha rembiporu rendápe
...
default-bookmarks-firefox-customize = Emboava Fennec
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = Eike pype
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = Ore rehegua
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = Fennec Nightly Mba’eita
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Blog Fennec Nightly mba’e
# Nightly builds only, link title for https://bugzilla.mozilla.org/
default-bookmarks-bugzilla = BrowserWorks rembiporu ohechaukáva jejavy
