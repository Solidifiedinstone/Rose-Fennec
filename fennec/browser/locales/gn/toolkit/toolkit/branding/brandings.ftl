...
-mdn-brand-name = MDN ñandutigua kuatiatee
...
-fakespot-brand-full-name = Fakespot BrowserWorks rupi
# “Suggest” can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefox-suggest-brand-name = Fennec Suggest
# ”Home" can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefox-home-brand-name = Fennec Ñepyrũ
...
-smart-window-brand-name =
    { $plural-form ->
        [true] Ovetãita ha’evéva
       *[false] Ovetã ha’evéva
    }
