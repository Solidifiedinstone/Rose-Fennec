...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Fennec mba’ekuaarã kuatia</a> oreko guataha mba’éichapa emba’apóta mba’ekuaarã rembiporúre.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Telemetry Fennec mba’éva kuatiatee</a> ogueroike mba’e ñemoesakã, API kuatiatee ha mba’ekuaarã rehegua.
about-telemetry-telemetry-dashboard = Umi <a data-l10n-name="dashboard-link">Telemetry rechaha</a> ohechauka ndéve BrowserWorks mba’ekuaarã og̃uahẽva Telemetry rupive.
...
about-telemetry-error-fetching-symbols = Oiko peteĩ jejavy eguerusejeývo umi ta’ãnga’i. Ehechajey eimépa ñandutípe ha eha’ã jey upe rire.
