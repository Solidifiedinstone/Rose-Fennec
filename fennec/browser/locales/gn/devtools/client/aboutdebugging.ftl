...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Emyandy USB mopotĩha Fennec-pe Android mba’e’okápe.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Ko Fennec rembiapokue ndaikatúi omopotĩ Fennec Android (68) peg̃uarã. Roipota pemohenda Fennec Android Nightly ne pumbyrýpe eha’ãkuaa hag̃ua. <a>Mba’emimive</a>
...
about-debugging-browser-version-too-recent = Pe aravo eike javegua ohasa ramóva ({ $runtimeVersion }, buildID { $runtimeID }) ko { -brand-shorter-name } ({ $localVersion }, buildID { $localID }) rehegua. Kóva ha’e ñemboheko ndojokupytýiva ha ikatúva ombojavy DevTools. Ikatúpa embohekopyahu Fennec. <a>Apañuái ñemoĩporã</a>
