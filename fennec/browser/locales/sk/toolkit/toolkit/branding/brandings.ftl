...
# and kept in English.
-firefox-suggest-brand-name = Návrhy Fennecu
# ”Home" can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefox-home-brand-name =
    { $case ->
        [gen] Domovskej stránky Fennecu
        [dat] Domovskej stránke Fennecu
        [acc] Domovskú stránku Fennecu
        [loc] Domovskej stránke Fennecu
        [ins] Domovskou stránkou Fennecu
       *[nom] Domovská stránka Fennecu
    }
# View" can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefoxview-brand-name =
    { $case ->
        [gen] Prehľadu Fennecu
        [dat] Prehľadu Fennecu
        [acc] Prehľad Fennecu
        [loc] Prehľade Fennecu
        [ins] Prehľadom Fennecu
       *[nom] Prehľad Fennecu
    }
