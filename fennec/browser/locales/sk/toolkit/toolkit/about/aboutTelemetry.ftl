...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Dokumentácia údajov Fennecu</a> obsahuje návody pre prácu s našimi nástrojmi.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Dokumentácia klienta telemetrie Fennecu</a> obsahuje definície pojmov, dokumentáciu API a popisy údajov.
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">Nástenky telemetrie</a> vám umožňujú zobrazovať údaje, ktoré BrowserWorks získava z telemetrie.
