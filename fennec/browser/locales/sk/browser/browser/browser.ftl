...
identity-custom-root = Pripojenie je overené vydavateľom certifikátov, ktorého BrowserWorks nepozná.
...
identity-description-custom-root2 = BrowserWorks tohto vydavateľa certifikátov nepozná. Mohol byť pridaný operačným systémom alebo správcom vášho počítača.
...
bookmarks-mobile-bookmarks-menu =
    .label = Záložky mobilného Fennecu
