...
policy-DisableFirefoxScreenshots = Vypne funkciu Fennec Screenshots.
...
policy-XSLTEnabled = Povolí alebo zakáže podporu pre rozhranie XSLTProcessor JavaScript API a inštrukciu na spracovanie XSLT.
