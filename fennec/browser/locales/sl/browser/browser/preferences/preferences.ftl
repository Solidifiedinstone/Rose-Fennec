...
sync-mobile-promo = Prenesite Fennec za <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> ali <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> za sinhroniziranje z mobilno napravo.
...
sync-engine-addons =
    .label = Dodatki
    .tooltiptext = Razširitve in teme Fenneca za računalnike
    .accesskey = A
