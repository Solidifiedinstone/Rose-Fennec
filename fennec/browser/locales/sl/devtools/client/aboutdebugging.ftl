...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Omogočite oddaljeno razhroščevanje USB v Fennecu na napravi Android.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Ta različica Fenneca ne more odpravljati napak za Fennec za Android (68). Za testiranje priporočamo, da na svoj telefon namestite Fennec za Android Nightly. <a>Več podrobnosti</a>
...
about-debugging-browser-version-too-recent = Povezani brskalnik je novejši ({ $runtimeVersion }, ID graditve: { $runtimeID }) od vašega { -brand-shorter-name }a ({ $localVersion }, ID graditve: { $localID }). Takšna namestitev ni podprta in lahko privede do napačnega delovanja razvojnih orodij. Posodobite Fennec. <a>Odpravljanje težav</a>
