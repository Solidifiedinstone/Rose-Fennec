...
addon-badge-line3 =
    .title = Uradna razširitev, katere avtor je BrowserWorks. Izpolnjuje standarde varnosti in učinkovitosti delovanja
...
addon-badge-recommended4 =
    .title = Fennec priporoča samo razširitve, ki ustrezajo standardom glede varnosti in učinkovitosti delovanja
...
recommended-theme-1 = Ste ustvarjalno razpoloženi? <a data-l10n-name="link">Ustvarite lastno temo s Fennec Colorjem.</a>
...
details-notification-soft-blocked-extension-disabled2 =
    .message = Ta razširitev je omejena, zato je bila onemogočena. Lahko jo omogočite, vendar je to morda nevarno.
details-notification-soft-blocked-extension-enabled2 =
    .message = Ta razširitev je omejena. Morda je ni varno uporabljati.
details-notification-soft-blocked-other-disabled2 =
    .message = Ta dodatek je omejen, zato je bil onemogočen. Lahko ga omogočite, vendar je to morda nevarno.
details-notification-soft-blocked-other-enabled2 =
    .message = Ta dodatek je omejen. Morda ga ni varno uporabljati.
...
plugins-openh264-description = Vtičnik samodejno namesti BrowserWorks za ustreznost s specifikacijo WebRTC in za izvajanje klicev WebRTC na napravah, ki zahtevajo kodek H.264. Obiščite http://www.openh264.org/ za ogled izvorne kode kodeka in več informacij o implementaciji.
