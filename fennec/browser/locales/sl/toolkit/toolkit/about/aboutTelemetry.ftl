...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Dokumentacija o Fennecovih podatkih</a> vsebuje vodnike o tem, kako uporabljati naša podatkovna orodja.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Dokumentacija o Fennecovem odjemalcu za telemetrijo</a> vsebuje definicije konceptov, dokumentacijo API in sklice podatkov.
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">Pregledne plošče telemetrije</a> omogočajo predstavitev podatkov, ki jih BrowserWorks prejme preko telemetrije.
