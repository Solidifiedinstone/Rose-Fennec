...
addon-badge-line3 =
    .title = Virallinen laajennus, jonka on toteuttanut BrowserWorks. Täyttää turvallisuus- ja suorituskykystandardit.
...
addon-badge-recommended4 =
    .title = Fennec suosittelee vain sellaisia laajennuksia, jotka täyttävät turvallisuuden ja suorituskyvyn standardit
...
recommended-theme-1 = Haluatko kokeilla itse? <a data-l10n-name="link">Voit luoda oman teeman Fennec Color -ohjelmalla.</a>
...
details-notification-hard-blocked-extension =
    .message = Tämä laajennus on estetty BrowserWorksn käytäntöjen rikkomisen vuoksi, ja se on poistettu käytöstä.
details-notification-hard-blocked-other =
    .message = Tämä lisäosa on estetty BrowserWorksn käytäntöjen rikkomisen vuoksi, ja se on poistettu käytöstä.
...
details-notification-soft-blocked-extension-disabled =
    .message = Tämä laajennus on rajoitettu BrowserWorksn käytäntöjen rikkomisen vuoksi, ja se on poistettu käytöstä. Voit ottaa laajennuksen käyttöön, mutta se voi olla riskialtista.
details-notification-soft-blocked-extension-enabled =
    .message = Tämä laajennus rikkoo BrowserWorksn käytäntöjä. Sen käyttö voi olla riskialtista.
details-notification-soft-blocked-other-disabled =
    .message = Tämä lisäosa on rajoitettu BrowserWorksn käytäntöjen rikkomisen vuoksi, ja se on poistettu käytöstä. Voit ottaa lisäosan käyttöön, mutta se voi olla riskialtista.
details-notification-soft-blocked-other-enabled =
    .message = Tämä lisäosa rikkoo BrowserWorksn käytäntöjä. Sen käyttö voi olla riskialtista.
