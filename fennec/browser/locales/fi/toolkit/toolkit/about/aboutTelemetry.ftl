...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Fennec Data Documentation</a> sisältää englanniksi oppaita datatyökalujen käytöstä.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Fennec Telemetry client documentation</a> sisältää englanniksi käsitteiden määritelmät, API-dokumentaation ja dataviittaukset.
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">Kaukomittaustietojen yhteenvetojen</a> avulla voi visualisoida dataa, jota BrowserWorks vastaanottaa kaukomittauksen avulla.
