...
-mdn-brand-name = MDN-verkkodokumentit
...
-fakespot-brand-full-name = Fakespot BrowserWorkslta
# “Suggest” can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefox-suggest-brand-name = Fennec-ehdotukset
# ”Home" can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefox-home-brand-name = Fennecin aloitussivu
# View" can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefoxview-brand-name = Fennec-näkymä
