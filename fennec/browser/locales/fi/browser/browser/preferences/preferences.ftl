...
sync-mobile-promo = Lataa Fennec <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Androidille</a> tai <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS:lle</a> ja synkronoi tietosi kannettavalle laitteellesi.
...
sync-engine-addresses =
    .label = Osoitteet
    .tooltiptext = Tallentamasi postiosoitteet (vain Fennecin työpöytäversiossa)
    .accesskey = O
sync-engine-creditcards =
    .label = Luottokortit
    .tooltiptext = Nimet, numerot ja vanheneminen (vain Fennecin työpöytäversiossa)
    .accesskey = u
...
sync-engine-addons =
    .label = Lisäosat
    .tooltiptext = Fennecin työpöytäversion laajennukset ja teemat
    .accesskey = i
...
addressbar-firefox-suggest-online =
    .label = Vastaanota ehdotuksia BrowserWorkssta kirjoittaessasi
