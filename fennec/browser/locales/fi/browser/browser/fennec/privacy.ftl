...
telemetry-page-subtitle = Fennec ei kerää telemetriatietoa asennuksestasi - kaikki telemetriamoduulit poistetaan käytöstä, kun selain koostetaan. Se, mitä teet selaimellasi, on vain sinun tiedossasi.
