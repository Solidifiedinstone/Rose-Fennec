...
enable-fennec-theme-0 =
    .label = Käytä Fennec-teemamukautuksia kaikissa teemoissa

enable-fennec-theme-1 =
    .label = Käytä Fennec-teemamukautuksia Fennec-teemoissa

enable-fennec-theme-2 =
    .label = Poista Fennec-teemamukautukset käytöstä
