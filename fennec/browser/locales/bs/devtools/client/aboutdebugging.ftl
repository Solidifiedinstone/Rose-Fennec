...
about-debugging-sidebar-this-firefox2 = Ovaj { -brand-shorter-name }
about-debugging-sidebar-this-firefox-title =
    .title = Ovaj { -brand-shorter-name }
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = Konfiguracija
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Omogućite USB otklanjanje grešaka u Fennecu na Android uređaju.
# USB section step by step guide
...
# runtimes.
about-debugging-runtime-profile-button2 = Performanse profila
# This string is displayed in the runtime page if the current configuration of the
# target runtime is incompatible with service workers. "Learn more" points to:
# https://firefox-source-docs.mozilla.org/devtools-user/about_colon_debugging/index.html#service-workers-not-compatible
about-debugging-runtime-service-workers-not-compatible = Konfiguracija vašeg preglednika nije kompatibilna sa Service Workerima. <a>Saznajte više</a>
# This string is displayed in the runtime page if the remote browser version is too old.
# "Troubleshooting" link points to https://firefox-source-docs.mozilla.org/devtools-user/about_colon_debugging/
# { $runtimeVersion } is the version of the remote browser (for instance "67.0a1")
# { $minVersion } is the minimum version that is compatible with the current Firefox instance (same format)
about-debugging-browser-version-too-old = Povezani preglednik ima staru verziju ({ $runtimeVersion }). Minimalna podržana verzija je ({ $minVersion }). Ovo je nepodržana postavka i može uzrokovati neuspjeh DevToolsa. Molimo ažurirajte povezani preglednik. <a>Rješavanje problema</a>
# Dedicated message for a backward compatibility issue that occurs when connecting:
# from Fx 70+ to the old Firefox for Android (aka Fennec) which uses Fx 68.
about-debugging-browser-version-too-old-fennec = Ova verzija Fenneca ne može otklanjati greške u Fennecu za Android (68). Preporučujemo da instalirate Fennec za Android Nightly na svoj telefon radi testiranja. <a>Više detalja</a>
...
about-debugging-browser-version-too-recent = Povezani preglednik je noviji ({ $runtimeVersion }, buildID { $runtimeID }) od vašeg { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Ovo je nepodržana postavka i može uzrokovati neuspjeh DevToolsa. Molimo vas da ažurirate Fennec. <a>Rješavanje problema</a>
...
about-debugging-runtime-disconnect-button = Prekini vezu
# Text of the connection prompt button displayed in Runtime pages, when the preference
# "devtools.debugger.prompt-connection" is false on the target runtime.
about-debugging-connection-prompt-enable-button = Omogući upit za povezivanje
# Text of the connection prompt button displayed in Runtime pages, when the preference
# "devtools.debugger.prompt-connection" is true on the target runtime.
about-debugging-connection-prompt-disable-button = Onemogući upit za povezivanje
# Title of a modal dialog displayed on remote runtime pages after clicking on the Profile Runtime button.
about-debugging-profiler-dialog-title2 = Alat za profiliranje
# Clicking on the header of a debug target category will expand or collapse the debug
# target items in the category. This text is used as ’title’ attribute of the header,
# to describe this feature.
about-debugging-collapse-expand-debug-targets = Sažmi / proširi

# Debug Targets strings

# Displayed in the categories of "runtime" pages that don't have any debug target to
# show. Debug targets depend on the category (extensions, tabs, workers...).
about-debugging-debug-target-list-empty = Ništa još.
# Text of a button displayed next to debug targets of "runtime" pages. Clicking on this
# button will open a DevTools toolbox that will allow inspecting the target.
# A target can be an addon, a tab, a worker...
about-debugging-debug-target-inspect-button = Pregledaj
# Text of a button displayed in the "This Firefox" page, in the Temporary Extension
# section. Clicking on the button will open a file picker to load a temporary extension
about-debugging-tmp-extension-install-button = Učitaj privremeni dodatak…
# Text displayed when trying to install a temporary extension in the "This Firefox" page.
about-debugging-tmp-extension-install-error = Došlo je do greške tokom instalacije privremenog dodatka.
# Text of a button displayed for a temporary extension loaded in the "This Firefox" page.
# Clicking on the button will reload the extension.
about-debugging-tmp-extension-reload-button = Obnovi
# Text of a button displayed for a temporary extension loaded in the "This Firefox" page.
...
about-debugging-tmp-extension-terminate-bgscript-button = Završi pozadinsku skriptu
# Message displayed in the file picker that opens to select a temporary extension to load
# (triggered by the button using "about-debugging-tmp-extension-install-button")
# manifest.json .xpi and .zip should not be localized.
# Note: this message is only displayed in Windows and Linux platforms.
about-debugging-tmp-extension-install-message = Odaberite datoteku manifest.json ili .xpi/.zip arhivu
# This string is displayed as a message about the add-on having a temporaryID.
about-debugging-tmp-extension-temporary-id = Ova web ekstenzija ima privremeni ID. <a>Saznajte više</a>
...
about-debugging-extension-backgroundscript =
    .label = Pozadinski skript
# Displayed for extension using a non-persistent background page (either an event page or
# background service worker) when the background script is currently running.
about-debugging-extension-backgroundscript-status-running = Pokrenuto
...
about-debugging-worker-action-push2 = Push
    .disabledTitle = Push za Service Worker je trenutno onemogućen za višestruki proces { -brand-shorter-name }a
# This string is displayed as a label of the button that starts a service worker.
# .disabledTitle is processed by the fluent-react / ActionButton code.
about-debugging-worker-action-start2 = Pokretanje
    .disabledTitle = Pokretanje Service Workera je trenutno onemogućeno za višestruki proces { -brand-shorter-name }
# This string is displayed as a label of the button that unregisters a service worker.
about-debugging-worker-action-unregister = Odregistruj
# Displayed for service workers in runtime pages that listen to Fetch events.
about-debugging-worker-fetch-listening =
    .label = Dohvati
    .value = Osluškuje događaje dohvaćanja
# Displayed for service workers in runtime pages that do not listen to Fetch events.
about-debugging-worker-fetch-not-listening =
    .label = Dohvati
    .value = Ne osluškuje događaje dohvaćanja
# Displayed for service workers in runtime pages that are currently running (service
# worker instance is active).
about-debugging-worker-status-running = Pokrenuto
# Displayed for service workers in runtime pages that are registered but stopped.
about-debugging-worker-status-stopped = Zaustavljeno
# Displayed for service workers in runtime pages that are registering.
about-debugging-worker-status-registering = Registrujem
...
about-debugging-worker-inspect-action-disabled =
    .title = Inspekcija service workera je trenutno onemogućena za višeprocesni proces { -brand-shorter-name }a
# Displayed as title of the inspect button for zombie tabs (e.g. tabs loaded via a session restore).
about-debugging-zombie-tab-inspect-action-disabled =
    .title = Tab nije u potpunosti učitan i ne može se pregledati
# Displayed as name for the Main Process debug target in the Processes category. Only for
# remote runtimes, if `devtools.aboutdebugging.process-debugging` is true.
about-debugging-multiprocess-toolbox-name = Višeprocesni alatni okvir
