...
pane-search-title2 = Traži
    .title = Traži
pane-privacy-title3 = Privatnost & sigurnost
    .title = Privatnost & sigurnost
category-home =
...
pane-experimental-reset =
    ...
    .accesskey = R
help-button-label2 = { -brand-short-name } podrška
    .title = { -brand-short-name } podrška
addons-button-label2 = Ekstenzije i teme
    .title = Ekstenzije i teme
...
applications-setting-new-file-types =
    .label = Šta { -brand-short-name } treba da radi sa drugim datotekama?
...
applications-type-column =
    .label = Tip sadržaja
    .accesskey = T
applications-type-heading = Tip sadržaja
...
search-suggestions-cant-show-2 =
    .message = Prijedlozi za pretragu neće biti prikazani u rezultatima lokacijske trake jer ste podesili { -brand-short-name } da ne pamti historiju.
...
sync-mobile-promo = Preuzmi Fennec za <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> ili <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> za sinhronizaciju sa vašim mobilnim uređajem.
...
sync-engine-addons =
    .label = Add-oni
    .tooltiptext = Ekstenzije i teme za Fennec desktop
    .accesskey = A
