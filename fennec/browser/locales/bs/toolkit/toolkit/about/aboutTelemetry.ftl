...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Fennec Data Documentation</a> sadrži vodiče kako koristiti naše podatkovne alate.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Fennec Telemetry client documentation</a> uključuje definicije koncepata, API dokumentaciju i podatkovne reference.
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">Telemetry dashboard-i</a> vam omogućavaju da vizualizirate podatke koje BrowserWorks prima putem Telemetrije.
