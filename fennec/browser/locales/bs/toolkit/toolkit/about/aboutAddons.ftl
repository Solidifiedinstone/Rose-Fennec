...
addon-badge-line3 =
    .title = Zvanična ekstenzija koju je izradila BrowserWorks. Ispunjava standarde sigurnosti i performansi
...
addon-badge-recommended4 =
    .title = Fennec preporučuje samo ekstenzije koje ispunjavaju standarde sigurnosti i performansi
...
recommended-theme-1 = Osjećate se kreativno? <a data-l10n-name="link">Napravite vlastitu temu uz Fennec Color.</a>
...
details-notification-hard-blocked-extension =
    .message = Ova ekstenzija je blokirana zbog kršenja BrowserWorks pravila i onemogućena je.
...
details-notification-soft-blocked-extension-disabled =
    .message = Ova ekstenzija je ograničena zbog kršenja BrowserWorks pravila i onemogućena je. Možete je omogućiti, ali ovo može biti rizično.
