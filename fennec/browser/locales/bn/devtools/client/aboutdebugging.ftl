...
about-debugging-sidebar-setup2 = সেটআপ
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = অ্যান্ড্রয়েড ডিভাইসে Fennec এ ইউএসবি ডিবাগিং সক্রিয় করুন।
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Fennec-এর এই সংস্করণটি Android (68) এর জন্য Fennec কে ডিবাগ করতে পারে না। আমরা আপনার ফোনে পরীক্ষার জন্য Fennec এর Android Nightly সংষ্করণ ইনস্টল করার পরামর্শ দিচ্ছি। <a>আরো জানুন</a>
...
about-debugging-browser-version-too-recent = সংযুক্ত ব্রাউজারটি ({ $runtimeVersion }, buildID { $runtimeID }) আপনার { -brand-shorter-name } ({ $localVersion }, buildID { $localID }) এর তুলনায় অধিক নতুন। এটি একটি অসমর্থিত সেটআপ এবং DevTools কে বিকল করে দিতে পারে। অনুগ্রহ করে Fennec হালনাগাদ করুন। <a>সমস্যা সমাধান</a>
...
about-debugging-tmp-extension-terminate-bgscript-button = ব্যাকগ্রাউন্ড স্ক্রিপ্ট বন্ধ করুন
...
about-debugging-extension-backgroundscript =
    .label = ব্যাকগ্রাউন্ড স্ক্রিপ্ট
# Displayed for extension using a non-persistent background page (either an event page or
# background service worker) when the background script is currently running.
about-debugging-extension-backgroundscript-status-running = চলমান
# Displayed for extension using a non-persistent background page when is currently stopped.
about-debugging-extension-backgroundscript-status-stopped = থেমে গেছে
...
about-debugging-zombie-tab-inspect-action-disabled =
    .title = ট্যাব সম্পূর্ণ লোড হয়নি এবং পরিদর্শন করা যাবে না
...
about-debugging-multiprocess-toolbox-description = নির্ধারিত (টার্গেট) ব্রাউজারের জন্য মেইন প্রসেস এবং কনটেন্ট প্রসেস
# Alt text used for the close icon of message component (warnings, errors and notifications).
about-debugging-message-close-icon2 =
    .tooltiptext = বার্তা বন্ধ করুন
# Alt text used for the close icon of message component (warnings, errors and notifications).
