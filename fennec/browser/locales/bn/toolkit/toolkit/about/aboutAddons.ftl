...
recommended-theme-1 = সৃজনশীল মনে হচ্ছে? <a data-l10n-name="link">Fennec Color দিয়ে নিজের থিম তৈরি করুন।</a>
