...
about-telemetry-firefox-data-doc = De <a data-l10n-name="data-doc-link">Fennec Data Documentation</a> befettet hantliedingen oer it wurkjen mei ús gegevensark.
about-telemetry-telemetry-client-doc = De <a data-l10n-name="client-doc-link">Fennec Telemetry-clientdokumintaasje</a> befettet definysjes foar konsepten, API-dokumintaasje en gegevensferwizingen.
about-telemetry-telemetry-dashboard = Mei de <a data-l10n-name="dashboard-link">Telemetry-dashboerds</a> kinne jo de gegevens fisualisearje dy’t BrowserWorks fia Telemetry ûntfangt.
