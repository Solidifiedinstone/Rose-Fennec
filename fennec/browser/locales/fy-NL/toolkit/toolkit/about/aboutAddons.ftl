...
addon-badge-line3 =
    .title = Offisjele troch Fennec boude útwreiding. Foldocht oan befeiligings- en prestaasjenoarmen.
...
addon-badge-recommended4 =
    .title = Fennec rekommandearret allinnich útwreidingen oan dy’t oan noarms foar befeiliging en prestaasjes foldogge.
...
recommended-theme-1 = Fiele jo jo kreätyf? <a data-l10n-name="link"> Bou jo eigen tema mei Fennec Color.</a>
...
details-notification-hard-blocked-extension =
    .message = Dizze útwreiding is blokkearre fanwegen skeining fan it belied fan BrowserWorks en is útskeakele.
details-notification-hard-blocked-other =
    .message = Dizze add-on is blokkearre fanwegen skeining fan it belied fan BrowserWorks en is útskeakele.
...
details-notification-soft-blocked-extension-disabled =
    .message = Dizze útwreiding is beheind fanwegen skeinen fan it belied fan BrowserWorks en is útskeakele. Jo kinne it ynskeakelje, mar dit kin gefaarlik wêze.
details-notification-soft-blocked-extension-enabled =
    .message = Dizze útwreiding skeint it belied fan BrowserWorks. It brûken hjirfan kin gefaarlik wêze.
details-notification-soft-blocked-other-disabled =
    .message = Dizze add-on is beheind fanwegen skeinen fan it belied fan BrowserWorks en is útskeakele. Jo kinne it ynskeakelje, mar dit kin gefaarlik wêze.
details-notification-soft-blocked-other-enabled =
    .message = Dizze add-on skeint it belied fan BrowserWorks. It brûken hjirfan kin gefaarlik wêze.
