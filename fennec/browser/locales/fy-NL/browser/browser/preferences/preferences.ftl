...
sync-mobile-promo = Download Fennec foar <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> of <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> om mei jo mobile apparaat te syngronisearjen.
...
sync-engine-addons =
    .label = Add-ons
    .tooltiptext = Utwreidingen en tema’s foar Fennec foar desktop
    .accesskey = A
...
addressbar-firefox-suggest-online =
    .label = Suggestjes fan BrowserWorks ophelje wylst jo type
...
preferences-ai-controls-pdfjs-control =
    .label = Alternative tekst bij ôfbyldingen yn { -brand-short-name }-pdf-lêzer
...
preferences-ai-controls-block-confirmation-pdfjs = Alternative tekst bij ôfbyldingen yn { -brand-short-name }-pdf-lêzer
...
security-privacy-issue-warning-third-party-cookies =
    .label = Cookies fan tredden binne útskeakele
