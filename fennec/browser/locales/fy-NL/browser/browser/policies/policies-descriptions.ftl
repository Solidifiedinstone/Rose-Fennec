...
policy-DefaultSerialGuardSetting = Gebrûk fan de seriële API beheare.
...
policy-DisableFirefoxScreenshots = De Fennec Screenshots-funksje útskeakelje.
...
policy-DisableRemoteImprovements = Foarkomme dat { -brand-short-name } prestaasjes, stabiliteit en funksjes tapast tusken fernijingen.
policy-DisableRemoteSettingsAndAcceptSecurityConsequences = Eksterne ynstellingen útskeakelje.
...
policy-XSLTEnabled = Stipe foar de XSLTProcessor JavaScript-API en de XSLT-ferwurkingsynstruksje yn- of útskeakelje.
