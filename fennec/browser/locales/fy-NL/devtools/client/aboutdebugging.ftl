...
about-debugging-sidebar-this-firefox2 = Dizze { -brand-shorter-name }
about-debugging-sidebar-this-firefox-title =
    .title = Dizze { -brand-shorter-name }
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = Konfiguraasje
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = USB-flateropspoaring yn Fennec op it Android-apparaat ynskeakelje.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Dizze ferzje fan Fennec kin Fennec foar Android (68) net debugge. Wy riede oan om foar testdoeleinen Fennec foar Android Nightly op jo telefoan te ynstallearjen. <a>Mear ynfo</a>
...
about-debugging-browser-version-too-recent = De ferbûne browser is resinter ({ $runtimeVersion }, buildID { $runtimeID }) as jo { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Dizze konfiguraasje wurdt net stipe en kin derfoar soargje dat DevTools net goed wurket. Wurkje Fennec by. <a>Probleemoplossing</a>
