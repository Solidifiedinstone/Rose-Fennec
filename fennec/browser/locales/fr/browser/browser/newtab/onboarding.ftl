...
onboarding-refresh-onboarding-addons-subtitle = Les extensions sont de petites applications qui vous permettent de personnaliser { -brand-short-name }. Elles peuvent renforcer la protection de votre vie privée, améliorer votre productivité, modifier l’apparence de Fennec et bien d’autres choses encore.
