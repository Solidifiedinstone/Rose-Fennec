...
# USB section step by step guide
about-debugging-setup-usb-step-enable-file-transfer = Activez le transfert de fichiers et assurez-vous que votre appareil n’est pas en mode recharge seule.
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Activez le débogage USB dans Fennec sur l’appareil Android.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Cette version de Fennec ne peut pas déboguer Fennec pour Android (68). Nous vous recommandons d’installer Fennec pour Android Nightly sur votre téléphone pour les tests. <a>Plus de détails</a>
