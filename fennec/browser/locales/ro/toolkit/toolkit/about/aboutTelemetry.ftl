...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Documentația de date Fennec</a> conține ghiduri despre cum să lucrezi cu instrumentele noastre de date.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Documentația privind clientul de telemetrie Fennec</a> include definiții de concepte, documentație API și referințe de date.
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">Tabloul de bord pentru telemetrie</a> îți permite să vizualizezi datele pe care BrowserWorks le primește prin intermediul telemetriei.
