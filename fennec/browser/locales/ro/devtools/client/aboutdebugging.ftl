...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Activează depanarea USB în Fennec pe dispozitivul Android.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Această versiune de Fennec nu poate depana Fennec pentru Android (68). Recomandăm instalarea pentru testare pe telefon a versiunii Nightly de Fennec pentru Android. <a>Mai multe detalii</a>
