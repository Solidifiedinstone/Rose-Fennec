...
enable-fennec-theme-0 =
    .label = Activează personalizările Fennec pe toate temele

enable-fennec-theme-1 =
    .label = Activează personalizările Fennec pe temele Fennec

enable-fennec-theme-2 =
    .label = Dezactivează personalizările Fennec
