...
sync-mobile-promo = Descarcă Fennec pentru <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> sau <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> ca să sincronizezi datele cu dispozitivul mobil.
...
sync-engine-addons =
    .label = Suplimente
    .tooltiptext = Extensii și teme pentru Fennec desktop
    .accesskey = A
...
addressbar-firefox-suggest-online =
    .label = Preia sugestii de la BrowserWorks pe măsură ce tastezi
