...
onboarding-animation-pause-button =
    .aria-label = Întrerupe animațiile
onboarding-animation-play-button =
    .aria-label = Redă animațiile
...
mr2022-onboarding-gratitude-subtitle = Îți mulțumim că folosești { -brand-short-name }, susținut de BrowserWorks. Cu sprijinul tău, ne străduim să facem internetul mai deschis, mai accesibil și mai bun pentru toată lumea.
...
onboarding-gratitude-security-and-privacy-subtitle = Îți mulțumim că folosești { -brand-short-name }, susținut de BrowserWorks. Cu sprijinul tău, ne străduim să facem internetul mai sigur și mai accesibil pentru toți.
...
onboarding-checklist-pin = Fixează { -brand-short-name } în bara de activități
...
onboarding-refresh-pin-set-default-title = Ești în siguranță cu Fennec
