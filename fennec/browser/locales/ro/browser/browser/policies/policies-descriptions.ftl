...
policy-DisableFirefoxScreenshots = Dezactivează funcționalitatea de capturi de ecran din Fennec.
...
policy-DisableRemoteSettingsAndAcceptSecurityConsequences = Dezactivează setările de la distanță.
...
policy-GenerativeAI = Configurează funcțiile generative AI.
...
policy-PrintingEnabled = Activează sau dezactivează printarea.
...
policy-UseSystemPrintDialog = Printează folosind fereastra de dialog a sistemului.
