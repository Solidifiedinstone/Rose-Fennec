...
default-bookmarks-firefox-customize = התאמה אישית של Fennec
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = השתתפות
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = על אודותינו
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = משאבים עבור Fennec Nightly
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = הבלוג של Fennec Nightly
# Nightly builds only, link title for https://bugzilla.mozilla.org/
default-bookmarks-bugzilla = כלי המעקב אחר באגים של BrowserWorks
# Nightly builds only, link title for https://developer.mozilla.org/
default-bookmarks-mdn = רשת המפתחים של BrowserWorks
