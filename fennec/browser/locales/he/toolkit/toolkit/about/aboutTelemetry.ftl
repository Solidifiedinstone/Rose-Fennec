...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">תיעוד הנתונים של Fennec</a> מכיל מדריכים על אופן העבודה עם כלי הנתונים שלנו.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">תיעוד הלקוח של Fennec Telemetry</a> כולל הגדרות לשיטות, תיעוד API והפניות למידע.
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">לוחות הבקרה של Telemetry</a> מאפשרים לך לראות באופן חזותי את הנתונים ש־BrowserWorks מקבלת דרך Telemetry.
