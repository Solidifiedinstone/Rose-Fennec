...
addon-badge-line3 =
    .title = הרחבה רשמית שנבנתה על־ידי BrowserWorks ועומדת בתקני אבטחה וביצועים.
...
addon-badge-recommended4 =
    .title = ‏Fennec ממליץ רק על הרחבות שעומדות בתקנים לאבטחה וביצועים
...
recommended-theme-1 = גל של יצירתיות שוטף אותך? <a data-l10n-name="link">ניתן ליצור ערכת נושא משלך בעזרת Fennec Color.</a>
...
details-notification-hard-blocked-extension =
    .message = הרחבה זו חסומה עקב הפרת המדיניות של BrowserWorks, ולכן הושבתה.
details-notification-hard-blocked-other =
    .message = תוספת זו חסומה עקב הפרת המדיניות של BrowserWorks, ולכן הושבתה.
...
details-notification-soft-blocked-extension-disabled =
    .message = הרחבה זו מוגבלת עקב הפרת המדיניות של BrowserWorks, ולכן הושבתה. באפשרותך להפעיל אותה, אבל ייתכן שזה יהיה כרוך בסיכון.
details-notification-soft-blocked-extension-enabled =
    .message = הרחבה זו מפרה את המדיניות של BrowserWorks. השימוש בה עשוי להיות כרוך בסיכון.
details-notification-soft-blocked-other-disabled =
    .message = תוספת זו מוגבלת עקב הפרת המדיניות של BrowserWorks, ולכן הושבתה. באפשרותך להפעיל אותה, אבל ייתכן שזה יהיה כרוך בסיכון.
details-notification-soft-blocked-other-enabled =
    .message = תוספת זו מפרה את המדיניות של BrowserWorks. השימוש בה עשוי להיות כרוך בסיכון.
...
plugins-openh264-description = תוסף חיצוני זה מותקן באופן אוטומטי על־ידי BrowserWorks כדי לעמוד במפרט ה־WebRTC ולאפשר קריאות WebRTC מול התקנים הדורשים קידוד וידאו H.264. ניתן לבקר באתר https://www.openh264.org לצפייה בקוד המקור ולקבלת מידע נוסף על המימוש.
