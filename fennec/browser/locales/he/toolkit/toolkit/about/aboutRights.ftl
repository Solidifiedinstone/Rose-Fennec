...
rights-intro-point-1 = { -brand-short-name } ניתן לך תחת התנאים של <a data-l10n-name="mozilla-public-license-link">הרישיון הציבורי של BrowserWorks</a>. משמעות הדבר היא שניתן להשתמש ב־{ -brand-short-name }, להעתיקו ולהפיצו לאחרים, כמו גם לשנות את קוד המקור של { -brand-short-name } בדרך המתאימה ביותר לצרכיך. הרישיון הציבורי של BrowserWorks גם נותן לך את הזכות להפיץ את הגרסאות עם השינויים שלך.
rights-intro-point-2 = לא הוענקה לך אף זכות בסמל המסחרי או רישיונות לסמל המסחרי של קרן BrowserWorks או חלקן, לא כולל הגבלה על השם או הלוגו של Fennec. מידע נוסף על הסמלים המסחריים נמצא <a data-l10n-name="mozilla-trademarks-link">כאן</a>.
