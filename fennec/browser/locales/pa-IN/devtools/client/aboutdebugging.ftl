...
about-debugging-sidebar-this-firefox2 = ਇਹ { -brand-shorter-name }
about-debugging-sidebar-this-firefox-title =
    .title = ਇਹ { -brand-shorter-name }
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = ਸੈਟਅੱਪ
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Android ਡਿਵਾਈਸ ਉੱਤੇ Fennec ਵਿੱਚ USB ਡੀਬੱਗਿੰਗ ਨੂੰ ਸਮਰੱਥ ਬਣਾਓ।
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Fennec ਦਾ ਇਹ ਵਰਜ਼ਨ Android ਲਈ Fennec (68) ਨੂੰ ਡੀਬੱਗ ਨਹੀਂ ਕਰ ਸਕਦਾ ਹੈ। ਅਸੀਂ ਟੈਸਟ ਕਰਨ ਲਈ ਤੁਹਾਡੇ ਫ਼ੋਨ ਉੱਤੇ Android ਲਈ Fennec ਇੰਸਟਾਲ ਕਰਨ ਦੀ ਸਿਫ਼ਾਰਸ਼ ਕਰਦੇ ਹਾਂ। <a>hੋਰ ਵੇਰਵੇ</a>
