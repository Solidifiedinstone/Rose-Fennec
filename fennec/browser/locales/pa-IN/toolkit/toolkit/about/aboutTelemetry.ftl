...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Fennec ਡਾਟਾ ਦਸਤਾਵੇਜ਼ (ਅੰਗਰੇਜ਼ੀ)</a> ਵਿੱਚ ਗਾਈਡਾਂ ਹਨ, ਜੋ ਕਿ ਸਾਡੇ ਡਾਟਾ ਟੂਲ ਨਾਲ ਕੰਮ ਕਰਨ ਬਾਰੇ ਜਾਣਕਾਰੀ ਦਿੰਦੀਆਂ ਹਨ।
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Fennec ਟੈਲੀਮੈਂਟਰੀ ਕਲਾਈਂਟ ਦਸਤਾਵੇਜ਼</a> ਵਿੱਚ ਸੰਕਲਪ ਦੀਆਂ ਪਰਿਭਾਸ਼ਾਵਾਂ, API ਦਸਤਾਵੇਜ਼ ਅਤੇ ਡਾਟਾ ਹਵਾਲੇ ਮੌਜੂਦ ਹਨ।
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">ਟੈਲੀਮੈਂਟਰੀ ਡੈਸ਼ਬੋਰਡ</a> ਤੁਹਾਨੂੰ BrowserWorks ਨੂੰ ਟੈਲੀਮੈਂਟਰੀ ਰਾਹੀਂ ਮਿਲੇ ਡਾਟੇ ਨੂੰ ਦਿਖਾਉਂਦਾ ਹੈ।
