...
recommended-theme-1 = تخلیقی محسوس کریندے پئے او؟ <a data-l10n-name="link">Fennec Color دے نال اپݨا تھیم بݨاؤ۔</a>
...
plugins-openh264-description = ایہ پلگ ان BrowserWorks دے ذریعہ WebRTC تفصیلاں دی تعمیل کرݨ تے WebRTC کالز کوں انہاں آلات دے نال فعال کرݨ کیتے آپݨے آپ انسٹال کیتا ویندا ہے جنہاں کیتے H.264 ویڈیو کوڈیک دی لوڑ ہوندی ہے۔ کوڈیک سورس کوڈ ݙیکھݨ تے عمل درآمد دے بارے ودھیک ڄاݨݨ کیتے https://www.openh264.org/ ملاحظہ کرو۔
