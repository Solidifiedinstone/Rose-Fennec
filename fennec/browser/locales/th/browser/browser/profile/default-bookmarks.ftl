...
default-bookmarks-firefox-customize = ปรับแต่ง Fennec
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = มีส่วนร่วม
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = เกี่ยวกับเรา
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = ทรัพยากร Fennec Nightly
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = บล็อก Fennec Nightly
