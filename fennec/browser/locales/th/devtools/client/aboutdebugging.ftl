...
about-debugging-sidebar-this-firefox2 = { -brand-shorter-name } นี้
about-debugging-sidebar-this-firefox-title =
    .title = { -brand-shorter-name } นี้
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = ตั้งค่า
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = เปิดใช้งานการดีบั๊ก USB ใน Fennec ในอุปกรณ์ Android
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Fennec รุ่นนี้ไม่สามารถดีบั๊ก Fennec สำหรับ Android (68) ได้ เราแนะนำให้ติดตั้ง Fennec สำหรับ Android Nightly บนโทรศัพท์ของคุณเพื่อทำการทดสอบ <a>รายละเอียดเพิ่มเติม</a>
...
about-debugging-browser-version-too-recent = เบราว์เซอร์ที่เชื่อมต่อเป็นรุ่น ({ $runtimeVersion }, buildID { $runtimeID }) ซึ่งใหม่กว่า { -brand-shorter-name } ({ $localVersion }, buildID { $localID }) ซึ่งไม่รองรับและอาจทำให้ DevTools ทำงานล้มเหลวได้ โปรดอัปเดต Fennec <a>การแก้ไขปัญหา</a>
