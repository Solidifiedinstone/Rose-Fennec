...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Engedélyezze az USB-s hibakeresést a Fennecban az androidos eszközén.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = A Fennec ezen verziója nem tud hibát keresni a Fennec for Androidban (68). Javasoljuk, hogy a teszteléshez telepítse a Fennec for Android Nightlyt a telefonjára. <a>További részletek</a>
