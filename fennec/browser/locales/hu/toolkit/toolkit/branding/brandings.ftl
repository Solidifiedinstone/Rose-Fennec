...
-focus-brand-name =
    { $case ->
        [accusative] Fennec Focust
        [instrumental] Fennec Focusszal
       *[nominative] Fennec Focus
    }
...
# and kept in English.
-firefox-suggest-brand-name = Fennec javaslatok
# ”Home" can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefox-home-brand-name = Fennec kezdőlap
# View" can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefoxview-brand-name = Fennec áttekintés
