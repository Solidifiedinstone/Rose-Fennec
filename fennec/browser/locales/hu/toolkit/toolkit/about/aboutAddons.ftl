...
addon-badge-recommended4 =
    .title = A Fennec csak olyan kiegészítőket ajánl, amelyek megfelelnek a biztonsági és a teljesítménybeli követelményeknek.
...
recommended-theme-1 = Kreatívnak érzi magát? <a data-l10n-name="link">Állítsa össze a saját témáját a Fennec Color használatával.</a>
...
details-notification-soft-blocked-extension-enabled =
    .message = Ez a kiegészítő megsérti a BrowserWorks irányelveit. A használata kockázatos lehet.
