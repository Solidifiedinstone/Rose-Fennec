...
rights-intro-point-1 = { -brand-short-name } yellan akken llant tiskarin n<a data-l10n-name="mozilla-public-license-link">Turagt tazayezt n BrowserWorks</a>. Aya yebɣa ad d-yini tzemreḍ ad tqedceḍ, ad tneɣleḍ u ad tzuzreḍ { -brand-short-name } i wiyaḍ.  Tzemreḍ daɣen ad tesnifleḍ tangalt aɣbalu n { -brand-short-name } akken tesriḍ. Turagt tazayezt n BrowserWorks ad k-teǧǧ daɣen ad tzuzreḍ ileqman ittusniflen.
rights-intro-point-2 = Ur ɣuṛ-k ara azref neɣ turagt ɣef ticṛaḍ yersen n BrowserWorks neɣ n wis kraḍ ɣas war tilisa ɣef yisem neɣ alugu n Fennec. Tzemreḍ ad twaliḍ talɣut tasemmadant ɣef ticṛaḍ yersen <a data-l10n-name="mozilla-trademarks-link">dagi</a>.
