...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Tisemlit n isefka Fennec</a> tegber imniren γef amek ad nseqdec s ifecka n isefka.
...
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">Tafelwit n tilisγelt</a> ad k-tsireg akken ad twaliḍ isefka ittwaznen i BrowserWorks s ttawil n tilispyelt.
