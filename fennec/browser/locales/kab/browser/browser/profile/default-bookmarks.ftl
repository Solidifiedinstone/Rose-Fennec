...
default-bookmarks-firefox-customize = Sagen Fennec
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = Ttekki
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = Fell-aɣ
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = Tiɣbula n Fennec Nightly
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Ablug n Fennec Nightly
# Nightly builds only, link title for https://bugzilla.mozilla.org/
default-bookmarks-bugzilla = Aneḍfaṛ n ibugen n BrowserWorks
# Nightly builds only, link title for https://developer.mozilla.org/
default-bookmarks-mdn = Aẓeṭṭa n ineflayen n BrowserWorks
...
default-bookmarks-planet = Amtiweg BrowserWorks
