...
about-debugging-sidebar-this-firefox2 = Aya { -brand-shorter-name }
about-debugging-sidebar-this-firefox-title =
    .title = Aya { -brand-shorter-name }
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = Sebded
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Rmed tamseɣtayt USB def Fennec deg yibenk-ik android.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Lqem-a n Fennec ur izmir ara ad iseɣti Fennec i Android (68). Ad k-nwelleh ad tesbeddeḍ Fennec i Android Nightli deg tiliɣri-ik i usekyed. <a>Ugar n yisallen</a>
