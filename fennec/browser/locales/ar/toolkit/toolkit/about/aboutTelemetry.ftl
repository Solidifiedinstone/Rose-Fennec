...
about-telemetry-firefox-data-doc = تجد في <a data-l10n-name="data-doc-link">توثيق بيانات Fennec</a> أدلّة تُخبرك بكيف تعمل مع أدوات البيانات التي نقدّمها.
about-telemetry-telemetry-dashboard = تتيح لك لوحات معلومات القياس عن بُعد <a data-l10n-name="dashboard-link">Telemetry</a> تصور البيانات التي تتلقاها BrowserWorks عبر القياس عن بُعد.
