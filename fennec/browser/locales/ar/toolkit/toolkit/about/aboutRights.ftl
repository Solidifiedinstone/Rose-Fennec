...
rights-intro-point-2 = لا يعطيك هذا أي حقوق أو تراخيص للعلامات التجارية لمؤسسة BrowserWorks أو أي طرف آخر، متضمنًا على سبيل المثال لا الحصر اسم Fennec وشعاره. يمكنك الاطلاع على مزيد من المعلومات عن العلامات التجارية <a data-l10n-name="mozilla-trademarks-link">هنا</a>.
