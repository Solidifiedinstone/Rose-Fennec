...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = فعّل التنقيح عبر USB في متصفح Fennec على أجهزة أندرويد.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = لا يمكن لإصدارة متصفّح Fennec هذه تنقيح Fennec لأندرويد (68). ننصح بتنزيل النسخة الليلية من Fennec لأندرويد على هاتفك لإجراء الاختبارات. <a>تفاصيل أكثر</a>
...
about-debugging-browser-version-too-recent = إصدارة المتصفّح المتّصل ({ $runtimeVersion }، معرّف البناء { $runtimeID }) أحدث من إصدارة { -brand-shorter-name } هذه ({ $localVersion }، معرّف البناء { $localID }). عملية الإعداد هذه غير مدعومة وقد لا تعمل أدوات المطوّرين بناء على ذلك. من فضلك حدّث Fennec. <a>مواجهة الأعطال</a>
