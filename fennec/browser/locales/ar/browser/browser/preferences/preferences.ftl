...
sync-mobile-promo = نزّل Fennec لنظامي <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">أندرويد</a> أو <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">آي أو إس</a> للمزامنة مع هاتفك المحمول.
...
addressbar-firefox-suggest-online =
    .label = احصل على اقتراحات من BrowserWorks أثناء الكتابة
