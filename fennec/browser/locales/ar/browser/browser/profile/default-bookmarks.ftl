...
default-bookmarks-firefox-customize = خصّص Fennec
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = كيفية المساهمة
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = معلومات عنا
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = موارد Fennec الليلي
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = مدونة Fennec الليلي
# Nightly builds only, link title for https://bugzilla.mozilla.org/
default-bookmarks-bugzilla = متتبع عِلَل BrowserWorks
...
default-bookmarks-planet = كوكب BrowserWorks
