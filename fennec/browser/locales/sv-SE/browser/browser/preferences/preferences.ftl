...
pane-downloads-title2 = Filhämtningar
    .title = Filhämtningar
pane-downloads3 =
    .heading = Filhämtningar
...
pane-tabs-browsing-title2 = Flikar och surfning
    .title = Flikar och surfning
tabs-group-header2 =
    .label = Flikar
...
settings-keyboard-shortcuts-group =
    ...
    .description = Styr hur du flyttar och interagerar med { -brand-short-name }.
...
pane-account-sync-title2 = Konto och synkronisering
    .title = Konto och synkronisering
...
sync-mobile-promo = Hämta Fennec för <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> eller <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> för att synkronisera med din mobila enhet.
...
sync-engine-addons =
    .label = Tillägg
    .tooltiptext = Tillägg och teman för Fennec skrivbord
    .accesskey = T
...
forms-primary-pw-on-2 = Huvudlösenordet är <strong>PÅ</strong>
forms-primary-pw-on =
...
addressbar-firefox-suggest-online =
    .label = Hämta förslag från BrowserWorks medan du skriver
...
pane-permissions-data-title2 = Behörigheter och data
    .title = Behörigheter och data
...
appearance-window-density-group =
    .label = Fönsterdensitet
    .description = Justera avståndet runt fönsterelement som verktygsfält, flikar och sidofält.
appearance-window-density-radio-group =
    .aria-label = Fönsterdensitet
appearance-window-density-automatic =
    .label = Automatisk (standard)
    .description = Standard-, kompakt- eller pekavstånd tillämpas automatiskt
appearance-window-density-automatic-no-touch =
    .label = Automatisk (standard)
    .description = Standard- eller kompaktavstånd tillämpas automatiskt
appearance-window-density-standard =
    .label = Standard
    .description = Balanserat avstånd för de flesta skärmar
appearance-window-density-auto-touch-mode =
    .label = Använd pekavstånd för surfplatteläge
appearance-window-density-compact =
    .label = Kompakt
    .description = Minskat avstånd för mindre skärmar
appearance-window-density-touch =
    .label = Touch
    .description = Större fönsterelement och klickmål, optimerad för pekskärmar
...
preferences-etp-custom-cookie-behavior-block-cross-site-cookies =
    .label = Blockera globala kakor
preferences-etp-custom-cookie-behavior-isolate-cross-site-cookies =
    .label = Isolera globala spårningskakor
preferences-etp-custom-cookie-behavior-block-unvisited =
    .label = Blockera kakor från obesökta webbplatser
preferences-etp-custom-cookie-behavior-block-all-cross-site-cookies =
    .label = Blockera alla globala kakor (kan orsaka fel på webbplatser)
preferences-etp-custom-cookie-behavior-block-all =
    .label = Blockera alla kakor (kommer att orsaka fel på webbplatser)
