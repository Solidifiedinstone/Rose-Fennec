...
fennec-defaults =
    .label = Fennec standardinställningar
...
enable-fennec-theme-0 =
    .label = Aktivera Fennec-temanpassningar på alla teman

enable-fennec-theme-1 =
    .label = Aktivera Fennec-temanpassningar på Fennec-teman

enable-fennec-theme-2 =
    .label = Inaktivera anpassningar av Fennec-teman
