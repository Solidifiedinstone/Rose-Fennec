...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Aktivera USB-felsökning i Fennec på Android-enheten.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Denna version av Fennec kan inte felsöka Fennec för Android (68). Vi rekommenderar att du installerar Fennec för Android Nightly på din telefon för testning. <a>Mer information</a>
...
about-debugging-browser-version-too-recent = Den anslutna webbläsaren är senare ({ $runtimeVersion }, buildID { $runtimeID }) än ditt { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Det här konfigurationen stöds inte och kan göra att DevTools misslyckas. Vänligen uppdatera Fennec. <a>Felsökning</a>
