...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Fennec datadokumentation</a> innehåller guider om hur du arbetar med våra datainställningar.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Fennec Telemetry klientdokumentation</a> innehåller definitioner för begrepp, API-dokumentation och datareferenser.
