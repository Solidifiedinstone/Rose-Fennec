...
addon-badge-line3 =
    .title = Officiellt tillägg byggt av Fennec. Uppfyller säkerhets- och prestandastandarder
...
addon-badge-recommended4 =
    .title = Fennec rekommenderar endast tillägg som uppfyller standarder för säkerhet och prestanda
...
recommended-theme-1 = Känner du dig kreativ? <a data-l10n-name="link">Skapa ditt egna tema med Fennec Color.</a>
