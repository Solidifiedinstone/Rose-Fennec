...
addon-badge-line3 =
    .title = Oficielne rozšyrjenje, wuwite wót BrowserWorks. Docynja wěstotne a wugbaśowe standardy.
...
addon-badge-recommended4 =
    .title = Fennec jano rozšyrjenja dopórucujo, kótarež standardam za wěstotu a wugbaśe wótpowěduju.
...
recommended-theme-1 = Cujośo se kreatiwny? <a data-l10n-name="link">Napórajśo swójsku drastwu z Fennec Color.</a>
...
details-notification-hard-blocked-extension =
    .message = Toś to rozšyrjenje jo dla pśejźenja pśeśiwo pšawidłam BrowserWorks blokěrowane a jo se znjemóžniło.
details-notification-hard-blocked-other =
    .message = Toś ten dodank jo dla pśejźenja pśeśiwo pšawidłam BrowserWorks blokěrowany a jo se znjemóžnił.
...
details-notification-soft-blocked-extension-disabled =
    .message = Toś to rozšyrjenje jo dla pśejźenja pśeśiwo pšawidłam BrowserWorks wobgranicowane a jo se znjemóžniło. Móžośo jo zmóžniś, ale to jo snaź riskantne.
details-notification-soft-blocked-extension-enabled =
    .message = Toś to rozšyrjenje se pśeśiwo pšawidłam BrowserWorks pśejźo. Jo riskantne jo wužywaś.
details-notification-soft-blocked-other-disabled =
    .message = Toś ten dodank jo dla pśejźenja pśeśiwo pšawidłam BrowserWorks wobgranicowany a jo se znjemóžnił. Móžośo jo zmóžniś, ale to jo snaź riskantne.
details-notification-soft-blocked-other-enabled =
    .message = Toś ten dodank se pśeśiwo pšawidłam BrowserWorks pśejźo. Jo riskantne jen wužywaś.
