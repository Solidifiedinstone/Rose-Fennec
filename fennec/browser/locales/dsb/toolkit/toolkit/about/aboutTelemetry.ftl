...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Datowa dokumentacija Fennec</a> rozpokazanja wó źěłanju z našymi datowymi rědami wopśimujo.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Klientowa dokumentacija za telemetriju Fennec</a> definicije za koncepty, API-dokumentaciju a datowe reference wopśimujo.
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">Telemetrijowy pśeglěd</a> wam zmóžnja, daty wizualizěrowaś, kótarež BrowserWorks pśez telemetriju dostawa.
