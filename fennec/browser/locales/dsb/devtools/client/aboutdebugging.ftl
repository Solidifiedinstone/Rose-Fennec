...
about-debugging-sidebar-this-firefox2 = Toś ten { -brand-shorter-name }
about-debugging-sidebar-this-firefox-title =
    .title = Toś ten { -brand-shorter-name }
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = Zarědowanje
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Pytanje zmólkow USB w Fennec na rěźe Android zmóžniś.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Toś ta wersija Fennec njamóžo Fennec za Android (68) za zmólkami pśeglědowaś. Pórucamy, až Fennec za Android Nightly na swójom telefonje za testowanje instalěrujośo. <a>Dalšne drobnostki</a>
...
about-debugging-browser-version-too-recent = Zwězany wobglědowak jo aktualnjejšy ({ $runtimeVersion }, buildID { $runtimeID }) ako waš { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). To jo njepódpěrana konfiguracija a móžo zawinowaś, až wuwijaŕske rědy njefunkcioněruju. Pšosym aktualizěrujśo Fennec. <a>Rozwězanje problemow</a>
...
about-debugging-profiler-dialog-title2 = Wugbaśowa analyza
