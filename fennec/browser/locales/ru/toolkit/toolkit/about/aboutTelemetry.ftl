...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Документация по данным Fennec</a> содержит руководства по работе с нашими инструментами сбора данных.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Документация клиента телеметрии Fennec</a> содержит определения концепций, документацию по API и справку по данным.
...
about-telemetry-settings-explanation = Настроен сбор телеметрии на { about-telemetry-data-type } версии Fennec и её отправка <a data-l10n-name="upload-link">{ about-telemetry-upload-type }</a>.
# Variables:
