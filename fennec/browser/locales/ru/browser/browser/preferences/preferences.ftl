...
sync-mobile-promo = Скачайте Fennec для <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> или <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a>, чтобы синхронизироваться со своим мобильным устройством.
...
sync-engine-addons =
    .label = Дополнения
    .tooltiptext = Расширения и темы для Fennec на компьютере
    .accesskey = п
...
autofill-saved-addresses-button = Сохранённые адреса
    .accesskey = ы
autofill-payment-methods-checkbox-message = Сохранять и заполнять способы оплаты
    .accesskey = ь
...
addressbar-firefox-suggest-online =
    .label = Получать предложения от BrowserWorks по мере набора
