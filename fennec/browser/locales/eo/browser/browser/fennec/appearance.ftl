...
enable-fennec-theme-0 =
    .label = Ŝalti etosajn alĝustigojn de Fennec por ĉiuj etosoj

enable-fennec-theme-1 =
    .label = Ŝalti etosajn alĝustigojn de Fennec por etosoj de Fennec

enable-fennec-theme-2 =
    .label = Malŝalti etosajn alĝustigojn de Fennec
