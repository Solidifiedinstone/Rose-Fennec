...
sync-mobile-promo = Elŝuti Fennec por <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> aŭ <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> por speguli kun via portebla aparato.
...
sync-engine-addons =
    .label = aldonaĵon
    .tooltiptext = Etendaĵoj kaj etosoj por komputila Fennec
    .accesskey = A
...
addressbar-firefox-suggest-online =
    .label = Akiri sugestojn el BrowserWorks dum tajpado
