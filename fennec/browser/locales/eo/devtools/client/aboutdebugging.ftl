...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Aktivigi senerarigon USB en Fennec en via aparato Android.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Tiu ĉi versio de Fennec ne povas senerarigi  Fennec for Android (68). Ni rekomendas instalon de Fennec for Android Nightly en vi telefono por testado. <a>Pli da informo</a>
...
about-debugging-browser-version-too-recent = La konektita retumilo estas pli nova ({ $runtimeVersion }, buildID { $runtimeID }) ol via { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Tiu ĉi estas nesubtenata situacio, kiu povus misfunkciigi la ilojn por programistoj. Bonvolu ĝisdatigi Fennec. <a>Solvado de problemoj</a>
