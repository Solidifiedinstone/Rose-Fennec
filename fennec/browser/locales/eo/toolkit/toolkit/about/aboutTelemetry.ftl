...
about-telemetry-firefox-data-doc = La <a data-l10n-name="data-doc-link">dokumentaro pri datumoj de Fennec</a> enhavas gvidilojn pri la maniero labori per niaj datumaj iloj.
about-telemetry-telemetry-client-doc = La <a data-l10n-name="client-doc-link">dokumentaro pri klientoj de Telemezuro de Fennec</a> enhavas difinojn por konceptoj, dokumentaron de API kaj datumaj referencoj.
about-telemetry-telemetry-dashboard = La <a data-l10n-name="dashboard-link">paneloj de Telemezuro</a> permesas al vi vidi la datumojn, kiujn BrowserWorks ricevas pere de Telemezuro.
