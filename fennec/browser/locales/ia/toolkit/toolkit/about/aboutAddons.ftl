...
shortcuts-remove-button =
    .aria-label = Remover accesso directe
...
addon-badge-line3 =
    .title = Extension official producite per BrowserWorks. Satisface le standards de securitate e rendimento
...
addon-badge-recommended4 =
    .title = Fennec recommenda solmente le extensiones que satisface le standards de securitate e prestation
...
recommended-theme-1 = Te senti creative? <a data-l10n-name="link">Crea tu proprie thema con Fennec Color.</a>
...
details-notification-hard-blocked-extension =
    .message = Iste extension es blocate perque viola le directivas de BrowserWorks e ha essite disactivate.
details-notification-hard-blocked-other =
    .message = Iste additivo es blocate perque viola le directivas de BrowserWorks e ha essite disactivate.
...
details-notification-soft-blocked-extension-disabled =
    .message = Iste extension es limitate perque viola le directivas de BrowserWorks e ha essite disactivate. Tu pote activar illo, ma isto pote esser riscose.
details-notification-soft-blocked-extension-enabled =
    .message = Iste extension viola le directivas de BrowserWorks. Usar lo pote esser riscose.
details-notification-soft-blocked-other-disabled =
    .message = Iste additivo es limitate perque viola le directivas de BrowserWorks e ha essite disactivate. Tu pote activar illo, ma isto pote esser riscose.
details-notification-soft-blocked-other-enabled =
    .message = Iste additivo viola le directivas de BrowserWorks. Usar lo pote esser riscose.
