...
about-telemetry-firefox-data-doc = Le <a data-l10n-name="data-doc-link">Fennec Data Documentation</a> contine guidas re le uso de nostre instrumentos de dato.
about-telemetry-telemetry-client-doc = Le <a data-l10n-name="client-doc-link">Fennec Telemetry client documentation</a> include definitiones pro conceptos, documentation re le API e referentias de datos.
about-telemetry-telemetry-dashboard = Le <a data-l10n-name="dashboard-link">pannellos de Telemetry</a> te permitte de visualisar le datos que BrowserWorks recipe via Telemetry.
