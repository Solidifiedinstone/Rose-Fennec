...
pane-experimental-reset =
    ...
    .accesskey = R
help-button-label2 = Assistentia de { -brand-short-name }
...
settings-tabs-drag-to-create-tab-groups =
    .label = Trahe schedas insimul pro crear gruppos de schedas
...
download-always-ask-where2 =
    .label = Demanda ubi salvar files ante discargar
    .accesskey = D
...
applications-setting2 =
    .label = Files e applicationes
    .description = Elige como { -brand-short-name } tracta files e contento discargate.
applications-filter =
...
applications-save-for-new-types2 =
    .label = Automaticamente salvar files
    .accesskey = S
applications-ask-before-handling =
    .label = Demandar si aperir o salvar le files
    .accesskey = D
applications-ask-before-handling2 =
    .label = Demanda pro aperir o salvar files
    .accesskey = D
drm-group =
...
keyboard-and-scrolling-group =
    .label = Navigation e rolamento per claviero
...
settings-keyboard-shortcuts-group =
    ...
    .description = Controla como tu te move e interage con { -brand-short-name }.
settings-keyboard-shortcuts-customkeys-link =
    .label = Personalisa vias breve de claviero
...
containers-card-header2 =
    .label = Containers
    .description = Separar cookies per contentor assi que tu pote usar differente contos sur le mesme sito e limitar le traciamento inter-sitos.
...
containers-new-tab-check2 =
    .label = Elige un contentor pro cata scheda nove
    .accesskey = E
    .description = Le configurationes del conto es indisponibile.
...
sync-mobile-promo = Discarga Fennec pro <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> o <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> pro synchronisar te con tu apparato mobile.
...
sync-engine-addons =
    .label = Additivos
    .tooltiptext = Extensiones e themas pro Fennec scriptorio
    .accesskey = A
...
addressbar-firefox-suggest-online =
    .label = Obtener suggestiones de BrowserWorks durante que tu digita
...
nimbus-rollouts =
    ...
    .description = Le cambiamentos sera implementate a distantia.
...
data-collection-health-report-disabled =
    .label = Inviar datos technic e de interaction a { -vendor-short-name }
    .accesskey = r
    .description = Le datos es disactivate pro iste configuration de compilation.
data-collection-run-studies =
    .label = Permitte a { -brand-short-name } de exequer studios de function
    .description = { -brand-short-name } aleatorimente selige usatores pro verificar le functionalitates, que adjuta a meliorar le qualitate pro omnes.
data-collection-studies-link =
    .label = Consultar le studios de { -brand-short-name }
data-collection-backlogged-crash-reports =
    .label = Automaticamente inviar reportos de crash
    .description = Isto adjuta { -vendor-short-name } a diagnosticar e corriger problemas con le navigator. Le reportos pote includer datos personal o sensibile.
    .accesskey = c
...
preferences-doh-fallback-label =
    .label = Sempre adverter me si le DNS secur non es disponibile
...
appearance-window-density-group =
    .label = Densitate del fenestra
    .description = Adjustar le spatiamento circum le elementos del fenestra como barra del instrumentos, schedas, e barra lateral.
appearance-window-density-radio-group =
    .aria-label = Densitate del fenestra
appearance-window-density-automatic =
    .label = Automatic (predefinite)
    .description = Le spatiamento standard, compacte o pro schermos tactile es applicate automaticamente
appearance-window-density-automatic-no-touch =
    .label = Automatic (predefinite)
    .description = Le spatiamento standard o compacte es applicate automaticamente
appearance-window-density-standard =
    .label = Standard
    .description = Spatiamento balanciate pro le major parte del paginas
appearance-window-density-auto-touch-mode =
    .label = Usar spatiamento de tocco pro le modalitate tabletta
appearance-window-density-compact =
    .label = Compacte
    .description = Spatiamento reducite pro paginas plus micre
appearance-window-density-touch =
    .label = Tactile
    .description = Elementos de fenestra e objectivos de clic plus grande, optimisate pro schermos tactile
...
preferences-etp-rfp-warning-message =
    .message = Tu va usar Resist Fingerprinting (RFP), que replacia alcunos del parametros de protection detection de dactylogrammas de { -brand-short-name }.
preferences-etp-level-warning-message =
    .heading = Attention! Alcun sitos pote non functionar como expectate.
    .message = Alcun sitos crea traciatores in lor functiones o contento. Quando { -brand-short-name } los bloca, le sito pare rupte. Tenta usar “Resolver problema de sito” o disactiva protection antitraciamento sur ille sito.
preferences-etp-manage-exceptions-button =
    .label = Gerer exceptiones
    .description = Gerer sitos web ubi le Protection contra-traciamento reinfortiate es disactivate.
preferences-etp-customize-header =
    .heading = Personalisar protection antitraciamento
preferences-etp-reset =
    .label = Reinitialisar personalisationes
    .description = Restaurar parametros a un nivello de protection predefinite.
preferences-etp-reset-standard-button =
    .label = Remontar a standard
preferences-etp-reset-strict-button =
    .label = Remontar a nivello stricte
preferences-etp-custom-control-group =
    .label = Protection contra le traciamento
    .description = Elige que protectiones activar o disactivar.
...
preferences-etp-custom-cookie-behavior-accept-all =
    .label = Permitter tote le cookies
preferences-etp-custom-cookie-behavior-block-cross-site-cookies =
    .label = Blocar le cookies inter sitos
preferences-etp-custom-cookie-behavior-isolate-cross-site-cookies =
    .label = Isolar le cookies inter sitos
preferences-etp-custom-cookie-behavior-block-unvisited =
    .label = Bloca cookies ab sitos web non visitate
preferences-etp-custom-cookie-behavior-block-all-cross-site-cookies =
    .label = Blocar tote le cookies inter-sitos (pote causar que le sitos web collabe)
preferences-etp-custom-cookie-behavior-block-all =
    .label = Blocar tote le cookies (facera collaber le sitos web)
...
security-privacy-issue-warning-fingerprinters =
    .label = Le dactylogrammatores note non es blocate
    .description = Isto pote permitter a alcun traciatores de sequer te sin cookies.
security-privacy-issue-warning-third-party-cookies =
    .label = Le cookies de tertie-parte es activate
    .description = Le cookies de tertie-parte es usate pro traciar te a transverso sitos web.
security-privacy-issue-warning-password-manager =
    .label = Le gestor de contrasignos es disactivate
    .description = Le gestores de contrasignos te adjuta a immagazinar contrasignos forte pro tu contos.
security-privacy-issue-warning-popup-blocker =
    .label = Le blocator de quadros resaltante es disactivate
    .description = Le quadros resaltante es interruptive e potentialmente malefic.
security-privacy-issue-warning-extension-install =
    .label = Le sitos web pote installar extensiones
    .description = Le sitos web pote installar extensiones pro { -brand-short-name } sin demandar.
security-privacy-issue-warning-safe-browsing =
    .label = Le contento periculose e fraudulente non es blocate
    .description = Tu exposition a attaccos fraudulente e malware de sitos web es accrescite.
security-privacy-issue-warning-doh =
    .label = DNS sur HTTPS es disactivate
    .description = DNS sur HTTPS cela ille sitos que tu visita ab tu fornitor de rete.
security-privacy-issue-warning-ech =
    .label = Le Encrypted Client Hello es disactivate
    .description = Le Encrypted Client Hello cela ille sitos que tu visita ab tu fornitor de rete.
