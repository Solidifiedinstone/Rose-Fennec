...
about-debugging-sidebar-this-firefox2 = Iste { -brand-shorter-name }
about-debugging-sidebar-this-firefox-title =
    .title = Iste { -brand-shorter-name }
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = Installation
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Activar le Depuration USB in Fennec sur le apparato Android.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Iste version de Fennec non pote depurar Fennec pro Android (68). Nos recommenda installar Fennec pro Android Nightly sur tu telephono pro facer tests. <a>Plus detalios</a>
...
about-debugging-browser-version-too-recent = Le navigator connexe es plus recente ({ $runtimeVersion }, buildID { $runtimeID }) que tu { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Isto es un installation non supportate e pote causar faltas in DevTools. Actualisa Fennec. <a>Resolution de problemas</a>
