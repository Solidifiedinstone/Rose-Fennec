...
about-debugging-sidebar-this-firefox2 = Tutón { -brand-shorter-name }
about-debugging-sidebar-this-firefox-title =
    .title = Tutón { -brand-shorter-name }
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = Připrawjenje
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Pytanje zmylkow USB w Fennec na graće Android zmóžnić.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Tuta wersija Fennec njemóže Fennec za Android (68) za zmylkami přepruwować. Poručamy, zo Fennec za Android Nightly na swojim telefonje za testowanje instalujeće. <a>Dalše podrobnosće</a>
