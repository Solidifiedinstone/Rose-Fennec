...
sync-mobile-promo = Fennec za <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> abo <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> sćahnyć, zo byšće ze swojim mobilnym gratom synchronizował.
...
sync-engine-addons =
    .label = Přidatki
    .tooltiptext = Rozšěrjenja a drasty za desktopowy Fennec
    .accesskey = P
...
addressbar-firefox-suggest-online =
    .label = Wotwołajće namjety wot BrowserWorks, hdyž pisaće
