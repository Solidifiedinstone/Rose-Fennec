...
default-bookmarks-firefox-customize = Fennec přiměrić
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = Čińće sobu
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = Wo nas
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = Resursy Fennec Nightly
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Blog Fennec Nightly
# Nightly builds only, link title for https://bugzilla.mozilla.org/
default-bookmarks-bugzilla = Slědowanje zmylkow BrowserWorks
# Nightly builds only, link title for https://developer.mozilla.org/
default-bookmarks-mdn = Syć wuwiwarjow BrowserWorks
