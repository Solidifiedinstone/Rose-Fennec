...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Datowa dokumentacija Fennec</a> nawody wo dźěłanju z našimi datowymi nastrojemi wobsahuje.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Klientowa dokumentacija za telemetriju Fennec</a> definicije za koncepty, API-dokumentaciju a datowe referency wobsahuje.
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">Telemetrijowy přehlad</a> wam zmóžnja, daty wizualizować, kotrež BrowserWorks přez telemetriju dóstawa.
