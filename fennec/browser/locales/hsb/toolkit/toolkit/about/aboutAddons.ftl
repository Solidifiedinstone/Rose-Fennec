...
addon-badge-line3 =
    .title = Oficielny rozšěrjenje, wuwite wot BrowserWorks. Spjelnja wěstotne a wukonowe standardy.
...
addon-badge-recommended4 =
    .title = Fennec jenož rozšěrjenja doporučuje, kotrež standardam za wěstotu a wukon wotpowěduja.
...
recommended-theme-1 = Čujeće so kreatiwny? <a data-l10n-name="link">Wutworće swójsku drastu z Fennec Color.</a>
...
details-notification-hard-blocked-extension =
    .message = Tute rozšěrjenje je přeńdźenja přećiwo prawidłam BrowserWorks dla zablokowane a je so znjemóžniło.
details-notification-hard-blocked-other =
    .message = Tutón přidatk je přeńdźenja přećiwo prawidłam BrowserWorks dla zablokowany a je so znjemóžnił.
...
details-notification-soft-blocked-extension-disabled =
    .message = Tute rozšěrjenje je přeńdźenja přećiwo prawidłam BrowserWorks dla wobmjezowane a je so znjemóžniło. Móžeće jo zmóžnić, ale to je snano riskantne.
details-notification-soft-blocked-extension-enabled =
    .message = Tute rozšěrjenje so přećiwo prawidłam BrowserWorks přeńdźe. Je riskantne jo wužiwać.
details-notification-soft-blocked-other-disabled =
    .message = Tutón přidatk je přeńdźenja přećiwo prawidłam BrowserWorks dla wobmjezowany a je so znjemóžnił. Móžeće jo zmóžnić, ale to je snano riskantne.
details-notification-soft-blocked-other-enabled =
    .message = Tutón přidatk so přećiwo prawidłam BrowserWorks přeńdźe. Je riskantne jón wužiwać.
...
plugins-openh264-description = Tutón tykač so wot BrowserWorks awtomatisce instaluje, zo by specifikaciji WebRTC wotpowědował a wołanja WebRTC z gratami zmóžnił, kotrež sej widejocodec H.264 wužaduja. Wopytajće http://www.openh264.org/, zo byšće sej codecowy žórłowy kod wobhladał a wjace wo implementaciji zhonił.
