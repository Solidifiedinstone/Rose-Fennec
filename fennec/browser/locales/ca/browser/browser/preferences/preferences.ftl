...
sync-mobile-promo = Baixeu el Fennec per a l'<img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> o per a l'<img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> per sincronitzar amb el vostre dispositiu mòbil.
...
sync-engine-addons =
    .label = Complements
    .tooltiptext = Extensions i temes per al Fennec d'escriptori
    .accesskey = C
