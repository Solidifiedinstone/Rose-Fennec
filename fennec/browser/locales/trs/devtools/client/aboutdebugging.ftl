...
about-debugging-sidebar-this-firefox2 = Nan { -brand-shorter-name }
about-debugging-sidebar-this-firefox-title =
    .title = Nan { -brand-shorter-name }
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = Chrej ganikò'
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Dugi'iaj sun sa nagi'iaj hìo USB riña si aga' Fennec
# USB section step by step guide
...
about-debugging-browser-version-too-recent = Hua nakà doj riña sa nana'uî't nuguan' ({ $runtimeVersion }, buildID { $runtimeID }) ngà da' si { -brand-shorter-name }, ({ $localVersion }, buildID { $localID }). Nitaj si aran' konfigurasiûn nan ngàj ni ga'ue si gi'iaj suin DevTools gi'ia. Gi'iaj sunuj u ni nadunïnjt Fennec. <a>Sa nagi'iaj sa hua a'nan'an</a>
