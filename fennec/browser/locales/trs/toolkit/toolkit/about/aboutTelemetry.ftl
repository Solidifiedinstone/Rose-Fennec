...
about-telemetry-firefox-data-doc = Sa <a data-l10n-name="data-doc-link">nagi'iaj chre' si nuguà' Fennec</a> gu'nàj nikaj chrej ganikò' da' nachrun' daran' si nuguàn'anj.
about-telemetry-telemetry-client-doc = Si <a data-l10n-name="client-doc-link"> Fennec Telemetrîa riña nachra chrej nuguan'an</a> nika daj gataj go'ngo nuguan'an ruhuaj, si nuguàn API ni ñanj màn chre' guendâ nej dâto.
about-telemetry-telemetry-dashboard = Si <a data-l10n-name="dashboard-link">Panel Telemetrîa</a> ni a'nïn ni'io' daran' chre ne nuguan' nahuin ra'a BrowserWorks narikî Telemetrîa.
