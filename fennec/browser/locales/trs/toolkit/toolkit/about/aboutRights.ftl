...
rights-intro-point-1 = { -brand-short-name } sa da'uit ganikaj ni'ñanjt huin <a data-l10n-name="mozilla-public-license-link">Si nuguan' BrowserWorks</a>. Sa gatâ huin si ga'ue garasunt ni duguchint { -brand-short-name } riña a'ngo dugui'. Ga'ue ganadunat daj ga si kodigo  { -brand-short-name } daj gani ruat. Si nuguan' BrowserWorks huin si ga'ué garasut sa nagi'iaj ma'ant.
rights-intro-point-2 = Si ga'ue riki Fundasión BrowserWorks nej sa huin si'iaj ma huenda nagi'iaj si'iat, daj run' si da'nga' Fennec. NI a'ngô nej sa ma na.<a data-l10n-name="mozilla-trademarks-link">ñuna</a>.
