...
recommended-theme-1 = Ûta hua sa ahui ràt ruhuâ raj? <a data-l10n-name="link">Girirà dàj ga si temât ngà Fennec Color.</a>
...
plugins-openh264-description = Sa gu'naj plugin nga gatuj ma'an gi'iaj BrowserWorks da' gi'iaj sunj nga WebRTC ni daj ga'ue ga'minj nga WebRTC nga nej aga' 'iaj sun nga sa ahui ni'io' H.264. Ni'iaj riña http://www.openh264.org/ da' gini'in codec, daj huaj codec ni daj 'iaj sunj.
