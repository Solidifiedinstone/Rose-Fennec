...
about-debugging-sidebar-this-firefox2 = Ta aplikacyjo { -brand-shorter-name }
about-debugging-sidebar-this-firefox-title =
    .title = Ta aplikacyjo { -brand-shorter-name }
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = Sztalowanie
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Załōncz debuggowanie bez USB we Fennecie na maszinie z Androidym.
# USB section step by step guide
