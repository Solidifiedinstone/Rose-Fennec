...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Fennec datu dokumentācijā</a> ir norādes par to kā strādāt ar mūsu datu rīkiem.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Fennec telemetrijas klienta dokumentācijā</a> ir konceptu definīcijas, API dokumentācija un datu atsauces.
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">Telemetrijas paneļi</a> ļauj vizualizēt BrowserWorks saņemtos telemetrijas datus.
