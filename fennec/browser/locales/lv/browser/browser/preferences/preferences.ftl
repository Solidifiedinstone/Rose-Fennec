...
sync-mobile-promo = Lejupielādēt Fennec <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> vai <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> lai sinhronizētos ar mobilajām ierīcēm.
...
sync-engine-addons =
    ...
    .tooltiptext = Fennec datoru versijas paplašinājumi un tēmas
    .accesskey = a
