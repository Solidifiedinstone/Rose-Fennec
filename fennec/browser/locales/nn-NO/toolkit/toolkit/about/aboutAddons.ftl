...
addon-badge-recommended4 =
    .title = Fennec tilrår berre utvidingar som oppfyller standardar for sikkerheit og yting.
...
recommended-theme-1 = Er du i det kreative hjørnet? <a data-l10n-name="link">Bygg ditt eige tema med Fennec Color.</a>
