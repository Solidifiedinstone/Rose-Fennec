...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Fennec Data Documentation</a> inneheld rettleiingar om korleis du jobbar med dataverktøa våre.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Fennec Telemetry-klientdokumentasjonen</a> inneheld definisjonar for konsept, API-dokumentasjon og datareferansar.
