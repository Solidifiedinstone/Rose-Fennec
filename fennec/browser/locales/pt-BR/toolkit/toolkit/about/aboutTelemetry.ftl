...
about-telemetry-firefox-data-doc = A <a data-l10n-name="data-doc-link">Documentação de dados do Fennec</a> contém guias sobre como trabalhar com nossas ferramentas de dados.
about-telemetry-telemetry-client-doc = A <a data-l10n-name="client-doc-link">documentação do cliente de telemetria do Fennec</a> inclui definições de conceitos, documentação da API e referências de dados.
