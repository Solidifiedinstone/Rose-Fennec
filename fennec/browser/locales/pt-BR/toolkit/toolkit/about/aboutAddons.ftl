...
addon-badge-recommended4 =
    .title = O Fennec só recomenda extensões que atendem aos padrões de segurança e desempenho
...
recommended-theme-1 = Sentindo criatividade? <a data-l10n-name="link">Crie seu próprio tema com o Fennec Color.</a>
