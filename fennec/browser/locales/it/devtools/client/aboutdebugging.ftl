...
about-debugging-sidebar-this-firefox2 = Questo { -brand-shorter-name }
about-debugging-sidebar-this-firefox-title =
    .title = Questo { -brand-shorter-name }
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = Impostazioni
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Attiva USB Debugging in Fennec sul dispositivo Android.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Non è possibile utilizzare questa versione di Fennec per eseguire il debug di Fennec per Android (68). Per effettuare test è consigliato installare Fennec per Android Nightly sul telefono. <a>Ulteriori informazioni</a>
