...
about-telemetry-firefox-data-doc = La <a data-l10n-name="data-doc-link">documentazione Fennec Data</a> include guide sull’utilizzo degli strumenti dedicati alla gestione dei dati.
about-telemetry-telemetry-client-doc = La <a data-l10n-name="client-doc-link">documentazione del client Fennec Telemetry</a> include definizioni, documentazione relativa alle API e fonti di riferimento per i dati.
