...
default-bookmarks-firefox-customize = Persunalisar Fennec
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = Ta participar
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = Davart nus
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = Resursas per Fennec nightly
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Blog da Fennec Nightly
# Nightly builds only, link title for https://bugzilla.mozilla.org/
default-bookmarks-bugzilla = Collecziun da bugs da BrowserWorks
