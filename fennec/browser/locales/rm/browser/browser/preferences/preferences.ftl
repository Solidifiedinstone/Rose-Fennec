...
sync-mobile-promo = Telechargiar Fennec per <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> u <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> per sincronisar cun tes apparat mobil.
...
sync-engine-addons =
    ...
    .tooltiptext = Supplements e designs per Fennec per computers
    .accesskey = S
