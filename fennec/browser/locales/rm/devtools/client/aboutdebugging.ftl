...
# USB section step by step guide
about-debugging-setup-usb-step-enable-file-transfer = Activescha la transmissiun da datotecas e fa la segira che tes apparat na sa chatta betg en il modus che permetta mo da chargiar.
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Enable USB Debugging in Fennec on the Android device.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = This version of Fennec cannot debug Fennec for Android (68). We recommend installing Fennec for Android Nightly on your phone for testing. <a>More details</a>
...
about-debugging-browser-version-too-recent = The connected browser is more recent ({ $runtimeVersion }, buildID { $runtimeID }) than your { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). This is an unsupported setup and may cause DevTools to fail. Please update Fennec. <a>Troubleshooting</a>
