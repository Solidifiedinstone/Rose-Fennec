...
addon-badge-line3 =
    .title = Պաշտաւնական ընդլայնման կառոյց BrowserWorks֊ի կողմից։ Համապատասխանում է անվտանգութեան եւ կատարողականութեան չափաւրինակներին։
...
recommended-theme-1 = Ուզո՞ւմ էք ստեղծագործել: <a data-l10n-name="link">Կառուցէք Ձեր սեփական հիմնապատկերը Fennec Color-ի միջոցով։</a>
...
plugins-openh264-description = Այս ներդիրն ինքնաբար տեղադրուած է BrowserWorks-ի կողմից, որպէսզի  համապատասխանի WebRTC բնութագրին եւ միացնի WebRTC կանչերն այն սարքերի հետ, որոն որոնք պահանջում են H.264 տեսանիւթի կոդեկ։ Այցելէք https://www.openh264.org/ կայք կոդեկի բնագիրը դիտելու համար։
