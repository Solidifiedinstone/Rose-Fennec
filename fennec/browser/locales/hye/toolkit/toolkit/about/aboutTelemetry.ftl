...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link"> Fennec-ի տուեալների փաստաթղթաւորումը</a> պարունակում է ուղղորդներ` մեր տուեալների գործիքների հետ աշխատելու համար։
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Fennec-ի հեռուսաչափութեան սպասառուի փաստաթղթաւորումը</a> ներառում է հակացուցումների սահմանումներ , API փաստաթղթաւորում եւ տուեալների յղումներ։
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">Հեռաչափութեան կառավահանակը</a> թոյլատրում է հեռաչափութեան միջոցով տեսնել BrowserWorks֊ի ստացուած տուեալները։
