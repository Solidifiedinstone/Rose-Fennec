...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Dokumentace dat prohlížeče Fennec</a> obsahuje návody pro práci s našimi datovými nástroji.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Dokumentace klienta telemetrie pro prohlížeč Fennec</a> obsahuje definice pojmů, dokumentaci API a popisy dat.
