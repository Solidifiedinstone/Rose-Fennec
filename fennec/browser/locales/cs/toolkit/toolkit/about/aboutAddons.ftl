...
addon-badge-recommended4 =
    .title = Fennec doporučuje pouze rozšíření, která splňují standardy zabezpečení a výkonu.
...
recommended-theme-1 = Jste tvořiví? <a data-l10n-name="link">Vyrobte si vlastní vzhled pomocí Fennec Color.</a>
