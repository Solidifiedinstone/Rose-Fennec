...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Povolte ladění přes USB ve Fennecu pro Android.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Tato verze Fennecu nemůže ladit Fennec pro Android (68). Pro testování doporučujeme do telefonu nainstalovat Fennec Nightly pro Android. <a>Více informací</a>
...
about-debugging-browser-version-too-recent =
    { -brand-shorter-name.gender ->
        [masculine] Připojený prohlížeč je novější ({ $runtimeVersion }, buildID { $runtimeID }) než váš { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Taková situace není podporována a může způsobit selhání nástrojů pro vývojáře. Aktualizujte prosím svůj Fennec. <a>Řešení potíží</a>
        [feminine] Připojený prohlížeč je novější ({ $runtimeVersion }, buildID { $runtimeID }) než vaše { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Taková situace není podporována a může způsobit selhání nástrojů pro vývojáře. Aktualizujte prosím svůj Fennec. <a>Řešení potíží</a>
        [neuter] Připojený prohlížeč je novější ({ $runtimeVersion }, buildID { $runtimeID }) než vaše { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Taková situace není podporována a může způsobit selhání nástrojů pro vývojáře. Aktualizujte prosím svůj Fennec. <a>Řešení potíží</a>
       *[other] Připojený prohlížeč je novější ({ $runtimeVersion }, buildID { $runtimeID }) než vaše aplikace { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Taková situace není podporována a může způsobit selhání nástrojů pro vývojáře. Aktualizujte prosím svůj Fennec. <a>Řešení potíží</a>
    }
