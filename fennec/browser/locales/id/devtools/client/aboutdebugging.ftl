...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Aktifkan Debugging USB di Fennec pada perangkat Android.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Versi Fennec ini tidak dapat melakukan debug Fennec untuk Android (68). Kami sarankan untuk menginstal Fennec untuk Android Nightly di ponsel anda untuk pengujian. <a>Detail lebih lanjut</a>
