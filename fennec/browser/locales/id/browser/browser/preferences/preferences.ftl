...
sync-mobile-promo = Unduh Fennec untuk <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> atau <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> untuk menyinkronkan dengan peranti seluler Anda.
...
sync-engine-addons =
    .label = Pengaya
    .tooltiptext = Ekstensi dan tema untuk Fennec desktop
    .accesskey = y
