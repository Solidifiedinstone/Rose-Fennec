...
preferences-doh-ultra-desc = { -brand-short-name } akan menggunakan DNS aman dengan Oblivious HTTP melalui relai privasi Fennec untuk perlindungan maksimal.

preferences-doh-ultra-detailed-desc-1 = Menggunakan relai Oblivious HTTP Fennec untuk menyembunyikan permintaan DNS bahkan dari penyedia DNS
