...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Fennec Data Documentation</a> berisi panduan tentang bagaimana bekerja dengan alat data kami.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Dokumentasi klien Fennec Telemetry</a> termasuk definisi untuk konsep, dokumentasi API, dan referensi data.
