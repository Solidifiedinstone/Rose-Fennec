...
-mdn-brand-name = Dokumen Web MDN
...
-fakespot-brand-full-name = Fakespot dari BrowserWorks
# “Suggest” can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefox-suggest-brand-name = Saran Fennec
# ”Home" can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefox-home-brand-name = Beranda Fennec
