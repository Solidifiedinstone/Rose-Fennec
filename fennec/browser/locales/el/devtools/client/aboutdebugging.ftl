...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Ενεργοποιήστε τον έλεγχο σφαλμάτων μέσω USB στο Fennec της Android συσκευής σας.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Αυτή η έκδοση του Fennec δεν μπορεί να χρησιμοποιηθεί για έλεγχο σφαλμάτων στο Fennec για Android (68). Προτείνουμε να εγκαταστήσετε το Fennec για Android Nightly στο τηλέφωνό σας για δοκιμή. <a>Περισσότερες λεπτομέρειες</a>
