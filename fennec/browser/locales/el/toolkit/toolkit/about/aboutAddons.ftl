...
discopane-intro3 =
    ...
    <a data-l10n-name="learn-more-trigger">προτάσεις</a> του Fennec για απαράμιλλη
...
addon-badge-recommended4 =
    .title = Το Fennec προτείνει μόνο τις επεκτάσεις που πληρούν τα πρότυπα ασφαλείας και επιδόσεων
...
recommended-theme-1 = Αισθάνεστε δημιουργικοί; <a data-l10n-name="link">Δημιουργήστε το δικό σας θέμα με το Fennec Color.</a>
