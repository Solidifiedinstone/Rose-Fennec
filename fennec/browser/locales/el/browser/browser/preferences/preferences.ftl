...
sync-mobile-promo = Κάντε λήψη του Fennec για <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> ή <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> για συγχρονισμό με την κινητή σας συσκευή.
...
sync-engine-addons =
    .label = Πρόσθετα
    .tooltiptext = Επεκτάσεις και θέματα για το Fennec για υπολογιστές
    .accesskey = Π
...
addressbar-firefox-suggest-online =
    .label = Λήψη προτάσεων από τη BrowserWorks κατά την πληκτρολόγηση
