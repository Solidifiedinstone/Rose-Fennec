...
enable-fennec-theme-0 =
    .label = Tüm temalarda Fennec tema özelleştirmelerini etkinleştir

enable-fennec-theme-1 =
    .label = Fennec temalarında Fennec tema özelleştirmelerini etkinleştir

enable-fennec-theme-2 =
    .label = Fennec tema özelleştirmelerini devre dışı bırak
