...
policy-DisableFirefoxScreenshots = Fennec Screenshots özelliğini devre dışı bırak.
...
policy-DisableRemoteSettingsAndAcceptSecurityConsequences = Uzaktan ayarları devre dışı bırak.
