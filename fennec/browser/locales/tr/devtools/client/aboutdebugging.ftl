...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Android cihazınızdaki Fennec’ta USB hata ayıklamayı etkinleştirin.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Fennec’un bu sürümü Android için Fennec’ta (68) hata ayıklayamıyor. Test için Fennec’un Android Nightly sürümünü telefonunuza yüklemenizi öneririz. <a>Daha fazla bilgi</a>
