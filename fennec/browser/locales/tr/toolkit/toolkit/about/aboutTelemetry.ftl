...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Fennec Veri Belgeleri</a>, veri araçlarımızla nasıl çalışabileceğinize dair rehberleri içerir.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Fennec Telemetri istemcisi belgeleri</a> kavram tanımlarını, API belgelerini ve veri referanslarını içerir.
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">Telemetri panoları</a> BrowserWorks’nın Telemetri aracılığıyla aldığı verileri görselleştirmenize olanak tanır.
