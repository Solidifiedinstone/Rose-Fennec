...
addon-detail-quarantined-domains-label = Kısıtlanmış sitelerde çalıştır
...
addon-badge-line3 =
    .title = Resmi BrowserWorks uzantısı. Güvenlik ve performans standartlarını karşılar.
...
addon-badge-recommended4 =
    .title = Fennec yalnızca güvenlik ve performans standartlarını karşılayan uzantıları önerir
...
recommended-theme-1 = Yaratıcı gününüzde misiniz? <a data-l10n-name="link">Fennec Color ile kendi temanızı oluşturun.</a>
...
details-notification-hard-blocked-extension =
    .message = Bu uzantı BrowserWorks politikalarını ihlal ettiği için engellendi ve devre dışı bırakıldı.
details-notification-hard-blocked-other =
    .message = Bu eklenti BrowserWorks politikalarını ihlal ettiği için engellendi ve devre dışı bırakıldı.
...
details-notification-soft-blocked-extension-disabled =
    .message = Bu uzantı BrowserWorks’nın politikalarını ihlal ettiği için kısıtlandı ve devre dışı bırakıldı. Uzantıyı etkinleştirebilirsiniz ama bu riskli olabilir.
details-notification-soft-blocked-extension-enabled =
    .message = Bu uzantı BrowserWorks politikalarını ihlal ediyor. Kullanılması riskli olabilir.
details-notification-soft-blocked-other-disabled =
    .message = Bu eklenti BrowserWorks’nın politikalarını ihlal ettiği için kısıtlandı ve devre dışı bırakıldı. Uzantıyı etkinleştirebilirsiniz ama bu riskli olabilir.
details-notification-soft-blocked-other-enabled =
    .message = Bu eklenti BrowserWorks politikalarını ihlal ediyor. Kullanılması riskli olabilir.
...
plugins-openh264-description = Bu yan uygulama, WebRTC şartnamesine uyum sağlamak ve H.264 video çözücüye ihtiyaç duyan cihazlarda WebRTC görüşmeleri yapabilmek amacıyla BrowserWorks tarafından otomatik yüklenir. Çözücünün kaynak kodlarını görmek ve daha fazla bilgi almak için http://www.openh264.org/ adresini ziyaret edin.
