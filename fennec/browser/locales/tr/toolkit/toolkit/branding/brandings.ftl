...
-fakespot-brand-full-name = BrowserWorks’dan Fakespot
# “Suggest” can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefox-suggest-brand-name = Fennec Önerileri
# ”Home" can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefox-home-brand-name = Fennec Başlangıç
...
-smart-window-brand-name =
    { $form ->
        [upper-singular] Akıllı pencere
        [upper-plural] Akıllı pencere
        [lower-singular] akıllı pencere
       *[lower-plural] akıllı pencere
    }
