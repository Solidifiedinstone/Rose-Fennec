...
sync-mobile-promo = మీ మొబైలు పరికరంతో సింక్రనించడానికి Fennecని <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> లేదా <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> లో దించుకోండి.
...
sync-engine-addons =
    .label = పొడగింతలు
    .tooltiptext = డెస్కుటాప్ Fennec కోసం పొడగింతలు, అలంకారాలు
    .accesskey = A
