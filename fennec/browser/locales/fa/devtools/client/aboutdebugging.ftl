...
about-debugging-sidebar-this-firefox2 = این { -brand-shorter-name }
about-debugging-sidebar-this-firefox-title =
    .title = این { -brand-shorter-name }
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = برپایی
...
about-debugging-browser-version-too-old-fennec = این نگارش از Fennec نمی‌تواند Fennec اندروید (۶۸) را اشکال‌زدایی کند. پیشنهاد می‌کنیم که Fennec اندروید شبانه را روی تلفن همراه‌تان برای آزمایش نصب کنید.<a>جزئیات بیش‌تر</a>
