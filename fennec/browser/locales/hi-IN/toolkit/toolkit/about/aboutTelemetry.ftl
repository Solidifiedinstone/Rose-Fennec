...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Fennec डेटा दस्तावेज़ीकरण</a> में हमारे डेटा उपकरणों के साथ काम करने के तरीक़े हैं.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Fennec दूरमापी ग्राहक प्रलेखन</a> में संकल्पनाओं, API प्रलेखन और आँकड़ों के संदर्भ के लिए परिभाषाएँ शामिल हैं.
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">दूरमापी नियंत्रण-पट्ट</a> आपको दूरमापी के माध्यम से BrowserWorks को प्राप्त होने वाले आँकड़ों को देखने का अवसर देता है.
