...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Fennec Data Documentation</a> ina waɗi dabi kollirooji no kuutorɗe keɓe amen ngollortee.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Fennec Data Documentation</a> ina waɗi firooji miijanɗe, duttorɗe e keɓe API tuugorɗe.
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">Telemetry dashboards</a> ina addan maa waawde hollirde keɓe BrowserWorks heɓri Telemetry.
