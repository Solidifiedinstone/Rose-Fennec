...
rights-intro-point-1 = { -brand-short-name } ena yettinaa e maa tugnaade e sarɗiiji <a data-l10n-name="mozilla-public-license-link">BrowserWorks Public License</a>. Ɗum firti ko aɗa waawi huutoraade, tummbitaade, weeɗde { -brand-short-name } woɗɓe.  Aɗa yamiraa kadi waylude dokkol yummawol { -brand-short-name } ngol no njiɗir-ɗaa ngam nafoore maa heeriingo. BrowserWorks Public License ena hokku-maa kadi hakke weeɗde jame maa bayklaaɗe ɗee.
rights-intro-point-2 = A hokkaaka hay hakke gooto wonande marke ɗee walla jamirooje marke BrowserWorks walla baawɗo wonde kala, ena jeyaa heen tawa alaa ɗo haaɗi innde Fennec ndee e logo mum. Humpito wonngo baɗte marke ena heɓoo <a data-l10n-name="mozilla-trademarks-link">ɗoo</a>.
