...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = ເປີດໃຊ້ການດີບັກ USB ໃນ Fennec ໃນອຸປະກອນ Android.
# USB section step by step guide
...
about-debugging-browser-version-too-old = ບຣາວເຊີທີ່ເຊື່ອມຕໍ່ມີເວີຊັນເກົ່າ ({ $runtimeVersion }). ຮຸ່ນຕ່ຳສຸດທີ່ຮອງຮັບແມ່ນ ({ $minVersion }). ນີ້ແມ່ນການຕັ້ງຄ່າທີ່ບໍ່ຮອງຮັບ ແລະ ອາດເຮັດໃຫ້ DevTools ລົ້ມເຫລວ. ກະລຸນາອັບເດດຕົວທ່ອງເວັບທີ່ເຊື່ອມຕໍ່. <a>ການແກ້ໄຂບັນຫາ</a>
# Dedicated message for a backward compatibility issue that occurs when connecting:
# from Fx 70+ to the old Firefox for Android (aka Fennec) which uses Fx 68.
about-debugging-browser-version-too-old-fennec = Fennec ລຸ້ນນີ້ບໍ່ສາມາດແກ້ບັນຫາ Fennec ສໍາລັບ Android (68). ພວກເຮົາແນະນໍາໃຫ້ຕິດຕັ້ງ Fennec ສໍາລັບ Android Nightly ໃນໂທລະສັບຂອງທ່ານເພື່ອທົດສອບ. <a>ລາຍລະອຽດເພີ່ມເຕີມ</a>
...
about-debugging-browser-version-too-recent = ຕົວທ່ອງເວັບທີ່ເຊື່ອມຕໍ່ແມ່ນຫລ້າສຸດ ({ $runtimeVersion }, buildID { $runtimeID }) ຫຼາຍກວ່າ { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). ນີ້ແມ່ນການຕັ້ງຄ່າທີ່ບໍ່ຮອງຮັບ ແລະອາດເຮັດໃຫ້ DevTools ລົ້ມເຫລວ. ກະລຸນາອັບເດດ Fennec. <a>ການແກ້ໄຂບັນຫາ</a>
