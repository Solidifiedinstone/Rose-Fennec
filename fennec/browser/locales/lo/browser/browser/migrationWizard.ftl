...
migration-wizard-migrator-display-name-file-bookmarks = ບຸກມາກຈາກໄຟລ໌ HTML
...
migration-imported-safari-reading-list = ລາຍການອ່ານ (ຈາກ Safari)
migration-imported-edge-reading-list = ລາຍການອ່ານ (ຈາກ Edge)
