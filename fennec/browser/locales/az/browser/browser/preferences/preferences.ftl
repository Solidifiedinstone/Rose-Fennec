...
sync-mobile-promo = Mobil cihazınızda sinronlaşdırmaq istəyirsinizsə <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> və ya <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> üçün Fennec endirin.
...
sync-engine-addons =
    .label = Əlavələr
    .tooltiptext = Fennec masaüstü üçün uzantı və mövzular
    .accesskey = Ə
