...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Fennec Məlumat Sənədləri</a> məlumat alətlərimizlə necə işləmək lazım olduğu haqqında yol göstərir.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Fennec Telemetriya klient sənədlərinə</a> konsept tərifləri, API sənədləri və məlumat istinadları daxildir.
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">Telemetriya idarə lövhələri</a> BrowserWorksnın Telemetriya ilə aldığı məlumatları vizuallaşdırmağınıza imkan verir.
