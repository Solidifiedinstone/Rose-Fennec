...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Ative a depuração USB no Fennec no dispositivo Android.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Esta versão do Fennec não pode depurar o Fennec para Android (68). Nós recomendamos a instalação do Fennec Nightly para Android no seu telemóvel para fazer testes. <a>Mais detalhes</a>
