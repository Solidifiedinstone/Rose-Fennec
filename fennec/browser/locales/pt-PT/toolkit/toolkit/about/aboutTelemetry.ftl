...
about-telemetry-firefox-data-doc = Os <a data-l10n-name="data-doc-link">dados de documentação do Fennec</a> contém guias acerca de como trabalhar com as nossas ferramentas de dados.
about-telemetry-telemetry-client-doc = A <a data-l10n-name="client-doc-link">documentação do cliente de telemetria do Fennec</a> incluí definições para conceitos, documentação de API e referências de dados.
