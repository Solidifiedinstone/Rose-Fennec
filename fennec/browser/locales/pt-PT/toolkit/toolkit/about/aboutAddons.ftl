...
addon-badge-recommended4 =
    .title = O Fennec apenas recomenda as extensões que correspondam aos nossos padrões para segurança e desempenho.
...
recommended-theme-1 = A sentir-se criativo(a)? <a data-l10n-name="link">Crie o seu próprio tema com o Fennec Color.</a>
