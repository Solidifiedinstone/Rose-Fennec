...
help-button-label2 = { -brand-short-name } সাপোর্ট
    .title = { -brand-short-name } সাপোর্ট
...
sync-mobile-promo = Fennec ডাউনলোড <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> অথবা <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> আপনার মোবাইল ডিভাইসের সাথে সিঙ্ক করতে।
