...
about-debugging-browser-version-too-old-fennec = Esta versión de Fennec no puede depurar Fennec para Android (68). Recomendamos instalar Fennec para Android Nightly en tu teléfono para realizar pruebas. <a>Más detalles</a>
