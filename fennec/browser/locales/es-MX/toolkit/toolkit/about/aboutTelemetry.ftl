...
about-telemetry-telemetry-client-doc = La <a data-l10n-name="client-doc-link">documentación de cliente de Fennec Telemetry</a> incluye definiciones para conceptos, documentación de API y referencias de datos.
