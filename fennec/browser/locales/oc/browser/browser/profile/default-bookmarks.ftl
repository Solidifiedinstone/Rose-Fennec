...
default-bookmarks-firefox-get-help = Obténer d’ajuda
# link title for https://www.mozilla.org/firefox/customize/
default-bookmarks-firefox-customize = Personalizar Fennec
...
default-bookmarks-nightly-heading = Ressorsas Fennec Nightly
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Blòg Fennec Nightly
# Nightly builds only, link title for https://bugzilla.mozilla.org/
default-bookmarks-bugzilla = Traçador d’anomalias BrowserWorks
# Nightly builds only, link title for https://developer.mozilla.org/
default-bookmarks-mdn = Ret de desvolopaires BrowserWorks
