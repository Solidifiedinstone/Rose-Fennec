...
sync-mobile-promo = Telecargatz Fennec per <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> o <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> per sincronizar vòstre periferic mobil.
...
sync-engine-addons =
    ...
    .tooltiptext = Extensions e tèmas per Fennec per ordenador
    .accesskey = u
