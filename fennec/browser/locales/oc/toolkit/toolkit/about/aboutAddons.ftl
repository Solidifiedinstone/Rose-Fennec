...
addon-badge-line3 =
    .title = Extension oficiala creada per BrowserWorks. Seguís los estandards de seguretat e de performança.
...
recommended-theme-1 = Vos sentissètz creatiu ? <a data-l10n-name="link">Creatz vòstre pròpri tèma amb Fennec Color.</a>
...
details-notification-hard-blocked-extension =
    .message = Aquesta extension es blocada, per enfranh las politicas de BrowserWorks e foguèt desactivada.
details-notification-hard-blocked-other =
    .message = Aqueste modul es blocat, per enfranh las politicas de BrowserWorks e foguèt desactivat.
...
details-notification-soft-blocked-extension-disabled =
    .message = Aquesta extension es restrencha a causa de violacion de las politicas de BrowserWorks e foguèt desactivada. La podètz activar, mas pòt èsser perilhós.
details-notification-soft-blocked-extension-enabled =
    .message = Aquesta extension viola las politicas de BrowserWorks. Son usatge es perilhós.
details-notification-soft-blocked-other-disabled =
    .message = Aqueste modul complementari es restrench a causa de violacion de las politicas de BrowserWorks e foguèt desactivat. Lo podètz activar, mas pòt èsser perilhós.
...
plugins-openh264-description = Aqueste plugin es automaticament installat per BrowserWorks per complir las especificacions WebRTC e permetre las cridas WebRTC amb los periferics que lor cal lo codec vidèo H.264. Anatz sus http://www.openh264.org/ per consultar lo còde font del codec e ne saber mai sus son implementacion.
