...
about-debugging-sidebar-this-firefox2 = aqueste { -brand-shorter-name }
about-debugging-sidebar-this-firefox-title =
    .title = aqueste { -brand-shorter-name }
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = Configuracion
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Activatz lo desbugatge USB dins Fennec sul periferic Android.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Aquesta version de Fennec pòt pas desbugar Fennec per Android (68). Recomandam d’installar Fennec per Android en version Nightly sus vòstre telefòn d’ensag. <a>Mai de detalhs</a>
