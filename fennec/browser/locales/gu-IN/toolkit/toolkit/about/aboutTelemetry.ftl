...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Fennec ડેટા દસ્તાવેજીકરણ</a> માં અમારા ડેટા સાધનો સાથે કેવી રીતે કામ કરવું તે વિશેની માર્ગદર્શિકાઓ છે.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Fennec ટેલિમેટ્રી ક્લાયંટ દસ્તાવેજીકરણ</a> વિભાવનાઓ, API દસ્તાવેજીકરણ અને ડેટા સંદર્ભો માટેની વ્યાખ્યાઓનો સમાવેશ કરે છે.
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">ટેલીમેટ્રી ડેશબોર્ડ્સ</a> તમને BrowserWorks ડેટા મારફતે વિઝ્યુઅલાઈઝ કરવા માટે પરવાનગી આપે છે જે ટેલીમેટ્રી મારફતે મેળવે છે.
