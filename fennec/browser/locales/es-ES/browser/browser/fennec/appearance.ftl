...
enable-fennec-theme-0 =
    .label = Activar las personalizaciones de tema de Fennec en todos los temas

enable-fennec-theme-1 =
    .label = Activar las personalizaciones de tema de Fennec solo en los temas de Fennec

enable-fennec-theme-2 =
    .label = Desactivar las personalizaciones de tema de Fennec
