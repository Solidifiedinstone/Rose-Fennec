...
do-not-track-removal3 =
    .message = Ya no admitimos la función “No rastrear”.
non-technical-privacy-heading =
    .label = Protecciones adicionales
preferences-privacy-relay-available =
    .label = Sugerir máscaras de correo electrónico de { -relay-brand-name }
    .description = Se oculta la dirección de correo electrónico real para proteger su bandeja de entrada del spam.
...
pane-experimental-reset =
    ...
    .accesskey = R
help-button-label2 = Asistencia de { -brand-short-name }
    .title = Asistencia de { -brand-short-name }
...
browser-layout-vertical-tabs2 =
    ...
    .title = Pestañas en el lateral, en la barra lateral
    .description = Pestañas en el lateral, en la barra lateral
...
preferences-web-appearance-choice-auto3 =
    .label = Sistema
    .title = Cambiar automáticamente fondos y contenido de sitios web basándose en la configuración de su sistema y el tema de { -brand-short-name }.
...
website-language-heading =
    ...
    .description = Algunas página se muestran en múltiples idiomas. Seleccione idiomas en el orden que prefiera.
...
browser-language-fallback-label =
    ...
    .description = Usado cuando la localización del idioma preferido está incompleta.
...
applications-setting2 =
    ...
    .description = Elija cómo { -brand-short-name } maneja los archivos y contenidos descargados.
applications-filter =
...
update-application-warning-cross-user-setting-2 =
    .message = Esta configuración se aplicará a todas las cuentas de Windows y los perfiles { -brand-short-name } usando esta instalación de { -brand-short-name }.
...
home-custom-homepage-no-results =
    .label = No hay sitios web añadidos todavía
...
sync-mobile-promo = Descargar Fennec para <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> o <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> para sincronizar con su dispositivo móvil.
...
sync-engine-addons =
    .label = Complementos
    .tooltiptext = Extensiones y temas para Fennec de escritorio
    .accesskey = C
...
addressbar-firefox-suggest-online =
    .label = Obtener sugerencias de BrowserWorks mientras escribe
...
permissions-block-popups-exceptions-button4 =
    .label = Administrar excepciones
    .description = Añada sitios web que puedan abrir ventanas emergentes y usar redirecciones de terceros.
    .accesskey = e
...
settings-redesign-promo =
    ...
    .message = Esta página se reorganizó para facilitar la lectura y la exploración. No hubo cambios en los ajustes personales y todo sigue aquí. Sugerencia: utilice la búsqueda para ir directamente a lo necesario.
...
# The search keyword isn't shown to users but is used to find relevant settings in about:preferences.
data-collection =
    .label = Recopilación y uso de datos de { -brand-short-name }
...
data-collection-backlogged-crash-reports =
    .label = Enviar automáticamente los informes de fallos
    .description =
        Esto ayuda a que { -vendor-short-name } diagnostique y arregle problemas con el navegador.
        Los informes pueden incluir datos personales o sensibles.
    .accesskey = c
...
preferences-etp-custom-cookie-behavior-block-all-cross-site-cookies =
    .label = Bloquear todas las cookies entre sitios (puede causar errores en los sitios web)
...
security-privacy-issue-warning-doh =
    ...
    .description = DNS sobre HTTPS oculta a su proveedor de red qué sitios visita.
security-privacy-issue-warning-ech =
    .label = Encrypted Client Hello está desactivado
    .description = Encrypted Client Hello oculta a su proveedor de red qué sitios visita.
