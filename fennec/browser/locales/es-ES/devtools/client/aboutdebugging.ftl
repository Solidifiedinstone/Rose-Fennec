...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Activar depuración USB en Fennec en el dispositivo Android.
# USB section step by step guide
