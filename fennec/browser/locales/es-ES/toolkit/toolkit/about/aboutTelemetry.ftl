...
about-telemetry-firefox-data-doc = La <a data-l10n-name="data-doc-link">Documentación de datos de Fennec</a> contiene guías sobre cómo trabajar con nuestras herramientas de datos.
about-telemetry-telemetry-client-doc = La <a data-l10n-name="client-doc-link">documentación del cliente Telemetry de Fennec</a> incluye definiciones de conceptos, documentación de la API y referencias de datos.
