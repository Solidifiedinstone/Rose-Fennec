...
search-suggestions-cant-show-2 =
    .message = অনুসন্ধানের পরামর্শগুলি লোকেশান বারে দেখানো হবেনা কারণ আপনি { -brand-short-name } কনফিগার করেছেন হিস্ট্রিতে মনে না রাখার জন্য।
...
search-engine-group =
    .label = ডিফল্ট সার্চ ইঞ্জিন
search-default-engine =
    .aria-label = ডিফল্ট সার্চ ইঞ্জিন
...
sync-mobile-promo = Fennec ডাউনলোড <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> বা <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> আপনার মোবাইল ডিভাইসের সাথে সুসংগত করতে।
...
sync-profile-picture-with-alt =
    .tooltiptext = প্রোফাইল ছবি পরিবর্তন করুন
    .alt = প্রোফাইল ছবি পরিবর্তন করুন
sync-manage-account = অ্যাকাউন্ট পরিচালনা
    .accesskey = o
sync-manage-account2 =
    .label = অ্যাকাউন্ট পরিচালনা
    .accesskey = o
...
sync-engine-addons =
    .label = অ্যাড-অন
    .tooltiptext = Fennec ডেস্কটপের জন্য এক্সটেনশন ও থিম
    .accesskey = A
