...
about-debugging-sidebar-this-firefox2 = Ang { -brand-shorter-name } na ito
about-debugging-sidebar-this-firefox-title =
    .title = Ang { -brand-shorter-name } na ito
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = I-enable ang USB Debugging sa Fennec sa Android device.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Ang bersyon na ito ng Fennec ay hindi maaaring mag-debug ng Fennec for Android (68). Inirerekomenda naming mag-install ng Fennec for Android Nightly sa iyong telepono para makapag-test. <a>Karagdagang detalye</a>
...
about-debugging-browser-version-too-recent = Ang nakakonektang browser ay mas bago ({ $runtimeVersion }, buildID { $runtimeID }) kaysa sa iyong { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Hindi ito suportadong setup at maaaring makasira sa DevTools. Paki-update ang Fennec. <a>Pag-troubleshoot</a>
...
about-debugging-extension-backgroundscript-status-running = Tumatakbo
# Displayed for extension using a non-persistent background page when is currently stopped.
about-debugging-extension-backgroundscript-status-stopped = Huminto
