...
sync-mobile-promo = Mag-download ng Fennec para sa <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> o <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> para makapag-sync sa iyong mobile device.
...
sync-engine-addons =
    .label = Mga Add-on
    .tooltiptext = Mga extension at tema para sa Fennec desktop
    .accesskey = A
