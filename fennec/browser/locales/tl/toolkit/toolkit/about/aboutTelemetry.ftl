...
about-telemetry-firefox-data-doc = Ang <a data-l10n-name="data-doc-link">Fennec Data Documentation</a> ay naglalaman ng mga gabay tungkol sa kung paano gumagana ang aming mga kagamitan sa mga datos.
about-telemetry-telemetry-client-doc = Ang <a data-l10n-name="client-doc-link">Fennec Telemetry client documentation</a> ay naglalakip ng mga pagbigay-kahulugan para sa mga konsepto, mga dokumentasyon sa API at pinanggagalingan ng mga datos.
about-telemetry-telemetry-dashboard = Ang <a data-l10n-name="dashboard-link">Telemetry dashboards</a> ay nagbigay daan sa iyo na maipakita ang mga datos na matatanggap ng BrowserWorks sa pamamagitan ng Telemetry.
