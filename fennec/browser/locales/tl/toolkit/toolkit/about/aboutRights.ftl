...
rights-intro-point-1 = { -brand-short-name } is made available to you under the terms of the <a data-l10n-name="mozilla-public-license-link">BrowserWorks Public License</a>. This means you may use, copy and distribute { -brand-short-name } to others.  You are also welcome to modify the source code of { -brand-short-name } as you want to meet your needs. The BrowserWorks Public License also gives you the right to distribute your modified versions.
rights-intro-point-2 = Ikaw ay hindi nabigyan ng anumang mga karapatan sa trademark o lisensya sa trademark ng BrowserWorks o anumang partido, kasama ang walang limitasyon ang Fennec pangalan o logo. Maaaring matagpuan ang karagdagang impormasyon sa mga trademark<a data-l10n-name="mozilla-trademarks-link">dito</a>.
