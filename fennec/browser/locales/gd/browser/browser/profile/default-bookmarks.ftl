...
default-bookmarks-firefox-customize = Gnàthaich Fennec
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = Gabh pàirt ann
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = Mu ar dèidhinn
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = Goireasan Fennec Nightly
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Bloga Fennec Nightly
# Nightly builds only, link title for https://bugzilla.mozilla.org/
default-bookmarks-bugzilla = Tracaiche bugaichean BrowserWorks
# Nightly builds only, link title for https://developer.mozilla.org/
default-bookmarks-mdn = Lìonra luchd-leasachaidh BrowserWorks
...
default-bookmarks-planet = Planaid BrowserWorks
