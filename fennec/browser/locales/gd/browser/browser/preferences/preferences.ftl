...
sync-mobile-promo = Luchdaich a-nuas Fennec airson <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> no <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> gus sioncronachadh a dhèanamh leis an uidheam mobile agad.
...
sync-engine-addons =
    ...
    .tooltiptext = Leudachain is ùrlaran airson Fennec desktop
    .accesskey = a
