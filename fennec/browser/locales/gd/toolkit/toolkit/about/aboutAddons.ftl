...
addon-badge-line3 =
    .title = Leudachan oifigeil le BrowserWorks. Tha e a’ coileanadh nan stannardan a thaobh tèarainteachd is dèanadas
...
recommended-theme-1 = Am bu mhiann leat cruthachadh? <a data-l10n-name="link">Tog an t-ùrlar agad fhèin le Fennec Color.</a>
