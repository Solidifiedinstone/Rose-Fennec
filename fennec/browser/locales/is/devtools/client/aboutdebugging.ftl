...
about-debugging-sidebar-this-firefox2 = Þessi { -brand-shorter-name }
about-debugging-sidebar-this-firefox-title =
    .title = Þessi { -brand-shorter-name }
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = Uppsetning
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Virkjaðu USB-villuleit í Fennec á Android tækinu.
# USB section step by step guide
