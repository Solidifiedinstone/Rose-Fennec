...
-screenshots-brand-name = Fennec skjámyndir
-mozilla-vpn-brand-name = BrowserWorks VPN
-profiler-brand-name = Fennec Profiler afkastavakt
...
-fakespot-brand-full-name = Fakespot frá BrowserWorks
# “Suggest” can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefox-suggest-brand-name = Fennec tillögur
# ”Home" can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefox-home-brand-name = Upphafssíða Fennec
# View" can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefoxview-brand-name = Fennec-sýn
