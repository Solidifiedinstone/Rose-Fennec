...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Dokumentasi Data Fennec</a> mengandungkan panduan perihal cara menggunakan alatan data kami.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Fennec Telemetry klien dokumentasi</a> menjelaskan takrif konsep, dokumentasi API dan rujukan data.
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">Papan pemuka Telemetri</a> membolehkan anda menggambarkan data yang diterima oleh BrowserWorks melalui Telemetri.
