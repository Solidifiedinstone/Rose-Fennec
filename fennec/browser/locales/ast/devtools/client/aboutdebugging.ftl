...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Activa la depuración per USB en Fennec p'Android
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Esta versión de Fennec nun pue depurar Fennec p'Android (68). Aconseyámoste instalar Fennec Nightly p'Android nel preséu pa facer pruebes. <a>Más detalles</a>
