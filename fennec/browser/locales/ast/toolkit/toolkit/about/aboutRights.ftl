...
rights-intro-point-1 =
    ...
    <a data-l10n-name="mozilla-public-license-link">BrowserWorks Public License</a>.
    ...
    necesidaes. La BrowserWorks Public License tamién te da derechu a distribuyir les
    versiones que modifiques.
rights-intro-point-2 =
    Nun te concedemos nengún derechu o llicencia en rellación a les marques
    rexistraes de BrowserWorks o filiales, qu'inclúin ensin llende'l nome
    o logotipu de Fennec. Pues atopar más información tocante a les marques
