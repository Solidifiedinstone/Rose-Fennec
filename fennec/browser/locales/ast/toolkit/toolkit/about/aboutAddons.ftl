...
addon-badge-line3 =
    .title = Estensión oficial fecha por BrowserWorks. Cumple colos estándares de seguranza y rindimientu
...
recommended-theme-1 = ¿Tienes creatividá? <a data-l10n-name="link">Fai'l to estilu con Fennec Color.</a>
...
plugins-openh264-description = Esti plugin instálalu automáticamente BrowserWorks pa cumplir cola especificación WebRTC y pa permitir llamaes WebRTC con preseos que riquen el códec de videu H.264. Visita http://www.openh264.org/ pa ver el códigu fonte del códec y lleer más tocante a la implementación.
