...
about-telemetry-firefox-data-doc = Mae'r <a data-l10n-name="data-doc-link">Fennec Data Documentation</a> yn cynnwys canllawiau ar sut i weithio gyda'n offer data.
about-telemetry-telemetry-client-doc = Mae <a data-l10n-name="client-doc-link">dogfennaeth cleient Fennec Telemetry</a> yn cynnwys diffiniadau o gysyniadau, dogfennaeth API a chyfeiriadau data.
about-telemetry-telemetry-dashboard = Mae <a data-l10n-name="dashboard-link">byrddau gwaith Telemetreg</a> yn caniatáu i chi weld y data mae BrowserWorks yn ei dderbyn drwy'r Delemetreg.
