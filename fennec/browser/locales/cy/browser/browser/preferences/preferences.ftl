...
sync-mobile-promo = Llwytho Fennec i lawr ar gyfer <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> neu <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> i gydweddu gyda'ch dyfais symudol.
...
sync-engine-addons =
    .label = Ychwanegion
    .tooltiptext = Estyniadau a themâu ar gyfer Fennec bwrdd gwaith
    .accesskey = Y
...
addressbar-firefox-suggest-online =
    .label = Cael awgrymiadau gan BrowserWorks wrth i chi deipio
