...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Galluogi Dadfygio USB yn Fennec ar y ddyfais Android.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Nid oes modd i'r fersiwn yma o Fennec ddadfygio Fennec ar gyfer Android (68). Rydym yn argymell gosod Fennec ar gyfer Android Nightly ar eich ffôn i'w brofi. <a> Rhagor o fanylion </a>
...
about-debugging-browser-version-too-recent = Mae'r porwr cysylltiedig yn fwy diweddar ( { $runtimeVersion }, buildID { $runtimeID }) na'ch { -brand-shorter-name } ({ $localVersion }, BuildID{ $localID }). Mae hwn yn osodiad heb gefnogaeth ac fe all beri i DevTools fethu. Diweddarwch Fennec. <a>Datrys Problemau</a>
