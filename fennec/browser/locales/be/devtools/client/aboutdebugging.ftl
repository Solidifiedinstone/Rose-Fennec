...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Уключыце адладку USB у Fennec на прыладзе Android.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Гэта версія Fennec не можа адладзіць Fennec для Android (68). Рэкамендуем усталяваць Fennec для Android Nightly на ваш тэлефон для тэставання. <a>Падрабязней</a>
...
about-debugging-browser-version-too-recent = Падлучаны браўзер больш новы ({ $runtimeVersion }, buildID { $runtimeID }), чымся ваш { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Такая канфігурацыя не падтрымліваецца і можа прывесці да збою інструментаў распрацоўшчыка. Калі ласка, абнавіце Fennec. <a>Вырашэнне праблем</a>
