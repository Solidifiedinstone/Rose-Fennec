...
policy-AIControls = Наладзіць элементы кіравання штучным інтэлектам.
...
policy-DisableFirefoxScreenshots = Адключыць функцыю Fennec Screenshots.
...
policy-DisableRemoteSettingsAndAcceptSecurityConsequences = Адключыць аддаленыя налады.
...
policy-IPProtectionAvailable = Забараніць карыстальнікам карыстацца ўбудаванай VPN.
...
policy-RelaunchRequired = Патрабаваць перазапуск { -brand-short-name } на працягу зададзенага перыяду і паведамляць карыстальніку пра будучы перазапуск.
...
policy-SitePolicies = Палітыкі для канкрэтных сайтаў.
...
policy-XSLTEnabled = Уключыць або адключыць падтрымку XSLTProcessor JavaScript API і інструкцыі апрацоўкі XSLT.
