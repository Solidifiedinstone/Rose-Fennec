...
default-bookmarks-firefox-customize = Уладкаваць Fennec
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = Далучыцца
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = Пра нас
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = Рэсурсы Fennec Nightly
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Блог Fennec Nightly
# Nightly builds only, link title for https://bugzilla.mozilla.org/
default-bookmarks-bugzilla = Сістэма асочвання хібаў BrowserWorks
# Nightly builds only, link title for https://developer.mozilla.org/
default-bookmarks-mdn = Сетка распрацоўшчыкаў BrowserWorks
