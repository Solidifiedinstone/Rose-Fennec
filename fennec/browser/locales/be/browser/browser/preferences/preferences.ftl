...
do-not-track-removal3 =
    .message = Мы больш не падтрымліваем функцыю «Не асочваць»
...
managed-notice-info-icon =
    .alt = інфармацыя
managed-notice-nav =
    .label = Вашым браўзерам кіруе ваша арганізацыя.
category-list =
...
pane-about-firefox-title = Пра { -brand-short-name }
...
pane-experimental-reset =
    ...
    .accesskey = А
help-button-label2 = Падтрымка { -brand-short-name }
    .title = Падтрымка { -brand-short-name }
addons-button-label2 = Пашырэнні і тэмы
    .title = Пашырэнні і тэмы
...
switch-to-new-tabs-2 =
    .label = Па адкрыцці спасылкі ці медыя ў новай картцы адразу пераключацца на яе
    .accesskey = р
switch-to-new-tabs =
...
browser-containers-enabled-2 =
    .label = Ужываць карткі ў кантэйнерах
    .accesskey = т
...
settings-tabs-drag-to-create-tab-groups =
    .label = Перацягванне картак стварае групы картак
...
appearance-group2 =
    ...
    .description = Некаторыя сайты мяняюць колеры ў адпаведнасці з вашымі перавагамі. Абярыце сваю колеравую схему.
preferences-web-appearance-choice-auto3 =
    .label = Сістэмная
    .title = Аўтаматычна змяняць фон і змесціва сайтаў у залежнасці ад налад вашай сістэмы і тэмы { -brand-short-name }.
...
preferences-text-zoom-override-warning2 =
    .message = Калі параметр «Павялічваць толькі тэкст» уключаны, а прадвызначаны маштаб не 100%, некаторыя сайты могуць паказваць змесціва няправільна.
...
browser-language-heading =
    .label = Мова браўзера
    .description = Выберыце мову для адлюстравання меню, паведамленняў і абвестак з { -brand-short-name }.
browser-language-preferred-label =
    .label = Пажаданая мова
browser-language-fallback-label =
    .label = Рэзервовая мова
    .description = Выкарыстоўваецца, калі лакалізацыя на пераважнай мове няпоўная.
...
spellcheck-promo =
    ...
    .message = Націсніце правай кнопкай мышы ў тэкставым полі, каб уключыць або выключыць праверку арфаграфіі ці змяніць мову. Не ўсе палі падтрымліваюць праверку правапісу.
...
download-always-ask-where2 =
    .label = Пытаць, куды захаваць файлы, перад сцягваннем.
    .accesskey = ф
download-private-browsing-delete2 =
    .label = Выдаляць файлы, сцягнутыя ў прыватным акне, пры закрыцці
    .accesskey = В
...
applications-setting2 =
    .label = Файлы і праграмы
    .description = Выберыце, як { -brand-short-name } будзе апрацоўваць сцягнутыя файлы і змесціва.
applications-filter =
...
settings-keyboard-shortcuts-group =
    ...
    .description = Кантралюйце, як вы ажыццяўляеце навігацыю і ўзаемадзейнічаеце з { -brand-short-name }.
...
browsing-picture-in-picture-enable-when-switching-tabs =
    .label = Працягваць прайграваць відэа ў рэжыме «Выява ў выяве» пры пераключэнні картак
    .accesskey = ы
...
sync-mobile-promo = Сцягніце Fennec для <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> або <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a>, каб сінхранізавацца са сваёй мабільнай прыладай.
...
sync-engine-addons =
    .label = Дадаткі
    .tooltiptext = Пашырэнні і тэмы для настольнага Fennec
    .accesskey = Д
...
forms-primary-pw-on-2 = Галоўны пароль <strong>УКЛЮЧАНЫ</strong>
forms-primary-pw-on =
...
history-remember-option-never2 =
    ...
    .description = Кожнае акно дзейнічае як прыватнае акно. Калі гэта функцыя ўключана, пашырэнні павінны быць дазволены.
history-remember-option-custom2 =
    .label = Уладкаваць гісторыю
...
history-section-header =
    .label = Гісторыя
    .description = Выберыце, што павінен запомніць { -brand-short-name } пасля закрыцця браўзера.
...
sitedata-delete-on-close2 =
    .label = Ачышчаць кукі і звесткі сайтаў кожны раз па закрыцці { -brand-short-name }
    .accesskey = с
...
sitedata-delete-on-close-private-browsing4 =
    .heading = Гісторыя не будзе захоўвацца.
    .message = { -brand-short-name } будзе ачышчаць кукі і звесткі сайтаў з вашага сеансу пры закрыцці браўзера.
...
sitedata-heading =
    .label = Звесткі аглядання
    .description = Кіраванне кукамі, гісторыяй, кэшам, дадзенымі сайтаў і іншым.
sitedata-settings3 =
    .label = Ачысціць дадзеныя для пэўных сайтаў
    .accesskey = ы
sitedata-cookies-exceptions3 =
    .label = Кіраваць выключэннямі
    .accesskey = ч
    .description = Выберыце, як акрэсленыя сайты будуць апрацоўваць кукі і дадзеныя сайтаў.
...
addressbar-firefox-suggest-online =
    .label = Атрымліваць прапановы ад BrowserWorks ў часе ўводу тэксту
...
permissions-block-popups-exceptions-button4 =
    .label = Кіраваць выключэннямі
    .description = Дадайце сайты, якія могуць адкрываць выплыўныя вокны і выкарыстоўваць староннія перанакіраванні
    .accesskey = в
    .searchkeywords = усплывальныя, вынырцы, pop-ups, popups
...
backup-multi-profile-warning-message =
    .message = Каб пераканацца, што гэта змяненне ўключана ў вашы рэзервовыя копіі, адкрыйце кожны профіль і абярыце ў наладах «Зрабіць рэзервовую копію зараз».
nimbus-rollouts =
    .label = Дазволіць { -brand-short-name } паляпшаць функцыі, прадукцыйнасць і стабільнасць паміж абнаўленнямі
    .description = Змяненні будуць разгортвацца дыстанцыйна.
addon-recommendations3 =
    .label = Дазволіць персаналізаваныя рэкамендацыі пашырэнняў
    .description = Атрымлівайце рэкамендацыі пашырэнняў для палепшанага аглядання.
...
data-collection-preferences-across-profiles =
    .message = Гэтыя налады прымяняюцца да кожнага профілю { -brand-product-name } на гэтай прыладзе.
data-collection-profiles-link = Паглядзець усе профілі
data-collection-health-report-telemetry-disabled =
    .message = Вы больш не дазваляеце { -vendor-short-name } захоўваць тэхнічныя дадзеныя і звесткі аб узаемадзеянні. Усе мінулыя дадзеныя будуць выдалены на працягу 30 дзён.
data-collection-health-report =
    .label = Адпраўляць тэхнічныя звесткі і дадзеныя ўзаемадзеяння ў { -vendor-short-name }
    .accesskey = к
    .description = Гэта дапамагае нам палепшыць магчымасці, прадукцыйнасць і стабільнасць { -brand-product-name }.
data-collection-health-report-disabled =
    .label = Адпраўляць тэхнічныя звесткі і дадзеныя ўзаемадзеяння ў { -vendor-short-name }
    .accesskey = к
    .description = Для гэтай канфігурацыі зборкі справаздачнасць па дадзеных адключана.
data-collection-run-studies =
    .label = Дазволіць { -brand-short-name } выконваць даследаванні функцый
    .description = { -brand-short-name } выпадковым чынам выбірае карыстальнікаў для тэставання функцый, што дапамагае палепшыць якасць для ўсіх.
data-collection-studies-link =
    .label = Прагляд даследаванняў { -brand-short-name }
data-collection-backlogged-crash-reports =
    .label = Аўтаматычна адпраўляць справаздачы аб збоях
    .description = Гэта дапамагае { -vendor-short-name } дыягнаставаць і выпраўляць праблемы з браўзерам. Справаздачы могуць утрымліваць асабістыя або канфідэнцыйныя звесткі.
    .accesskey = с
data-collection-usage-ping =
    .label = Адпраўляць пінг штодзённага выкарыстання ў { -vendor-short-name }
    .description = Гэта дапамагае { -vendor-short-name } ацаніць актыўнасць карыстальнікаў.
    .accesskey = г
...
browsing-protection-group2 =
    ...
    .description = Небяспечныя сайты і сцягванні могуць паставіць пад пагрозу вашы звесткі і прыладу. { -brand-short-name } аўтаматычна блакуе іх і папярэджвае аб небяспечных або непажаданых праграмах.
...
security-safe-browsing-warning =
    .message = Адключэнне гэтай функцыі зніжае ахову ад махлярства, зламысных сайтаў і небяспечных сцягванняў.
...
certs-view2 =
    .label = Кіраваць сертыфікатамі
    .accesskey = с
certs-devices2 =
    .label = Кіраваць прыладамі бяспекі
    .accesskey = в
...
dns-over-https-group2 =
    ...
    .description = Сістэма даменных імён праз HTTPS (Domain Name System over HTTPS, DoH) шыфруе пошукі сайтаў, таму вашаму інтэрнэт-правайдару або іншым асобам цяжэй убачыць, якія сайты вы збіраецеся наведаць.
...
preferences-doh-overview-default =
    .label = Прадвызначаная ахова
    .description = Выкарыстоўваць бяспечны DNS у рэгіёнах, дзе ён даступны.
preferences-doh-overview-custom =
    .label = Адмыслова
    .description = Заўсёды ўжываць бяспечны DNS, кантралюючы свайго правайдара і рэзервовыя паводзіны.
preferences-doh-overview-off =
    .label = Адключана
    .description = Выкарыстоўваць прадвызначаны DNS-правайдар.
...
preferences-doh-fallback-label =
    .label = Заўсёды папярэджваць, калі бяспечны DNS недаступны
preferences-doh-status-item-off =
    .message = DNS праз HTTPS адключаны
# Variables:
#   $reason (string) - A string representation of the reason DoH is not active. For example NS_ERROR_UNKNOWN_HOST or TRR_RCODE_FAIL.
#   $name (string) - The name of the DNS over HTTPS resolver. If a custom resolver is used, the name will be the domain of the URL.
preferences-doh-status-item-not-active =
    .message = DNS праз HTTPS не працуе, бо пры спробе выкарыстання правайдара { $name } узнікла памылка ({ $reason })
# Variables:
#   $reason (string) - A string representation of the reason DoH is not active. For example NS_ERROR_UNKNOWN_HOST or TRR_RCODE_FAIL.
preferences-doh-status-item-not-active-bad-url =
    .message = DNS праз HTTPS не працуе, бо мы атрымалі нядзейсны URL ({ $reason })
# Variables:
#   $name (string) - The name of the DNS over HTTPS resolver. If a custom resolver is used, the name will be the domain of the URL.
preferences-doh-status-item-active =
    .message = DNS праз HTTPS выкарыстоўвае правайдара { $name }
# Variables:
#   $reason (string) - A string representation of the reason DoH is not active. For example NS_ERROR_UNKNOWN_HOST or TRR_RCODE_FAIL.
#   $name (string) - The name of the DNS over HTTPS resolver. If a custom resolver is used, the name will be the domain of the URL.
preferences-doh-status-item-not-active-local =
    .message = DNS праз HTTPS не працуе, бо пры спробе выкарыстання мясцовага правайдара { $name } узнікла памылка ({ $reason })
# Variables:
#   $name (string) - The name of the DNS over HTTPS resolver. If a custom resolver is used, the name will be the domain of the URL.
preferences-doh-status-item-active-local =
    .message = DNS праз HTTPS выкарыстоўвае мясцовага правайдара { $name }
preferences-doh-select-resolver-label =
    .label = Абраць правайдара:
# Variables:
#   $name (String) - Display name or URL for the DNS over HTTPS provider
connection-dns-over-https-url-item =
    .label = { $name }
    .tooltiptext = Выкарыстоўваць гэтага правайдара для вырашэння DNS праз HTTPS
...
appearance-window-density-group =
    .label = Шчыльнасць вокнаў
    .description = Рэгулюйце адлегласці вакол элементаў акна, такіх як паліца прылад, карткі і бакавая панэль.
appearance-window-density-radio-group =
    .aria-label = Шчыльнасць вокнаў
appearance-window-density-automatic =
    .label = Аўтаматычная (прадвызначана)
    .description = Стандартны інтэрвал, кампактны або дотык прымяняюцца аўтаматычна.
appearance-window-density-automatic-no-touch =
    .label = Аўтаматычная (прадвызначана)
    .description = Стандартны і кампактны інтэрвалы прымяняюцца аўтаматычна
appearance-window-density-standard =
    .label = Стандартная
    .description = Збалансаваны інтэрвал для большасці экранаў
appearance-window-density-auto-touch-mode =
    .label = Выкарыстоўваць інтэрвал "дотык" для планшэтнага рэжыму
appearance-window-density-compact =
    .label = Кампактная
    .description = Паменшаны інтэрвал для невялікіх экранаў
appearance-window-density-touch =
    .label = Дотык
    .description = Павялічаныя элементы акна і аб'екты націскання, аптымізаваныя для сенсарных экранаў
...
preferences-ai-controls-on-device-group =
    ...
    .description = Тут ужываюцца невялікія ШІ-мадэлі, якія сцягваюцца на вашу прыладу, калі вы карыстаецеся адпаведнай функцыяй. Такі падыход дапамагае абараніць вашу прыватнасць.
...
preferences-ai-controls-header3 =
    .heading = Кіраванне штучным інтэлектам

## Privacy and security status card

security-privacy-status-ok-header = { -brand-short-name } напагатове
# This is the header above a section telling the user about problems in their settings
security-privacy-status-problem-header = { -brand-short-name } рэкамендуе некаторыя паляпшэнні бяспекі
security-privacy-status-ok-label = Узмоцненая ахова ад сачэння ўключана
security-privacy-status-problem-label = Мы знайшлі налады, якія ўплываюць на вашу ахову
security-privacy-status-problem-helper-label = Паглядзець праблемы
security-privacy-status-pending-trackers-label = Пошук колькасці трэкераў, заблакаваных { -brand-short-name } за апошні месяц
# This label tells the user how many trackers we have blocked for them.
# Variables:
#   $trackerCount (Number) - Number of trackers we have blocked in the last month
security-privacy-status-trackers-label =
    { $trackerCount ->
        [one] { $trackerCount } трэкер заблакаваны за апошні месяц
        [few] { $trackerCount } трэкеры заблакавана за апошні месяц
       *[many] { $trackerCount } трэкераў заблакавана за апошні месяц
    }
...
preferences-etp-status-protections-dashboard-link =
    .label = Прагляд персаналізаванай панэлі аховы
    .description = Паглядзіце, колькі хітрых трэкераў заблакаваў для вас { -brand-short-name }, у тым ліку трэкеры сацыяльных сетак, збіральнікі лічбавых адбіткаў і крыптамайнеры.
preferences-etp-header =
    .heading = Узмоцненая ахова ад сачэння
preferences-etp-advanced-settings-group =
    .label = Дадатковыя налады
    .description = Сайты выкарыстоўваюць трэкеры, каб сачыць за вамі ў інтэрнэце і паказваць злавесную рэкламу. { -brand-short-name } ахоўвае вас у часе аглядання, аўтаматычна блакуючы большасць трэкераў, каб ваш лічбавы след быў пад вашым кантролем.
preferences-etp-customize-button =
    .label = Уладкаваць ахову ад сачэння
preferences-etp-reload-tabs-hint =
    .message = Перазагрузіце карткі, каб прымяніць гэтыя змены.
preferences-etp-reload-tabs-hint-button =
    .label = Перазагрузіць усе карткі
preferences-etp-rfp-warning-message =
    .message = Вы выкарыстоўваеце функцыю абароны ад збіральнікаў лічбавых адбіткаў (Resist Fingerprinting, RFP), якая замяняе некаторыя налады аховы { -brand-short-name }. Гэта можа прывесці да няспраўнасці некаторых сайтаў.
preferences-etp-level-warning-message =
    .heading = Увага! Некаторыя сайты могуць не працаваць належным чынам.
    .message = Некаторыя сайты ўбудоўваюць трэкеры ў свае функцыі або змесціва. Калі { -brand-short-name } блакуе іх, сайт выглядае няспраўным. Паспрабуйце скарыстаць функцыю «Выправіць праблему з сайтам» ці адключыць ахову ад сачэння на гэтым сайце.
preferences-etp-manage-exceptions-button =
    .label = Кіраванне выключэннямі
    .description = Кіруйце сайтамі, на якіх Узмоцненая ахова ад сачэння адключана.
preferences-etp-customize-header =
    .heading = Уладкаваць ахову ад сачэння
preferences-etp-reset =
    .label = Скінуць уладкаванні
    .description = Узнавіць налады папярэдне зададзенага ўзроўню аховы.
preferences-etp-reset-standard-button =
    .label = Скінуць да стандартнай
preferences-etp-reset-strict-button =
    .label = Скінуць да строгай
preferences-etp-custom-control-group =
    .label = Ахова ад сачэння
    .description = Выберыце, якія меры аховы ўключыць або выключыць.
...
preferences-etp-custom-suspect-fingerprinting-protection-enabled-context =
    .aria-label = Падазраваныя збіральнікі лічбавых адбіткаў

## Warnings section

security-privacy-issue-warning-fingerprinters =
    .label = Вядомыя збіральнікі лічбавых адбіткаў не блакуюцца
    .description = Гэта можа дазволіць некаторым трэкерам сачыць за вамі без кукі.
security-privacy-issue-warning-third-party-cookies =
    .label = Кукі ад трэцяга боку ўключаны
    .description = Староннія кукі ўжываюцца, каб сачыць за вамі на розных сайтах.
security-privacy-issue-warning-password-manager =
    .label = Менеджар пароляў адключаны
    .description = Менеджар пароляў дапамагае захоўваць моцныя паролі для вашых ўліковых запісаў.
security-privacy-issue-warning-popup-blocker =
    .label = Блакаванне выплыўных вокнаў адключана
    .description = Выплыўныя вокны перашкаджаюць працы і патэнцыйна небяспечныя.
security-privacy-issue-warning-extension-install =
    .label = Сайты могуць усталёўваць пашырэнні
    .description = Вэб-сайты могуць усталёўваць пашырэнні ў { -brand-short-name } без запыту.
security-privacy-issue-warning-safe-browsing =
    .label = Небяспечнае і падманлівае змесціва не блакуецца
    .description = Павялічваецца рызыка махлярства і шкодных праграм з вэб-сайтаў.
security-privacy-issue-warning-doh =
    .label = DNS праз HTTPS адключаны
    .description = DNS праз HTTPS хавае ад вашага правайдара інтэрнэту, якія сайты вы наведваеце.
security-privacy-issue-warning-ech =
    .label = Зашыфраванае прывітанне кліента адключана
    .description = Зашыфраванае прывітанне кліента (Encrypted Client Hello) хавае ад вашага інтэрнэт-правайдара, якія сайты вы наведваеце.
