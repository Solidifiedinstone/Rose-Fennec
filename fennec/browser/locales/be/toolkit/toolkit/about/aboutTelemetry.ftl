...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Дакументацыя дадзеных Fennec</a> змяшчае кіраўніцтва па працы з нашымі інструментамі збору дадзеных.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Дакументацыя кліента тэлеметрыі Fennec</a> змяшчае вызначэнні канцэпцый, дакументацыю па API і даведку па дадзеных.
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">Панэлі Тэлеметрыі</a> дазваляюць вам візуалізаваць дадзеныя, атрыманыя BrowserWorks праз тэлеметрыю.
