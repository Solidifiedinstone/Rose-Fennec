...
-mdn-brand-name = Вэб-дакументацыя MDN
...
-fakespot-brand-full-name = Fakespot ад BrowserWorks
# “Suggest” can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefox-suggest-brand-name = Прапановы Fennec
# ”Home" can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefox-home-brand-name = Хатняя старонка Fennec
# View" can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefoxview-brand-name = Агляд Fennec
