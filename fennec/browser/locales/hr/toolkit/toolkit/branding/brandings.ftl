...
-profiler-brand-name =
    { $case ->
        [gen] Fennec Profilera
        [dat] Fennec Profileru
        [acc] Fennec Profiler
        [loc] Fennec Profileru
        [ins] Fennec Profilerom
       *[nom] Fennec Profiler
    }
...
-mdn-brand-name = MDN web dokumenti
...
# and kept in English.
-firefox-suggest-brand-name = Fennecovi prijedlozi
# ”Home" can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefox-home-brand-name = Početna Fennec stranica
# View" can be localized, “Firefox” must be treated as a brand
# and kept in English.
-firefoxview-brand-name = Fennec pogled
