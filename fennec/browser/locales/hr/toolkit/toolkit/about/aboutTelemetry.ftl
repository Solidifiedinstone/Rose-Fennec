...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Fennecova dokumentacija podataka</a> sadrži upute za rad s našim podatkovnim alatima.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Klijentska dokumentacija Fennec telemetrije</a> uključuje definicije za koncepte, API dokumentaciju i reference podataka.
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">Nadzorne ploče telemetrije</a> omogućuju vizualizaciju podataka koje BrowserWorks prima putem telemetrije.
