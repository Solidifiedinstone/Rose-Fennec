...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Aktiviraj USB uklanjanje grešaka u Fennecu na Android uređaju.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Ova verzija Fenneca ne može uklanjati greške programa Fennec za Android (68). Preporučujemo instaliranje Fenneca za Android Nightly na mobitel radi testiranja. <a>Više detalja</a>
...
about-debugging-browser-version-too-recent = Povezani preglednik je noviji { $runtimeVersion }, ID gradnje { $runtimeID } od tvog { -brand-shorter-name(case: "gen") } ({ $localVersion }, ID gradnje { $localID }). Ovo je nepodržana postava i programerski alati možda neće raditi. Aktualiziraj Fennec. <a>Ispravljanje grešaka</a>
