...
sync-mobile-promo = Preuzmi Fennec za <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> ili <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> za sinkroniziranje s tvojim mobilnim uređajem.
...
sync-engine-addons =
    .label = Dodaci
    .tooltiptext = Dodaci i teme za Fennec na radnoj površini
    .accesskey = a
...
addressbar-firefox-suggest-online =
    .label = Dohvaćaj BrowserWorks prijedloge dok tipkaš
