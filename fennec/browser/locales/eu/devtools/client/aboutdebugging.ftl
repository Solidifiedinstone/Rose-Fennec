...
about-debugging-sidebar-this-firefox2 = { -brand-shorter-name } hau
about-debugging-sidebar-this-firefox-title =
    .title = { -brand-shorter-name } hau
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = Konfigurazioa
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Gaitu Fennecen USB arazketa Android gailuan.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Fennecen bertsio honek ezin du Androiderako Fennec (68) araztu. Probak egiteko, Androiderako Fennecen Nightly bertsioa instalatzea gomendatzen dugu. <a>Xehetasun gehiago</a>
...
about-debugging-browser-version-too-recent = Konektatutako nabigatzailea berriagoa da ({ $runtimeVersion }, { $runtimeID } eraikitze-IDa) zure { -brand-shorter-name } ({ $localVersion }, { $localID } eraikitze-IDa) baino. Euskarririk gabeko konfigurazioa da hau eta garatzaile-tresnek huts egitea eragin lezake. Mesedez eguneratu Fennec. <a>Arazo-konpontzea</a>
