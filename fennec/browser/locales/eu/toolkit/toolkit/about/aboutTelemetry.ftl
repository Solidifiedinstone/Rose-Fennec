...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Fennecen datuen dokumentazioa</a>k gure datu-tresnekin nola lan egin erakusten du.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Fennec Telemetry bezeroaren dokumentazioa</a>k kontzeptuen definizioak, API dokumentazioa eta datu-erreferentziak ditu.
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">Telemetry panelen</a> bidez BrowserWorksk Telemetry bitartez jasotako datuak irudika ditzakezu.
