...
sync-mobile-promo = Deskargatu <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> edo <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a>erako Fennec zure gailu mugikorrarekin sinkronizatzeko.
...
sync-engine-addons =
    .label = Gehigarriak
    .tooltiptext = Mahaigaineko Fennecerako hedapenak eta itxurak
    .accesskey = G
...
addressbar-firefox-suggest-online =
    .label = Eskuratu BrowserWorksren iradokizunak idatzi ahala
