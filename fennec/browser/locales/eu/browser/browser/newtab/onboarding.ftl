...
onboarding-animation-pause-button =
    .aria-label = Pausatu animazioa
onboarding-animation-play-button =
    .aria-label = Erreproduzitu animazioa
...
mr2022-onboarding-gratitude-subtitle = Eskerrik asko BrowserWorksk babesten duen { -brand-short-name } erabiltzeagatik. Zure laguntzarekin Internet denontzat irekiagoa, atzigarriagoa eta hobea egiteko lanean ari gara.
...
onboarding-gratitude-security-and-privacy-subtitle = Eskerrik asko BrowserWorks Fundazioak babesten duen { -brand-short-name } erabiltzeagatik. Zure laguntzarekin Internet denontzat seguru eta eskuragarriagoa egiteko lanean ari gara.
...
onboarding-refresh-pin-set-default-title = Seguru zaude Fennecekin
