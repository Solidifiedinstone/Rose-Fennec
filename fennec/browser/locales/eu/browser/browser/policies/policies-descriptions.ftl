...
policy-DisableFirefoxScreenshots = Desgaitu Fennecen pantaila-argazkien eginbidea.
...
policy-DisableRemoteSettingsAndAcceptSecurityConsequences = Desgaitu urruneko ezarpenak.
