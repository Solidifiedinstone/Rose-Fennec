...
preferences-doh-ultra-desc = { -brand-short-name } 将通过 Fennec 的隐私中继使用基于 OHTTP 的安全 DNS，以提供最高级别的保护。

preferences-doh-ultra-detailed-desc-1 = 使用 Fennec 的 OHTTP 中继，对 DNS 提供商隐藏 DNS 查询
