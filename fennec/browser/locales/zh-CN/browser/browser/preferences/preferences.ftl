...
pane-experimental-reset =
    .label = 恢复默认设置
    .accesskey = R
help-button-label2 = { -brand-short-name } 帮助
    .title = { -brand-short-name } 帮助
...
appearance-group2 =
    .label = 网站外观
    .description = 部分网站可更改自身颜色以符合您的偏好。您可选择配色方案。
preferences-web-appearance-choice-auto3 =
    .label = 跟随系统
    .title = 根据系统设置和 { -brand-short-name } 主题，自动更改网站背景和内容。
...
browser-language-heading =
    .label = 浏览器语言
    .description = 选择用于显示 { -brand-short-name } 菜单、消息、通知的语言。
browser-language-preferred-label =
    .label = 首选语言
browser-language-fallback-label =
    .label = 后备语言
    .description = 首选语言未完全本地化时使用。
...
applications-setting2 =
    .label = 文件与应用程序
    .description = 选择 { -brand-short-name } 处理下载文件和内容的方式。
applications-filter =
...
settings-keyboard-shortcuts-group =
    .label = 键盘快捷键
    .description = 控制操作和与 { -brand-short-name } 交互的方式。
...
containers-card-header2 =
    .label = 身份
    .description = 按身份分隔 Cookie，以便在同一网站上使用不同账户，并可限制跨站跟踪。
...
sync-mobile-promo = 在 <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> 和 <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> 设备上安装 Fennec，让您的个性体验随身相伴。
...
sync-engine-addons =
    .label = 附加组件
    .tooltiptext = 用于 Fennec 桌面版的扩展和主题
    .accesskey = A
...
forms-primary-pw-set =
    .label = 设置主密码
forms-primary-pw-on-2 = 主密码：<strong>开启</strong>
forms-primary-pw-on =
    .label = 主密码：开启
...
addressbar-firefox-suggest-online =
    .label = 在键入时获取来自 BrowserWorks 的建议
