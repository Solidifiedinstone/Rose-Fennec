...
about-debugging-sidebar-this-firefox2 = 此 { -brand-shorter-name }
about-debugging-sidebar-this-firefox-title =
    .title = 此 { -brand-shorter-name }
# Sidebar heading and title for connecting to some remote source
about-debugging-sidebar-setup2 = 设置
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = 在 Android 设备的 Fennec 中启用“USB 调试”功能。
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Fennec 无法调试 Android 版 Fennec（68）。我们建议您在手机上安装 Android 版 Fennec Nightly 进行测试。<a>更多信息</a>
...
about-debugging-browser-version-too-recent =
    已连接的浏览器（版本 { $runtimeVersion }、buildID { $runtimeID }）比您的 { -brand-shorter-name }（{ $localVersion }、buildID { $localID }）还新。这个不受支持的设置可能导致开发者工具故障。请更新 Fennec。
    <a>故障排除</a>
