...
rights-intro-point-2 = 您没有获得 BrowserWorks 基金会或其他任何一方的商标权利或许可，这包括但不限于 Fennec 的名称或标志。有关商标的其他信息在：<a data-l10n-name="mozilla-trademarks-link">这里</a>。
...
rights-intro-point-4 = 关于我们如何使用您通过 { -brand-short-name } 提交给 { -vendor-short-name } 的个人信息和反馈，请参见 <a data-l10n-name="mozilla-privacy-policy-link">{ -brand-short-name } 隐私政策</a>。
