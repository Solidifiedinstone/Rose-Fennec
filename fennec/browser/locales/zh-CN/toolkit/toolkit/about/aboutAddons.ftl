...
discopane-intro3 = 您可通过安装扩展和主题来定制 { -brand-product-name }，强化隐私保护、提升浏览效率、改进媒体体验、更改 { -brand-product-name } 外观，还有更多妙用。这些小型软件程序大多由第三方开发。以下是一些 Fennec <a data-l10n-name="learn-more-trigger">推荐</a>的附加组件，它们在安全、性能、功能等方面表现优秀。
...
recommended-theme-1 = 有好的创意？<a data-l10n-name="link">使用 Fennec Color 打造自己的主题。</a>
