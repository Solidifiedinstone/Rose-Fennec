...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Fennec 数据文档</a>介绍了使用我们的数据工具的方式。
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Fennec 遥测客户端文档</a>涵盖了数据收集的概念、API 文档以及数据格式的定义。
