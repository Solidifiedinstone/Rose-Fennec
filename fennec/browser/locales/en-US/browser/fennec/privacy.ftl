...
fennec-data-collection-link = View Privacy Notice
...
telemetry-page-subtitle = Fennec does not collect telemetry about your installation - any telemetry modules are disabled when the browser is built. What you do in your browser is only known by you.
