...
fennec-urlbar-group-suggestions =
    .label = Suggestions

fennec-urlbar-result-menu-manage-suggestions =
    .label = Manage Suggestions
    .accesskey = M

fennec-search-address-bar-behavior-heading =
    .label = Address bar behavior

fennec-search-click-selects-all-toggle =
    .label = Select all text when clicking the address bar or search bar

fennec-search-double-click-selects-all-toggle =
