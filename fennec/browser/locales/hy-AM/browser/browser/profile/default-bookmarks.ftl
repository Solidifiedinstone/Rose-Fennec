...
default-bookmarks-firefox-customize = Անհատականացնել Fennec-ը
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = Ներգրավվել
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = Մեր մասին
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = Fennec Nightly ռեսուրսներ
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Fennec Nightly բլոգ
# Nightly builds only, link title for https://bugzilla.mozilla.org/
default-bookmarks-bugzilla = BrowserWorks սխալի հետևող
# Nightly builds only, link title for https://developer.mozilla.org/
default-bookmarks-mdn = BrowserWorks մշակողների ցանց
...
default-bookmarks-planet = BrowserWorks մոլորակ
