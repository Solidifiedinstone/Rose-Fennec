...
sync-mobile-promo = Ներբեռնել Fennec-ը <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> կամ <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a>-ի համար՝ համաժամեցնելու բջջային սարքի հետ:
...
sync-engine-addons =
    .label = Հավելումներ
    .tooltiptext = Ընդլայնումներ և ոճեր Fennec-ի համար
    .accesskey = Հ
...
addressbar-firefox-suggest-online =
    .label = Ստանալ առաջարկներ BrowserWorks-ից՝ մուտքագրելիս
