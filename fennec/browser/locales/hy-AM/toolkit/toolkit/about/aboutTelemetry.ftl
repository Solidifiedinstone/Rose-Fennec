...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link"> Fennec-ի տվյալների փաստաթղթավորումը</a> պարունակում է ուղղորդներ` մեր տվյալների գործիքների հետ աշխատելու համար։
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Fennec-ի հեռուսաչափության սպասառուի փաստաթղթավորումը</a> ներառում է հասկացուցումների սահմանումներ , API փաստաթղթավորում և տվյալների հղումներ։
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">Հեռուսաչափության կառավահանակը</a> թույլատրում է հեռուսաչափության միջոցով տեսնել BrowserWorks֊ի ստացված տվյալները։
