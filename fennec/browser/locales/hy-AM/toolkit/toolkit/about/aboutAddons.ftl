...
addon-detail-quarantined-domains-help = Թույլատրվելու դեպքում ընդլայնումը կունենա { -vendor-short-name }-ի կողմից սահմանափակված կայքեր մուտք գործելու հնարավորություն։ Թույլատրեք միայն այն դեպքում, եթե վստահում եք այս ընդլայնմանը։
...
addon-badge-line3 =
    .title = Պաշտոնական ընդլայնում, հավաքված BrowserWorks-ի կողմից: Համապատասխանում է անվտանգության և արտադրողականության չափանիշներին
...
recommended-theme-1 = Զգու՞մ եք ստեղծող։ <a data-l10n-name="link">Fennec Color-ով կառուցեք ձեր սեփական հիմնապատեկերը։</a>
...
plugins-openh264-description = Այս բաղադրիչը ինքնաբար տեղադրված է BrowserWorks-ի կողմից և համապատասխանում է WebRTC բնութագրին և WebRTC-ը միացնելու համար կանչում է սարքեր, որոնք պահանջում են H.264 տեսանյութի կոդեկ: Այցելեք http://www.openh264.org/ կայք՝ դիտելու համար կոդեկի բնագիրը:
...
addon-permissions-required-data-collection = Պահանջվող տվյալների հավաքում՝
