...
about-debugging-sidebar-setup2 = Տեղակայում
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Միացրեք USB վրիպազերծումը Android սարքի Fennec-ում։
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Fennec-ի այս տարբերակը չի կարող վրիպազերծել Fennec-ը Android-ի համար (68): Թեստավորման համար խորհուրդ ենք տալիս տեղադրել ձեր հեռախոսում Fennec- ը Android-ի համար Nightly-ին: <a> Լրացուցիչ մանրամասներ</a>
...
about-debugging-browser-version-too-recent = Միացված դիտարկիչը ավելի նոր է ({ $runtimeVersion }, buildID { $runtimeID }) քան ձեր { -brand-shorter-name } ({ $localVersion }, buildID { $localID })։ Սա չաջակցված կարգավորում է և կարող է հանգեցնել DevTools-ին չստացվել։ Խնդրում ենք թարմացրել Fennec-ը։ <a>Անսարքությունների կարգավորում</a>
