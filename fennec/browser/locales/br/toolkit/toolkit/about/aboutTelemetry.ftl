...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Teuliadur roadennoù Fennec</a> a ginnig sturlevrioù evit kompren penaos implij hor ostilhoù roadennoù.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Teuliadur arval pellventerezh Fennec</a> a enkorf despizadurioù evit meizadoù, teuliadurioù API ha daveennoù roadennoù.
about-telemetry-telemetry-dashboard = Gant an <a data-l10n-name="dashboard-link">daolenn bellventerezh</a> e c'hallit gwelet ar roadennoù resevet gant BrowserWorks dre ar pellventerezh.
