...
notCached-title = Dɔkomɛnte no etwa mu
netOffline-title = Ɔflaen tebea
contentEncodingError-title = Mu-asɛm Ndanee Mfomso
unsafeContentType-title = Fael bɔbea a onni bambɔ
netReset-title = Wɔhyɛɛ kɔnɛkhyɛn no ase bio
netTimeout-title = Kɔnɛkhyɛn no ne bere apa ho
unknownProtocolFound-title = Fennec annte adrɛs no ase
