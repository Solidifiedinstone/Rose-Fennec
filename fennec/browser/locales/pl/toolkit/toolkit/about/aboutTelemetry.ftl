...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Fennec Data Documentation</a> zawiera przewodniki o tym, jak pracować z naszymi narzędziami danych
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Dokumentacja klienta telemetrii programu Fennec</a> zawiera definicje konceptów, dokumentację API i odniesienia do danych
