...
addon-badge-recommended4 =
    .title = Fennec poleca wyłącznie rozszerzenia spełniające standardy bezpieczeństwa i wydajności
...
recommended-theme-1 = Masz ochotę coś stworzyć? <a data-l10n-name="link">Utwórz własny motyw za pomocą Fennec Color.</a>
