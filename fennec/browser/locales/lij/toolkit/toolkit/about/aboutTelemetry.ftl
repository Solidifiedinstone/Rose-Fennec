...
about-telemetry-firefox-data-doc = A <a data-l10n-name="data-doc-link">Documentaçion Dæti de Fennec</a> a contegne guidde in sce comme travagiâ co-i nòstri strumenti dati.
about-telemetry-telemetry-client-doc = A <a data-l10n-name="client-doc-link">Documentaçion da Telemetria Dæti de Fennec</a> a contegne documenti definiçioin, API e referense di dati.
about-telemetry-telemetry-dashboard = A <a data-l10n-name="dashboard-link">Lavagna da telemetria</a> a permette de vedde i dati che BrowserWorks a riçeive via Telemetria.
