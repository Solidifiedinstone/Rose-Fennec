...
rights-intro-point-1 = { -brand-short-name } te vegne dæto sotta a-i termini da <a data-l10n-name="mozilla-public-license-link">Licensa Pubrica de BrowserWorks</a>. Questo o veu dî che ti ti peu deuviâ, copiâ e distriboî o { -brand-short-name } a-i atri. Ti ê o benvegnuo anche a cangiâ i sorgenti de { -brand-short-name } pe-i teu bezeugni. A Licensa Pubrica de BrowserWorks a te dâ anche o dirito de distriboî e teu verscioin modificæ.
rights-intro-point-2 = BrowserWorks no te dâ di diriti in sci marchi e lòghi de BrowserWorks e Fennec. Atre informaçioin in sci marchi e lòghi se peuan atrovâ <a data-l10n-name="mozilla-trademarks-link">chi</a>.
