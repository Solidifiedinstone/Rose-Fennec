...
about-telemetry-firefox-data-doc = La <a data-l10n-name="data-doc-link">Documentación de Datos de Fennec</a> contién guidas sobre cómo treballar con as nuestras ferramientas de datos.
about-telemetry-telemetry-client-doc = La <a data-l10n-name="client-doc-link">Documentación d'o client de telemetría de Fennec</a> contién la definición d'os diferents conceptos, la documentación de l'API y referencias d'os datos.
about-telemetry-telemetry-dashboard = Las <a data-l10n-name="dashboard-link">Taulas de telemetría</a> te permiten visualizar los datos recibius por BrowserWorks gracias a la telemetría.
