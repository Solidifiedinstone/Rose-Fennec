...
default-bookmarks-firefox-customize = Fenneci kohandamine
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = Aita kaasa
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = Meist
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = Fennec Nightly ressursid
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Fennec Nightly blogi
# Nightly builds only, link title for https://bugzilla.mozilla.org/
default-bookmarks-bugzilla = BrowserWorks veahalduskeskkond
# Nightly builds only, link title for https://developer.mozilla.org/
default-bookmarks-mdn = BrowserWorks arendajate võrgustik
