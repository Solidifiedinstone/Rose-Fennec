...
sync-mobile-promo = Hangi Fennec <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Androidile</a> või <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOSile</a>, et sünkroniseerida oma mobiilse seadmega.
...
sync-engine-addons =
    .label = Lisad
    .tooltiptext = Arvutis kasutatava Fenneci laiendused ja teemad
    .accesskey = i
