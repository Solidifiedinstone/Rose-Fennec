...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Fenneci andmete dokumentatsioon</a> sisaldab juhendeid selle kohta, kuidas meie andmetööriistu kasutada.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Fenneci telemeetriaandmete kliendidokumentatsioon</a> sisaldab definitsioone mõistete, API dokumentatsiooni ja andmespetsifikatsioonide kohta.
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">Telemeetria koondpaneelid</a> võimaldavad sul visualiseerida neid andmeid, mida BrowserWorks telemeetria kaudu vastu võtab.
