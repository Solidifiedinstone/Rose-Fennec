...
addon-badge-line3 =
    .title = BrowserWorks loodud ametlik laiendus. Vastab turva- ja jõudlusstandarditele
...
recommended-theme-1 = Tunned end loomingulisena? <a data-l10n-name="link">Loo endale oma teema Fennec Coloriga.</a>
...
plugins-openh264-description = Selle plugina on BrowserWorks automaatselt paigaldanud, et tagada ühilduvus WebRTC spetsifikatsiooniga ja võimaldada WebRTC-kõnesid videokoodekit H.264 nõudvate seadmetega. Lisateabe saamiseks ja koodeki lähtekoodiga tutvumiseks külasta aadressi http://www.openh264.org
