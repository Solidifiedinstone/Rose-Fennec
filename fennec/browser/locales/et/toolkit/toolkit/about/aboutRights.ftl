...
rights-intro-point-1 = { -brand-short-name } on tehtud kättesaadavaks järgneva litsentsi all: <a data-l10n-name="mozilla-public-license-link">BrowserWorks avalik litsents (MPL - BrowserWorks Public License)</a>. See tähendab, et sa võid { -brand-short-name }i kasutada, kopeerida ja teistele jagada. Sa võid ka igati muuta { -brand-short-name }i lähtekoodi, kui tahad, et see paremini sobiks sinu vajadustega. Samuti annab BrowserWorks avalik litsents (MPL) sulle õiguse oma muudetud versiooni edasi levitada.
rights-intro-point-2 = BrowserWorks ei anna sulle mingeid õigusi ega litsentse BrowserWorks ja Fenneci kaubamärkide või logode üle. Lisainfot kaubamärkide kohta võib leida <a data-l10n-name="mozilla-trademarks-link">siit</a>.
