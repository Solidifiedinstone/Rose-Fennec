...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Aktivizoni Diagnostikim USB te Fennec-i në pajisjen Android.
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Ky version i Fennec-it s’mund të diagnostikojë Fennec-in për Android (68). Rekomandojmë që për testime në telefonin tuaj të instaloni Fennec-in për Android Nightly. <a>Më tepër hollësi</a>
