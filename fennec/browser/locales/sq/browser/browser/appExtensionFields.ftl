...
extension-colorways-soft-name = { $colorway-name } — E butë
extension-colorways-balanced-name = { $colorway-name } — E baraspeshuar
# "Bold" is used in the sense of bravery or courage, not in the sense of
# emphasized text.
extension-colorways-bold-name = { $colorway-name } — E guximshme
