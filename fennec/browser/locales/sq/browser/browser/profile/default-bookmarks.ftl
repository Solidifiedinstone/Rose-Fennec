...
default-bookmarks-firefox-customize = Përshtateni Fennec-in
# link title for https://www.mozilla.org/contribute/
default-bookmarks-firefox-community = Përfshihuni
# link title for https://www.mozilla.org/about/
default-bookmarks-firefox-about = Rreth Nesh
# Firefox Nightly links folder name
default-bookmarks-nightly-heading = Burime për Fennec Nightly
# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Blog për Fennec Nightly
# Nightly builds only, link title for https://bugzilla.mozilla.org/
default-bookmarks-bugzilla = Ndjekësi i të Metave BrowserWorks
# Nightly builds only, link title for https://developer.mozilla.org/
default-bookmarks-mdn = Rrjeti i Zhvilluesve BrowserWorks
...
default-bookmarks-planet = Planeti BrowserWorks
