...
sync-mobile-promo = Që të kryeni njëkohësim te pajisja juaj celulare, shkarkoni Fennec-in për <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> ose <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a>.
...
sync-engine-addons =
    .label = Shtesa
    .tooltiptext = Zgjerime dhe tema për Fennec Desktop
    .accesskey = t
...
addressbar-firefox-suggest-online =
    .label = Merrni sugjerime nga BrowserWorks, teksa shtypni
