...
pref("fennec.blocker.enabled", true);
// Show ad blocking controls in Settings.
pref("fennec.blocker.ui.enabled", true);
// Show the blocked count badge on the blocker toolbar button.
pref("fennec.blocker.showBadge", true);
// Allow ads on configured Fennec search partner domains.
pref("fennec.blocker.allowSearchPartnerAds", true);
// Additional custom filter list URLs as a JSON array string.
pref("fennec.blocker.filterListUrls", "[]");
// Per list enabled overrides as a JSON object mapping list IDs to booleans.
pref("fennec.blocker.enabledLists", "{}");
// Suppress startup detection notifications for ad blocker extensions.
pref("fennec.blocker.extensionDetectionDismissed", false);
// Extension IDs for which install warnings have already been dismissed.
pref("fennec.blocker.dismissedExtensionInstallWarnings", "[]");
// Let the blocker run alongside ad blocking extensions.
pref("fennec.blocker.coexist", false);
// Fetch uBO scriptlets and supplementary resources from Fennec AUS at
// runtime. When false, the engine uses only the copies bundled in the build.
pref("fennec.blocker.remoteResourcesEnabled", true);
