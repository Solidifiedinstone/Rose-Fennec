...
// Fennec search extension policy blanks these while an ad clicking
// extension is active.
pref("browser.search.param.fennec_attribution_1org", "1org.fennec");
pref("browser.search.param.fennec_attribution_ddg", "fennec");
pref("browser.search.param.fennec_attribution_ecosia", "57226k1p");
pref("browser.search.param.fennec_attribution_qwant", "brz-fennec");
